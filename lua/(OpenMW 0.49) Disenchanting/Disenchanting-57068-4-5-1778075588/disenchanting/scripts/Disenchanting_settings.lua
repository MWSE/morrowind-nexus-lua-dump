...
settingsTemplate[tempKey] = {
	...
	settings = {
		...
		{
			key = "RECOUPED_SOUL_PER_LEVEL",
			name = "Recouped Soul Mult Per Level",
			description = "Increases the multiplier above for each enchant level",
			renderer = "number",
			default = 0.003,
			argument = {
				min = 0,
		...
		{
			key = "BOOKS_ENCHANT_MULTIPLIER",
			name = "Scroll Enchant Multiplier",
			description = "Divided by your Enchanted Paper Multiplier for generated records\n0 = disable",
			renderer = "number",
			default = 0.5,
			argument = {
				min = 0,
	...
	settings = {
		{
			key = "UI_OPACITY",
			name = "UI Opacity",
			description = "Background opacity of dialogue windows and tooltips",
			renderer = "number",
			default = 0.8,
			argument = {
				min = 0,
		...
		{
			key = "SHOW_SOULGEM_IN_IE_TOOLTIP",
			name = "Show Soul In IE Tooltip",
			description = "Show the soul value in Inventory Extender tooltips for filled soulgems\nIf you prefer this mod's style over inventory extender's",
			renderer = "checkbox",
			default = false,
		},
		{
		...
		{
			key = "ALWAYS_SHOW_DISENCHANT_VALUE",
			name = "Always show disenchant value",
			description = "Always show the recouped soul for enchanted items in Inventory Extender tooltips\nOtherwise only when disenchanting is toggled or when holding shift",
			renderer = "checkbox",
			default = true,
		},
	},
...
settingsTemplate[tempKey] = {
	...
	settings = {
		...
		{
			key = "PAPER_MAGNITUDE_MULT",
			name = "Paper Magnitude Multiplier",
			description = "Scales the magnitude of every effect on the resulting paper enchantment\n1 = unchanged",
			renderer = "number",
			default = 1.5,
			argument = {
				min = 0,

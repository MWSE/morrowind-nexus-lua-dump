...
-- MAIN FUNCTION
return function (item, newValueMult, enchRemoveColor, isPickpocketing, countOverride) --makeTooltip
	...
	local ench = item and item.enchant ~= "" and item.enchant
	...
	local displayCount = countOverride or item.count
	if displayCount and displayCount > 1 then
		name = name.." ("..displayCount..")"
	end

...
return function(item, preview, player)
	...
	local newCapacity = math.floor(math.max(enchPoints / 7, oldCapacity * globalSection:get("CAPACITY_MULT") + math.min(2*oldCapacity, enchPoints) * globalSection:get("CAPACITY_FROM_ENCHANTMENT")))

...
local defaultConfig = {
    ...
    bobCustomizableAmplitudeMultiplier = 65,
    smoothValue = 10,
    ...
    stepRotationEnabled = true,
    stepRotationMultiplier = 60,
    stepRotationSmoothing= 8,
    sneakStepRotationNoiseScale = 6,
    sneakStepRotationNoiseAmplitude = 0.3,
    walkStepRotationNoiseScale = 9,
    walkStepRotationNoiseAmplitude = 0.5,
    runStepRotationNoiseScale = 16,
    runStepRotationNoiseAmplitude = 0.8,
}

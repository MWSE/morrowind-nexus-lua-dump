...
settings:createOnOffButton{
    label = "Step Rotation Mechanic",
    description = "Dictates if the camera should roll a little with every step the player takes. It rolls in the direction of the horizontal head bobbing.",
...
local sneakPage = template:createSideBarPage({
    ...
    description = "These settings details how the smoothing works for sneak camera transitions. Toggling OFF the sneak camera setting will reset the GMST value for sneak height.",
    showReset = true
})
...
local stepRotationPage = template:createSideBarPage({
    label = "Step rotation settings",
    description = "These settings details how the step rotation feature works ",
    showReset = true
})

stepRotationPage:createSlider{
    label = "Step Rotation Strength",
    description = "This is a multiplier that dictates how much the camera rotates with every step. Requires the Step Rotation Mechanic to be enabled to do anything.",
    max = 250,
    min = 50,
...
stepRotationPage:createSlider{
    label = "Step Rotation Smoothing",
    description = "This value dictates how smooth the rotation is.",
    max = 25,
    min = 1,
...
local sneakStepRotationTweaks = stepRotationPage:createCategory ("Tweaks for step rotation when sneaking")

sneakStepRotationTweaks:createSlider{
    label = "Sneak Step Rotation Noise Multiplier",
    description = "This value dictates how much noise is passed through the step rotation when sneaking. If set to 0, the added noise feature is turned off completely.",
    max = 5,
    min = 0,
    step = 0.1,
    decimalPlaces = 1,
...
sneakStepRotationTweaks:createSlider{
    label = "Sneak Step Rotation Noise Speed",
    description = "This value dictates how fast the noise is for step rotations when sneaking. The multiplier above needs to be higher than 0 for this to do anything.",
    max = 25,
    min = 0,
    step = 0.1,
    decimalPlaces = 1,
...
local walkStepRotationTweaks = stepRotationPage:createCategory ("Tweaks for step rotation when walking")

walkStepRotationTweaks:createSlider{
    label = "Walk Step Rotation Noise Multiplier",
    description = "This value dictates how much noise is passed through the step rotation when walking. If set to 0, the added noise feature is turned off completely.",
    max = 5,
    min = 0,
    step = 0.1,
    decimalPlaces = 1,
...
walkStepRotationTweaks:createSlider{
    label = "Walk Step Rotation Noise Speed",
    description = "This value dictates how fast the noise is for step rotations when walking. The multiplier above needs to be higher than 0 for this to do anything.",
    max = 25,
    min = 0,
    step = 0.1,
    decimalPlaces = 1,
...
local runStepRotationTweaks = stepRotationPage:createCategory ("Tweaks for step rotation when running")

runStepRotationTweaks:createSlider{
    label = "Run Step Rotation Noise Multiplier",
    description = "This value dictates how much noise is passed through the step rotation when running. If set to 0, the added noise feature is turned off completely.",
    max = 5,
    min = 0,
    step = 0.1,
    decimalPlaces = 1,
...
runStepRotationTweaks:createSlider{
    label = "Run Step Rotation Noise Speed",
    description = "This value dictates how fast the noise is for step rotations when running. The multiplier above needs to be higher than 0 for this to do anything.",
    max = 25,
    min = 0,
    step = 0.1,
    decimalPlaces = 1,

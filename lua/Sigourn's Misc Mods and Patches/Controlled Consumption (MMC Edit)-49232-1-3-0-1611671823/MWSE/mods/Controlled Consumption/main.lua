...
--[[
	...
	The following configurations are available:
		* Vanilla NPC: A potion or ingredient can only be consumed once every 5 seconds. This is the same restriction NPCs have in vanilla.
		* Oblivion: Only 4 potions or ingredients can be active at any one time.
]]--

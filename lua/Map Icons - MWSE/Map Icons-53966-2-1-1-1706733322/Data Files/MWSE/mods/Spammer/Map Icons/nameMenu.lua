...
this.id_menu = tes3ui.registerID("spa_IconNameInput")
...
function this.createWindow(path)
    ...
    local input = border:createTextInput { id = this.id_input, placeholderText = "Custom Icon" }

...
settings:createSlider{
	label = "Specialisation Coefficient",
	description = "Determines how much your class specialisation contributes towards your skill limits. This value is multiplied by 5 and then added to the limits of corresponding skills.",
	min = 0,
	max = 3,
	step = 1,
	jump = 2,
	variable = EasyMCM.createTableVariable{
		id = "specialisationCoef",
		table = config
	}
}

settings:createSlider{
	label = "Race Coefficient",
	description = "Determines how much your race contributes towards your skill limits. This value is multiplied by your race bonuses and then added to the limits of corresponding skills.",
	min = 0,
	max = 3,
	step = 1,
	jump = 2,

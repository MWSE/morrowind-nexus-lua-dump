...
-- This Arcane Knight has long studied arcana while following the more conventional training of a knight in melee combat and etiquette.
        return {
            gearList = {
                { item = "aa_cl_speech_pot" },
                { item = "hammer_repair", count = 2 },
...
-- The Plagueherald has an incredible physique that lets them resist diseases and an intellect to understand and manipulate them. Once an enemy is weakened and plague-ridden, the Plagueherald will them off with their axe.
        return {
            gearList = {
                { item = "chitin war axe" },

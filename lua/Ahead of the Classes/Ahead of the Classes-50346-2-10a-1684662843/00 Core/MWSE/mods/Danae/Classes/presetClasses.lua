...
--old tr enlisted seafarers, sailors are skilled in operating and maintaining naval vessels, as well as navigation and the occasional joust. when wor on a military vessel, a group of sailors are often under the command of noble officers.
        return {
            gearlist = {
...
--old tr scribes serve as public clerks for the masses, as well as professional copyists of hand-written texts in noble courts. in western provinces, scribes often oversee the operation and maintainance of printing presses.	
        return {
            gearlist = {
...
-- illusion, alchemy, alteration, mercantile, sneak // speechcraft, athletics, blunt weapon, unarmored, light armor
        return {
            gearlist = {
                ...
                { item = "t_com_paintpot_01" },
                { item = "jop_easel_misc" },
                { item = "jop_paintbrush_01" },
                { item = "jop_pallete_01" },
            },
            spelllist = {
                "calm creature",

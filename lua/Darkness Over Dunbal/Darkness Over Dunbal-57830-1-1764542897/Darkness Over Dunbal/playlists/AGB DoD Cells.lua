...
local CoveCells = {
    ...
    ['corpse cove, guard post'] = true,
    ['corpse cove, residence'] = true,
    ['corpse cove, shrine'] = true,
}
...
return {
    ...
    {
        id = 'ms/interior/AGB_Kilhavenint',
        priority = PlaylistPriority.CellExact,
    ...
    {
        id = 'ms/interior/AGB_USanctum',
        priority = PlaylistPriority.CellExact,
        isValidCallback = TempleupperRule,
    },
    {
        id = 'ms/interior/AGB_LSanctum',
        priority = PlaylistPriority.CellExact,

    ...
    if (e.newlyCreated and tes3.player == nil) then
        ...
        for _, element in ipairs(e.element:getContentElement().children[1].children) do
            ...
            if (contentPath) then
                ...
                for i = 1, 3 do
                    element.children[i].width = (512 / iw) * w * 0.75
                    element.children[i].height = (64 / ih) * h * 0.75
                    element.children[i].imageScaleX = (w / iw) * 0.75
                    element.children[i].imageScaleY = (h / ih) * 0.75
                    if (i == 2) then

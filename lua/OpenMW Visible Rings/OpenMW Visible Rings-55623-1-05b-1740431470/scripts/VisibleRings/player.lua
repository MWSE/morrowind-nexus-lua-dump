...
local function updateSettings()
	...
	records.bareHands.first = rec.first
	records.bareHands.third = rec.third
...
local function addRingVfx(o, bone, hand)
	...
	if onlyHands and sizes ~= records.bareHands then		return		end
	local view = (cam == MD.first and "first") or "third"
	if debug then print(sizes[view], id)			end

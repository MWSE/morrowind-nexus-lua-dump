local function adjustWadeSpeed(e)
    ...
    --if (mobile.isSwimming or mobile.isFlying or mobile.encumbrance.normalized >= 1 ) then return end
	if (mobile.isSwimming or mobile.isFlying or e.speed <= 1 ) then return end
	...
	local maxPosition = minPosition + mobile.height

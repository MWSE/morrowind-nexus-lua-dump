...
local configurations = require("StormAtronach.TT.config")
common.config = configurations.config
common.default_config = configurations.default_config
common.log = require("logging.logger").new{
    name        = "Take that!",
    logLevel    = common.config.log_level,
}
--  Weapon Types
...
function common.weaponSkillCheck(data)
    ...
    common.log:trace(string.format("Executed weapon skill check: Skill %s, skillDC %s ", skillLevel, skillDC))

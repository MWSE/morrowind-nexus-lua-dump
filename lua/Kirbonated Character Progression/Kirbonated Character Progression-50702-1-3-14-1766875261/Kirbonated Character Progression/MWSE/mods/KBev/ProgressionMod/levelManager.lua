...
local function asButtonScript(params)
	...
	if params.type == "sub" then
		if (params.tbl.base + params.tbl.pointsSpent < 101) and (params.tbl.pointsSpent > 0) then
			 common.playerData.levelPoints[params.points] =  common.playerData.levelPoints[params.points] + 1
			params.tbl.pointsSpent = params.tbl.pointsSpent - 1
	...
	page = 0 --initialize to page 0
		...
		introPage.visible = (page == 0)
			...
			b_Flavor.autoHeight = true
				FlavorText = b_Flavor:createLabel{id = tes3ui.registerID("KCP:LevelUPFlavorText"),text = (levelUpMessage[nextLevel] or "The results of hard work and dedication always look like luck to saps. But you know you've earned every ounce of your success.")}

...
local function BSG_OpenEnchantMenu(obj)
    I.UI.setMode("Enchanting",{target =obj})
end
return {eventHandlers = {BSG_OpenEnchantMenu = BSG_OpenEnchantMenu, BSG_ShowMessage = BSG_ShowMessage, BSG_playSoundEvent = playSoundEvent}}
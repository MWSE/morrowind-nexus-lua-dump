...
return {
    ...
    interface = {
        ...
        test = {
            pickModifiers = function(itemLevel, alpha, beta) mTest.testPickModifier(state, itemLevel, alpha, beta) end,
            showActorStats = function() mTest.showStats(state.stats) end,
            createItem = function(recordId, modId1, lvl1, modId2, lvl2) mTest.createItem(state, recordId, modId1, lvl1, modId2, lvl2) end
        },
    },
    engineHandlers = {
        onInit = onInit,

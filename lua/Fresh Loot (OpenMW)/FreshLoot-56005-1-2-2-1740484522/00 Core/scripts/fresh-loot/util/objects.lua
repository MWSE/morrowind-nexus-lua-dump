...
local function isValidContainer(record)
    return not record.isOrganic and not record.isRespawning
end
module.isValidContainer = isValidContainer

local function isValidInventory(inventory)
...
module.isValidInventory = isValidInventory

...
local function trySeeDestination(actor, destination)
...
module.trySeeDestination = trySeeDestination
...
local function getDoorBoosts(actor, container, allDoorStats)
    local doorsBoosts = {}
...
module.getDoorsBoosts = getDoorBoosts

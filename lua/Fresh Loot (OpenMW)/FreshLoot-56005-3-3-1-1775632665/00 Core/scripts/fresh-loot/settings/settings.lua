...
module.updateSettings = function(state, key, oldValue)
    local newValue = settings[key].get()
    if newValue == nil then
        -- nil means reset: We need to reapply presets
...
module.getSettingChanges = function()
    local restoreTypes = {}
...
module.initSettings = function()
    ...
    -- fix old controller key setting

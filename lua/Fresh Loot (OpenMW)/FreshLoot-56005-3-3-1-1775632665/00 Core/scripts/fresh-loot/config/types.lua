...
module.chancePresets = { VeryRare = 1, Rare = 2, Common = 3, VeryCommon = 4, Maximum = 5 }
...
local modEffectConflicts = {
    ...
    [EffectTypes.FortifyHealth] = { EffectTypes.DrainHealth, EffectTypes.DamageHealth },
    [EffectTypes.FortifyMagicka] = { EffectTypes.DrainMagicka, EffectTypes.DamageMagicka },
    [EffectTypes.FortifyFatigue] = { EffectTypes.DrainFatigue, EffectTypes.DamageFatigue },
    [EffectTypes.CalmHumanoid] = { EffectTypes.FrenzyHumanoid },
    [EffectTypes.CalmCreature] = { EffectTypes.FrenzyCreature },
...
for effect1, effects in pairs(modEffectConflicts) do
    module.modEffectConflicts[effect1] = module.modEffectConflicts[effect1] or {}
...
module.contextualModRestrictions = {
    [EffectTypes.SunDamage] = function(_, effect, _, loot)
        return effect.range ~= RangeTypes.Self or loot.type == T.Container
    end
}

module.armorClasses = { Light = "Light", Medium = "Medium", Heavy = "Heavy" }

module.validContainerScripts = {
    float = true,
    sound_flies = true,
}
...
module.new = {
    cache = function()
        return { validItems = {}, itemLists = {}, exceptions = module.new.exceptionLists(), modifiers = {}, modifierTypes = { props = {}, effects = {} } }
    end,
    exceptionLists = function()
        return { actorLevelOverrides = {}, excludedActorIds = {}, excludedContainerIds = {} }
    end,

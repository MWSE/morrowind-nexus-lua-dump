...
local modifiers = {}
for _, category in ipairs({ "properties", "alteration", "conjuration", "destruction", "illusion", "mysticism", "restoration", "multi-schools",
                            "compromises-on-use", "compromises-on-strike", "compromises-constant" }) do

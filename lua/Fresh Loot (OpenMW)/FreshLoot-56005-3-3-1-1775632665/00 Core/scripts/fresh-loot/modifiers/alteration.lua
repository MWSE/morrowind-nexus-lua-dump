...
return {
        ...
        effects = {
            {
                ...
                duration = { 30, 75, 120, false, false },
            },
        },
        itemTypes = {
            [T.Clothing] = { types = {
        ...
        effects = {
            {
                ...
                range = RangeTypes.Self,
                min = { false, 30, 60, 100, 150 },
                max = { false, 30, 60, 100, 150 },
            },
        },
        itemTypes = {
            [T.Armor] = true,
        ...
        effects = {
            {
                ...
                range = RangeTypes.Self,
                min = { 1, 1, 1, false, false },
                max = { 2, 2, 2, false, false },
                duration = { 10, 25, 50, false, false },
            },
        },
        itemTypes = {
            [T.Clothing] = true,
    ...
    {
        id = "fireFrostLightningShield-onUse",
        affixType = mT.affixes.Prefix,
        value = 250,
        castType = EnchantTypes.CastOnUse,
        cost = 80,

        ...
        effects = {
            {
                ...
                range = RangeTypes.Self,
                min = { 10, 20, 30, false, false },
                max = { 15, 25, 30, false, false },
                duration = { 45, 60, 90, false, false },
            },
        },
        itemTypes = {
            [T.Clothing] = { types = {
        ...
        effects = {
            {
                ...
                duration = { false, 20, 20, 20, 20 },
            },
            {
                id = EffectTypes.FrenzyCreature,
                range = RangeTypes.Touch,
                min = { false, 30, 40, 60, 70 },
                max = { false, 50, 70, 90, 100 },
                duration = { false, 20, 20, 20, 20 },
            },
        },
        itemTypes = {
        ...
        effects = {
            {
                ...
                range = RangeTypes.Target,
                min = { 20, 30, 50, false, false },
                max = { 40, 60, 100, false, false },
                duration = { 30, 45, 60, false, false },
            },
            {

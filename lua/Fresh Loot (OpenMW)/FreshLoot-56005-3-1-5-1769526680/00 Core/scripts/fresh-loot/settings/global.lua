...
local settingGroups = {
    {
        ...
        settings = {
            ...
            {
                key = mStore.cfg.chancePresets.key,
                renderer = "select",
                default = mStore.cfg.chancePresets.keys[mT.chancePresets.Rare],
            },
            {
                key = mStore.cfg.enableChancePresets.key,
                renderer = "checkbox",
                default = true,
            },
            {
            ...
            {
                key = mStore.cfg.itemsWindowKeyKeyboard.key,
                renderer = mDef.renderers.hotkeyKeyboard,
                default = nil,
            },
            {
                key = mStore.cfg.itemsWindowKeyController.key,
            ...
            },
            {
                ...
                renderer = "select",
                default = mStore.cfg.logMode.keys[mT.logLevels.None],
            },
        },
    },
    {
        ...
        settings = {
            ...
            {
                key = mStore.cfg.nextConversionInSameLootChance.key,
                renderer = mDef.renderers.number,
            },
            {
                key = mStore.cfg.equippedWeaponMinChance.key,
                renderer = mDef.renderers.number,
            },
            {

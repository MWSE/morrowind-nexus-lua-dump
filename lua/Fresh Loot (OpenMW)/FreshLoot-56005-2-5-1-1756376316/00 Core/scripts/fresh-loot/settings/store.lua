...
module.cfg = {
    ...
    equippedWeaponSecondChance = {
        section = module.section.chance,
        argument = { integer = true, min = 0, max = 100, isPercent = true },
        triggerRestoreTypes = { mTypes.itemRestoreTypes.Equipped },
    },
    equippedWeaponSecondChanceLootLevelRatio = {
        section = module.section.chance,
        argument = { integer = true, min = 0, max = 100, isPercent = true },
        triggerRestoreTypes = { mTypes.itemRestoreTypes.Equipped },
    },
...
module.cfg.equippedWeaponSecondChance.requires = module.cfg.doEquippedItems.key
module.cfg.equippedWeaponSecondChanceLootLevelRatio.requires = module.cfg.doEquippedItems.key

...
local state = {
    ...
    learned = {
        ...
        factionRanksLevel = {},
        containers = { levelStats = {}, boosts = {}, soldItems = {} },
    },
...
return {
    ...
    eventHandlers = {
        ...
        [mDef.events.filterConvertedItems] = function(event) event.object:sendEvent(event.name, mConvert.filterConvertedItems(state, event.input)) end,

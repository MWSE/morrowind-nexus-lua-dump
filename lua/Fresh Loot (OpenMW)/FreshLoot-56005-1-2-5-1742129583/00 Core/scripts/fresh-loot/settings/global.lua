...
local settingGroups = {
    ...
    },
    {
        ...
        settings = {
            ...
            {
                key = mStore.cfg.lootLevelChanceBoost.key,
                renderer = mDef.renderers.number,
                default = mCfg.modifierChance.lootLevelBoost,
            },
            {
            ...
            {
                key = mStore.cfg.multiConvertsChanceReduction.key,
                renderer = mDef.renderers.number,
                default = mCfg.modifierChance.multiConvertsChanceReduction,
            },
        },
    },
    {
        ...
        settings = {
            {
                key = mStore.cfg.modifierLevelDifficultyRange.key,
                renderer = mDef.renderers.number,
                default = mCfg.modifierLevel.levelDifficultyRange,
            },
            {
            ...
            {
                key = mStore.cfg.creatureLevelBoost.key,
                renderer = mDef.renderers.number,
                default = mCfg.lootLevel.creatureLevelBoost,
            },
            {

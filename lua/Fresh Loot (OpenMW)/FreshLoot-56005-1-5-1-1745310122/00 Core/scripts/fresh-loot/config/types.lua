...
module.new = {
    ...
    containerStats = function(container, actors, levelStatsOverride)
        return { container = container, actors = actors, levelStatsOverride = levelStatsOverride, levelStats = {}, accessDoors = {} }
    end,
    ...
    lootKeeperStatsOverride = function(actorLevel, source)
        return { actorLevel = actorLevel, source = source }
    end,
    ...
    partialRequest = function(id)
        return { data = nil, requestId = id }
    end,
}

...
module.cfg = {
    ...
    enabled = {
        ...
        triggerRestoreTypes = { mTypes.itemRestoreTypes.All, mTypes.itemRestoreTypes.Equipped },
    },
    chancePresets = {
        section = module.section.global,
        triggerRestoreTypes = { mTypes.itemRestoreTypes.Equipped },
        enum = mTypes.chancePresets,
    },
    enableChancePresets = {
        section = module.section.global,
        triggerRestoreTypes = { mTypes.itemRestoreTypes.Equipped },
    ...
    doArmors = {
        section = module.section.global,
        triggerRestoreTypes = { mTypes.itemRestoreTypes.Armors, mTypes.itemRestoreTypes.Equipped },
    },
    doClothing = {
        section = module.section.global,
        triggerRestoreTypes = { mTypes.itemRestoreTypes.Clothing, mTypes.itemRestoreTypes.Equipped },
    },
    doWeapons = {
        section = module.section.global,
        triggerRestoreTypes = { mTypes.itemRestoreTypes.Weapons, mTypes.itemRestoreTypes.Equipped },
    },
    endGameLootLevel = {
        section = module.section.global,
...
module.cfg.maxModsValueOverCreatureWealth.lockIf = { key = module.cfg.enableChancePresets.key, value = true }

module.presets = {
    [mTypes.chancePresets.VeryRare] = {
        ...
        [module.cfg.maxModsValueOverCreatureWealth.key] = 50,
    },
    [mTypes.chancePresets.Rare] = {
    ...
    [mTypes.chancePresets.Common] = {
        ...
        [module.cfg.maxModsValueOverCreatureWealth.key] = 75,
    },
    [mTypes.chancePresets.VeryCommon] = {
        ...
        [module.cfg.maxModsValueOverCreatureWealth.key] = 0,
    },
}

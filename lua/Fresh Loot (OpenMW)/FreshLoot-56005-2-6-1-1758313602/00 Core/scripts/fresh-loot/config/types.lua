...
module.new = {
    ...
    newContainersData = function(containers, actors, player)
        return { containers = containers, actors = actors, player = player }
    end,
    ...
    containerGlobalStats = function(container, actors, levelStatsOverride, checkDoors)

...
local function replaceLight(oldLight, newRecordId)
	...
	local rotation = saveData.originalRotations[oldId] or oldLight.rotation
	...
	saveData.originalRotations[newLight.id] = rotation
...
local function onUpdate(dt)
	...
	local isNight = clockHour < 7 or clockHour > 18

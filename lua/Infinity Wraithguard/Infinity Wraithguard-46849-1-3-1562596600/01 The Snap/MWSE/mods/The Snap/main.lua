...
local function onInitialized()
	infinityGauntlet = tes3.getObject("wraithguard_complete")
	dust = tes3.getObject("ashes_Dwemer")

	if (infinityGauntlet == nil or dust == nil) then
		mwse.log("[The Snap] ERROR: Could not find critical items necessary. Ensure that the main .esp is active.")
		return
	end

...
local function registerModConfig()
    ...
    settings:createYesNoButton({
		label = "Message Boxes Show for Non-Voiced Races",
		configKey = "noVoice",
        description = "Shows message boxes when non-voiced races consider the player a trespasser. Disable to prevent logic from affecting non-voiced races. Default: Yes"
	})

...
local function detectSneak(e)
    ...
    elseif isMatchingCell(playerCell.id) and (currentTime >= config.startTrespass or currentTime <= config.endTrespass) then
        ...
        local follower = nil
        -- Before the loop or earlier in the logic, set the follower
        for _, mobile in ipairs(mobileList) do
            ...
            if (tes3.getCurrentAIPackageId(actor) == tes3.aiPackage.follow) then
                follower = actor  -- Assign follower
            end

            -- Skip the player and followers
            -- Ensure that follower is not nil before using it
            if actor ~= tes3.player and (not follower or actor ~= follower) then
                if tes3.testLineOfSight({ reference1 = actor, reference2 = tes3.player }) or (follower and tes3.testLineOfSight({ reference1 = actor, reference2 = follower })) then
                    ...
                    if actor.object.objectType == tes3.objectType.npc and actor.object.isGuard or config.blacklistNpc[actor.object.name] then
                        ...
                        if disposition and disposition >= config.disposition and config.dispOn then
                            ...
                            if actor and actor.object and actor.object.objectType == tes3.objectType.npc and actor ~= tes3.player then
                                    ...
                                    if not actorInfo.actionTriggered then
                                        ...
                                        actorInfo.timer = timer.start{
                                            ...
                                            callback = function()
                                                ...
                                                -- Check if the actor's health is 0 before proceeding
                                                if actor.mobile.health.current <= 0 then
                                                    -- Cancel the timer and clear the actor's detection status
                                                    if actorInfo.timer then
                                                        actorInfo.timer:cancel()
                                                        detectedActors[actor] = nil
                                                        return
                                                    end
                                                end

                                                if not tes3.testLineOfSight({ reference1 = actor, reference2 = tes3.player }) or (follower and tes3.testLineOfSight({ reference1 = actor, reference2 = follower })) then
                                                    if actorInfo.timer then
                                                        actorInfo.timer:cancel()
                                                        detectedActors[actor] = nil
                                                        return
                                ...
                                elseif (race and race.id == "Khajiit" and actor.object.female) or (race and race.id == "T_Els_Cathay" and actor.object.female) or (race and race.id == "T_Els_Cathay-raht" and actor.object.female) or (race and race.id == "T_Els_Dagi-raht" and actor.object.female) or (race and race.id == "T_Els_Ohmes" and actor.object.female) or (race and race.id == "T_Els_Ohmes-raht" and actor.object.female) or (race and race.id == "T_Els_Suthay" and actor.object.female) or (race and race.id == "Dagi" and actor.object.female) or (race and race.id == "Pahmar" and actor.object.female) or (race and race.id == "Pahmar-Raht" and actor.object.female) or (race and race.id == "Tojay" and actor.object.female) or (race and race.id == "Tojay-Raht" and actor.object.female) then
                                    -- If not already detected, mark the actor as having detected the player
                                    if not detectedActors[actor] then
                                        detectedActors[actor] = {
                                            detected = true,
                                ...
                                elseif (race and race.id == "Khajiit") or (race and race.id == "T_Els_Cathay") or (race and race.id == "T_Els_Cathay-raht") or (race and race.id == "T_Els_Dagi-raht") or (race and race.id == "T_Els_Ohmes") or (race and race.id == "T_Els_Ohmes-raht") or (race and race.id == "T_Els_Suthay") or (race and race.id == "Dagi") or (race and race.id == "Pahmar") or (race and race.id == "Pahmar-Raht") or (race and race.id == "Tojay") or (race and race.id == "Tojay-Raht") then
                                    -- If not already detected, mark the actor as having detected the player
                                    if not detectedActors[actor] then
                                        detectedActors[actor] = {
                                            detected = true,
                                ...
                                elseif (race and race.id == "T_Cnq_Keptu" and actor.object.female) then
                                                ...
                                                if config.combat then
                                                    if config.playerLevel then
                                                        ...
                                                        actor.mobile:startCombat(tes3.mobilePlayer)
                                                                    ...
                                                                    elseif (race and race.id == "T_Cyr_Ayleid" and actor.object.female) then
                                    -- If not already detected, mark the actor as having detected the player
                                    if not detectedActors[actor] then
                                        detectedActors[actor] = {
                                            detected = true,
                                    ...
                                    if not actorInfo.actionTriggered then
                                        ...
                                        tes3.say({ reference = actor, soundPath = "vo\\Ay\\f\\Hlo_AyF000e.mp3", subtitle = "Get out of here!" })
                                        if config.messagesOn then
                                            tes3.messageBox({ message = actor.object.name .. " asks you to leave." })
                                        end
                                        ...
                                        actorInfo.timer = timer.start{
                                            ...
                                            callback = function()
                                                ...
                                                tes3.say({ reference = actor, soundPath = "vo\\Ay\\f\\Thf_AyF002.mp3", subtitle = "What are you doing?!" })
                                ...
                                elseif (race and race.id == "T_Cyr_Ayleid") then
                                    -- If not already detected, mark the actor as having detected the player
                                    if not detectedActors[actor] then
                                        detectedActors[actor] = {
                                            detected = true,
                                    ...
                                    if not actorInfo.actionTriggered then
                                        ...
                                        tes3.say({ reference = actor, soundPath = "Vo\\Ay\\m\\Hlo_Ay024.mp3", subtitle = "You'll get more than you bargained for from me!" })
                                        if config.messagesOn then
                                            tes3.messageBox({ message = actor.object.name .. " asks you to leave." })
                                        end
                                        ...
                                        actorInfo.timer = timer.start{
                                            ...
                                            callback = function()
                                                ...
                                                tes3.say({ reference = actor, soundPath = "Vo\\Ay\\m\\Hlo_Ay022.mp3", subtitle = "Can't you see I wish to be left alone!" })
                                ...
                                elseif (race and race.id == "T_Val_Imga" and not actor.object.female) then
                                    -- If not already detected, mark the actor as having detected the player
                                    if not detectedActors[actor] then
                                        detectedActors[actor] = {
                                            detected = true,
                                    ...
                                    if not actorInfo.actionTriggered then
                                        ...
                                        tes3.say({ reference = actor, soundPath = "Va\\Vo\\img\\m\\Hlo_001.mp3", subtitle = "Leave me be..." })
                                        if config.messagesOn then
                                            tes3.messageBox({ message = actor.object.name .. " asks you to leave." })
                                        end
                                        ...
                                        actorInfo.timer = timer.start{
                                            ...
                                            callback = function()
                                                ...
                                                tes3.say({ reference = actor, soundPath = "Va\\Vo\\img\\m\\Hlo_008.mp3", subtitle = "Begone." })
                                ...
                                elseif config.noVoice then
                                    ...
                                    if not actorInfo.actionTriggered then
                                        ...
                                        tes3.messageBox({ message = actor.object.name .. ": Leave now." })
                                        if config.messagesOn then
                                            tes3.messageBox({ message = actor.object.name .. " asks you to leave." })
                                        end
    ...
    elseif isMatchingCell(playerCell.id) and (currentTime >= config.startTrespass or currentTime <= config.endTrespass) then
        ...
        -- Ensure the target is an NPC and not the player
            if actor and actor.object and actor.object.objectType == tes3.objectType.npc and actor ~= tes3.player then
                ...
                local health = actor.mobile.health.current
                if health == 0 then
                    -- Allow activation as normal since NPC is dead or incapacitated
                    return
                end
                ...
                if disposition and disposition >= config.disposition and config.dispOn then
                    ...
                    elseif race and race.id == "Argonian" then
                        tes3.say({ reference = actor, soundPath = "Vo\\a\\m\\Srv_AM006.mp3", subtitle = "Go away!" })
                        return false
                    elseif race and (race.id == "Khajiit" and actor.object.female) or (race.id == "T_Els_Cathay" and actor.object.female) or (race.id == "T_Els_Cathay-raht" and actor.object.female) or (race.id == "T_Els_Dagi-raht" and actor.object.female) or (race.id == "T_Els_Ohmes" and actor.object.female) or (race.id == "T_Els_Ohmes-raht" and actor.object.female) or (race.id == "T_Els_Suthay" and actor.object.female) or (race and race.id == "Dagi" and actor.object.female) or (race and race.id == "Pahmar" and actor.object.female) or (race and race.id == "Pahmar-Raht" and actor.object.female) or (race and race.id == "Tojay" and actor.object.female) or (race and race.id == "Tojay-Raht" and actor.object.female) then
                        tes3.say({ reference = actor, soundPath = "Vo\\k\\f\\Hlo_KF000e.mp3", subtitle = "Get out of here!" })
                        return false
                    elseif race and (race.id == "Khajiit") or (race.id == "T_Els_Cathay") or (race.id == "T_Els_Cathay-raht") or (race.id == "T_Els_Dagi-raht") or (race.id == "T_Els_Ohmes") or (race.id == "T_Els_Ohmes-raht") or (race.id == "T_Els_Suthay") or (race and race.id == "Dagi") or (race and race.id == "Pahmar") or (race and race.id == "Pahmar-Raht") or (race and race.id == "Tojay") or (race and race.id == "Tojay-Raht") then
                        tes3.say({ reference = actor, soundPath = "Vo\\k\\m\\Hlo_KM022.mp3", subtitle = "Go away! Do not come back!" })
                        return false

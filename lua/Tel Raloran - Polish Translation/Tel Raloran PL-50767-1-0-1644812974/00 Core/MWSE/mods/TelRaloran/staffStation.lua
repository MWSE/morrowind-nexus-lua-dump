local stationID = "_COR_lr_enchant_staff"
...
local function transferCharge(e, amount)
    ...
    tes3.messageBox("Laska została naładowana!")
end
    ...
    if e.target.object.id == stationID then
        ...
        if data.stationCharge > 1 then
            tes3ui.showInventorySelectMenu({
                ...
                noResultsText = "Nie masz żadnej laski, która wymaga naładowania.",
            ...
            tes3.messageBox("Stół wymaga naładowania.")
        end
    end
end

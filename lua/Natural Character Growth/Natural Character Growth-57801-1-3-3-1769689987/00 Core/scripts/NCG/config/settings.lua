...
local debugSettingsKey = "SettingsDebug" .. mDef.MOD_NAME
    ...
    [healthSettingsKey] = {
        ...
        settings = {
            ...
            },
            {
                ...
                argument = {
                    l10n = mDef.MOD_NAME,
                    items = { "baseHP25", "baseHP50", "baseHP75", "baseHP100", "baseHP125", "baseHP150", "baseHP175", "baseHP200" },
...
module.debugStorage = getStorage(debugSettingsKey)
...
module.getAttributeGeneralMaxValue = function()
    return getCapperActualValue(module.attributesStorage:get("attributeUncapper"))
end
...
module.initGlobalSettings = function()
    I.Settings.registerGroup(settingGroups[debugSettingsKey])
end
...
module.initPlayerSettings = function()
    ...
    module.attributesStorage:subscribe(async:callback(function(_, key)
...
local baseHPFactorUpgrade133 = {
    baseHPLow = "baseHP25",
    baseHPMedium = "baseHP50",
    baseHPHigh = "baseHP75",
    baseHPFull = "baseHP100",
}

module.upgradeSettings = function()
    if type(module.globalStorage:get("messagesLogKey")) == "number" then
        module.globalStorage:set("messagesLogKey", "")
    end
    local newBaseHPFactor = baseHPFactorUpgrade133[module.healthStorage:get("baseHPFactor")]
    if newBaseHPFactor then
        module.healthStorage:set("baseHPFactor", newBaseHPFactor)
    end
end

...
return {
    ...
    eventHandlers = {
        ...
        NPCSch_ResetShopFlag = function()
            shopVisitDone = false
        end,

        NPCSch_ResetTempleFlag = function()
            templeVisitDone = false
        end,

        -- global enables NPC inside shop: start wander
        NPCSch_StartShopWander = function()
            state = 'inside'
            AI.removePackages('Wander')
            AI.removePackages('Travel')
            AI.startPackage({
        ...
        NPCSch_InitShopVisit = function(data)
            if state then return end
        ...
        NPCSch_InitTempleVisit = function(data)
            if state then return end

...
function ObservatoryHatch:showOpenMessage()
    ...
    tes3.messageBox("Люк реагирует на Цветовой резонатор.")
...
function ObservatoryHatch:activate()
    ...
    local message = "Таинственный люк"
    tes3ui.showMessageMenu{
        message = message,
        buttons = {
            {
                text = "Установить Цветовой резонатор",
                enableRequirements = function()
                    return ObservatoryHatch.playerHasResonator()
                end,
                tooltipDisabled = "У вас нет Цветового резонатора.",
                callback = function()

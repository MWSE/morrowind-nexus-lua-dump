...
local playerSettings = require("scripts.QuickSelect.qs_settings")
...
local function SetRealtimeMenus()
	...
	I.UI.setPauseOnMode('Hotbar', playerSettings:get("realtimeHotbar") == false)
	I.UI.setPauseOnMode('QuickSelect', playerSettings:get("realtimeQuickSelect") == false)
end

...
I.Settings.registerPage {
    ...
    name = "QuickSelectUltimate v1.0",
    description = [[
    QuickSelectUltimate v1.0
    Base mod: SkyHasACat
    Rework: Skrow42
    ]]
}
...
description = [[
    ...
    Select the type of controls you want to use with the mod (Gamepad/Keyboard/Mouse).
    ...
    settings = {
        ...
        },
        {
            ...
            description =
            "If enabled, gamepad DPad and A button controls are active for hotbar and menu navigation/selection.",
            default = true
        },
        {
            key = "unEquipOnHotkey",
        ...
        },
        {
            ...
            description = "The keys used to select a different hotbar. If Disabled is used, no keys are bound for bar selection. If Shift Modifier is used, shift+1-3 will select the corresponding hotbar. If -/= Keys is used, - and = will select the previous and next hotbars. If [/] Keys is used, [ and ] will select the previous and next hotbars.\n\nThe described keys should be unbound in the settings if you'd like to use them. The same applies to the DPad.",
            argument = {
                disabled = false,

...
local function addSideBar(component)
    local versionText = string.format("Модуль ремесла, версия 1.23.1")
...
local function registerMCM()
    ...
    page:createSlider{
        ...
        description = "Установите процент восстановления материалов при уничтожении предмета. Это значение может быть изменено настройками конкретного мода или рецепта. По умолчанию: 75%",
        min = 0,
        max = 100,
        step = 1,
    ...
    page:createKeyBinder{
        ...
        description = "Назначает кнопку для рецептов установленных `quickActivateCallback`. По умолчанию: Left Shift",

...
local MenuActivator = {
    schema = {
        ...
        fields = {
            ...
            craftButtonText = { type = "string", default = "Создать", required = false },
            recipeHeaderText = { type = "string", default = "Рецепты", required = false },
            skillsHeaderText = { type = "string", default = "Навыки", required = false },
            customRequirementsHeaderText = { type = "string", default = "Требования", required = false },
            toolsHeaderText = { type = "string", default = "Инструменты", required = false },
            materialsHeaderText = { type = "string", default = "Материалы", required = false },
...
function MenuActivator:openMenu()
    ...
    if knowsRecipe then
        ...
        tes3.messageBox("Вы не знаете ни одного рецепта.")
    end
end

...
local SC = {
	...
	abeceancomp = "vaib_stock_abeceancomp",
	blackisle = "vaib_stock_blackisle",
	southpoint = "vaib_stock_southpoint",
	whitescarab = "vaib_stock_whitescarab",
...
defns.daily_changes = {
	...
	---Black Isle Company
	{id=SC.blackisle, min=-12, max=14, swan_chance=30},
	---Southpoint
	{id=SC.southpoint, min=-10, max=7, swan_chance=40},
	---White Scarab
	{id=SC.whitescarab, min=-6, max=9, swan_chance=55},
	---Abecean
	{id=SC.abeceancomp, min=-10, max=13, swan_chance=45},
	
	---Ebony
	{id=CC.ebony, min=-12, max=10, swan_chance=20},
	---Kwama
	...
	---Fish
	{id=CC.fish, min=-4, max=3, swan_chance=75},
...
defns.quest_progress_bonuses = {
    ...
    ["tr_m4_il_grudge"]={{index=130; penalties={{id=SC.hlaalu; min=90; max=95}}}};
    ...
    ["tr_m1_ht_unseatingdral"]={{index=100; bonuses={{id=SC.telvanni; min=125; max=145}}}};
	...
	---tr firemoth
    ["tr_m3_il_firemothrebuilt_hla"]={{index=100; bonuses={{id=SC.hlaalu; min=110; max=120}}}};
    ["tr_m3_il_firemothrebuilt_red"]={{index=100; bonuses={{id=SC.redoran; min=110; max=120}}}};
    ["tr_m3_il_firemothrebuilt_tel"]={{index=100; bonuses={{id=SC.telvanni; min=110; max=120}}}};
	...
	["tr_m3_eec_cano1"]={{index=200; bonuses={{id=SC.eec; min=105; max=110}}}};

	["tr_m3_eec_cano2"]={{index=200; bonuses={{id=SC.eec; min=105; max=110}}}};

	["tr_m3_eec_cano4"]={{index=200; bonuses={{id=SC.eec; min=105; max=110}}}};

	["tr_m3_eec_cano5"]={{index=200; bonuses={{id=SC.eec; min=105; max=110}}}};

	["tr_m3_eec_cano6"]={{index=210; bonuses={{id=SC.eec; min=105; max=110}}}};

	["tr_m1_eec_lora"]={{index=30; bonuses={{id=SC.eec; min=105; max=110}}}};
	
    ["tr_m1_eec_lora2"]={
       {index=30; bonuses={{id=SC.eec; min=105; max=110}}};
       {index=35; bonuses={{id=SC.eec; min=105; max=110}}};
    };
    ...
    ["vaib_an02_loan"]={{index=130; bonuses={{id=SC.impbank; min=102; max=108}}}};
 
    ["vaib_an03_loan"]={{index=120; bonuses={{id=SC.impbank; min=102; max=108}}}};
 
    ["vaib_an04_loan"]={{index=120; bonuses={{id=SC.impbank; min=102; max=108}}}};
	
    ["vaib_an05_debt"]={{index=100; bonuses={{id=SC.impbank; min=105; max=115}}}};
	
    ["vaib_an06_machine"]={
       {index=100; bonuses={{id=SC.impbank; min=120; max=130}; {id=CC.fish; min=1200; max=2600}}};
    };
	
    ["vaib_ins1"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
    ["vaib_ins2"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins3"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins4"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins5"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins6"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins7"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins8"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins9"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins10"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins11"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins12"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	["vaib_ins13"]={{index=100; bonuses={{id=SC.impbank; min=100; max=102}}}};
	
	["vaib_ns02_advert"]={{index=100; bonuses={{id=SC.impbank; min=105; max=125}}}};
 
 
	---misc tr
    ["tr_m3_bo_burglar1"]={{index=100; bonuses={{id=SC.indoril; min=105; max=110}}}};
	
    ["tr_m3_bo_burglar2"]={
       {index=110; bonuses={{id=SC.indoril; min=105; max=110}}};
       {index=111; bonuses={{id=SC.indoril; min=105; max=110}}};
    };
	
    ["tr_m3_do_velk"]={
       {index=110; bonuses={{id=SC.indoril; min=105; max=110}}};
       {index=50; penalties={{id=SC.indoril; min=90; max=95}}};
    };
	
	
    ---fighters guild pc
    ["pc_m1_fg_anv1"]={{min_index=100; bonuses={{id=SC.fighters; min=105; max=115}}}};
	
    ["pc_m1_fg_anv2"]={{min_index=100; bonuses={{id=SC.fighters; min=105; max=115}}}};
	
    ["pc_m1_fg_anv3"]={{min_index=100; bonuses={{id=SC.fighters; min=105; max=115}}}};
	
    ["pc_m1_fg_anv4"]={{min_index=100; bonuses={{id=SC.fighters; min=105; max=115}}}};
	
    ["pc_m1_fg_anv5"]={
       {index=110; bonuses={{id=SC.fighters; min=105; max=115}}};
       {index=110; bonuses={{id=SC.fighters; min=105; max=115}}};
    };
	
    ["pc_m1_fg_anv6"]={
       {index=100; bonuses={{id=SC.fighters; min=105; max=115}}};
       {index=150; bonuses={{id=SC.fighters; min=115; max=125}}};
    };
	
    ["pc_m1_fg_anv7"]={
       {index=100; bonuses={{id=SC.fighters; min=105; max=115}}};
       {index=150; bonuses={{id=SC.fighters; min=105; max=115}}};
	   {min_index=200; penalties={{id=SC.fighters; min=90; max=95}}};
    };
	
    ["pc_m1_fg_anv8"]={{min_index=100; bonuses={{id=SC.fighters; min=110; max=120}}}};

...
local SC = {
	...
	kinganvil = "vaib_stock_kinganvil",
	kingsutch = "vaib_stock_kingsutch",
	kingkvatch = "vaib_stock_kingkvatch",
...
defns.daily_changes = {
	...
	---Kingdom of Anvil
	{id=SC.kinganvil, min=-4, max=3, swan_chance=60},
	---Kingdom of Kvatch
	{id=SC.kingkvatch, min=-4, max=2, swan_chance=45},
	---Kingdom of Sutch
	{id=SC.kingsutch, min=-3, max=2, swan_chance=65},
	---Black Isle Company

...
defns.daily_changes = {
	---House Hlaalu
	{id=SC.hlaalu, min=-8, max=4, swan_chance=35},
	---House Telvanni
	{id=SC.telvanni, min=-12, max=8, swan_chance=25},
	---House Redoran
	{id=SC.redoran, min=-4, max=3, swan_chance=45},
	---House Indoril
	{id=SC.indoril, min=-4, max=3, swan_chance=60},
	---House Dres
	{id=SC.dres, min=-4, max=2, swan_chance=60},
	---EEC
	{id=SC.eec, min=-6, max=4, swan_chance=35},
	---Imperial Bank
	{id=SC.impbank, min=-7, max=7, swan_chance=35},
	---Mages Guild
	{id=SC.mages, min=-7, max=5, swan_chance=45},
	---Fighters Guild
	{id=SC.fighters, min=-8, max=5, swan_chance=40},
	---Zafirbel Bay Company
	{id=SC.zafirbel, min=-5, max=8, swan_chance=30},
	---Bear Clan
	{id=SC.bearclan, min=-20, max=10, swan_chance=15},
	---Ebony
	{id=CC.ebony, min=-9, max=5, swan_chance=20},
	---Kwama
	{id=CC.kwama, min=-2, max=3, swan_chance=45},
	---Saltrice
	{id=CC.saltrice, min=-2, max=3, swan_chance=45},
	---Gold
	{id=CC.gold, min=-9, max=5, swan_chance=25},
	---Glass
	{id=CC.glass, min=-7, max=5, swan_chance=35},
	---Mead
	{id=CC.mead, min=-2, max=4, swan_chance=65},
	---Hides
	{id=CC.hides, min=-4, max=3, swan_chance=55},
	---Comberries
	{id=CC.comberries, min=-2, max=3, swan_chance=65},
}

...
local function magMod(modVal)
  ...
  -- damage check
  if attributes.intelligence(self).modifier == attributes.intelligence(self).damage then
    attributes.intelligence(self).modifier = 0
    attributes.intelligence(self).damage = 0
  end
  if attributes.willpower(self).modifier == attributes.willpower(self).damage then

...
local Anims = {
	firstPerson = {
		...
		sneakforward = { g="sneakforward_base", velocity=C.first.sneak, max=10000, hasSkipKey=true },
		sneakback = { g="sneakback_base", velocity=C.first.sneak, max=10000, hasSkipKey=true },
		sneakleft = { g="sneakleft_base", velocity=C.first.sneak, max=10000, hasSkipKey=true },
		sneakright = { g="sneakright_base", velocity=C.first.sneak, max=10000, hasSkipKey=true },
		maxWalk = 10000, maxRun = 10000
	},
	thirdPerson = {
		walkforward = { g="walkforward_spd09", velocity=154, max=10000, hasSkipKey=true },

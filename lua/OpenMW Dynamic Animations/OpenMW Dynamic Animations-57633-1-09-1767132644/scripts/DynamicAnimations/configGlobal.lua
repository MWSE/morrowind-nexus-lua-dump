local presets = {
	...
	idle_armsakimbo = { id = "armsakimbo", priority = 0,
		...
		opt = {loops=2, priority=1, blendMask=12, isBlend=true}
	},
	idle_armsakimbo_switch = { id = "armsakimbo", priority = 0,
		modify = { speeds={ 0.7, 0.6, 0.7, 0.8 } },
		masks={4, 8, 12, 4, 8, 12}, opt = { loops=3, priority=1 }
	},
	...
	idle_armsfolded = { id = "armsfolded", priority = 0,
		modify = { speeds={ 0.7, 0.6, 0.7, 0.8 } },
		opt = {loops=2, priority=1, blendMask=12}
	},
	idle4 = { id = "idle4", priority = 0, opt = {priority=1, blendMask=8} },
	idle5 = { id = "idle5", priority = 0, opt = {priority=1, blendMask=8} },
	idle7 = { id = "idle7", priority = 0, opt = {priority=1, blendMask=8, loops=1} },
	idle8 = { id = "idle8", priority = 0, opt = {priority=1, blendMask=8, loops=1} },

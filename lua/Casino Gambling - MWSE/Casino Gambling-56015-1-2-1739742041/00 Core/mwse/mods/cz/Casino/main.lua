...
local function panicButton(e)
    if(e.keyCode == tes3.scanCode["l"]) then
        ...
        if(menu ~= tes3ui.getMenuOnTop() and tes3ui.findMenu(menus.blackjackMenuID) ~= tes3ui.getMenuOnTop()) then return end
        clearGamblingMenu()
...
-- Skeleton for a generic bet menu with a slider and and confirm button
    ...
    confirmButton:register("mouseClick", function()
        if betTotal > 0 then
            ...
            if playerGold >= betTotal then
                ...
                local luck = tes3.mobilePlayer.luck.current/10

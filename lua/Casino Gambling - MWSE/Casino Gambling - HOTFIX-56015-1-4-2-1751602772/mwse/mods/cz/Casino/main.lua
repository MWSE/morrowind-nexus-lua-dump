...
local menus = {
    ...
    mahjongMenuID = tes3ui.registerID("MahjongMenu")
}
...
-- Dummy so it's not double registered
local function placeBetDown() end
...
local function createRouletteMenu()
    -- Clear existing menu
    --clearGamblingMenu()   -- causes mempointer errors, what was I thinking???
    ...
    local numSliderLabel
    if(DEBUG) then numSliderLabel = labelBlock:createLabel({ text = "0" }) end
    ----------------------------
    ...
    ------------DEBUG-----------
    local numSliderDebug
    if(DEBUG) then
        numSliderDebug = sliderBlock:createSlider({ current = 0, max = 38, step = 1, jump = 10 })
        numSliderDebug.width = minWidth * 0.25
        numSliderDebug:register("PartScrollBar_changed", function() numSliderLabel.text = string.format("%d", numSliderDebug.widget.current)
    end)
    end
    ----------------------------
    ...
    local betAreas = {
        ...
        { name = "Split 1-4",   bounds = { x = cursorX-46,    y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 64
        { name = "Split 2-5",   bounds = { x = cursorX-46,    y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 65
        { name = "Split 3-6",   bounds = { x = cursorX-46,    y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 66
        { name = "Split 4-7",   bounds = { x = cursorX-2,     y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 67
        { name = "Split 5-8",   bounds = { x = cursorX-2,     y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 68
        { name = "Split 6-9",   bounds = { x = cursorX-2,     y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 69
        { name = "Split 7-10",  bounds = { x = cursorX+42,    y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 70
        { name = "Split 8-11",  bounds = { x = cursorX+42,    y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 71
        { name = "Split 9-12",  bounds = { x = cursorX+42,    y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 72
        { name = "Split 10-13", bounds = { x = cursorX+86,    y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 73
        { name = "Split 11-14", bounds = { x = cursorX+86,    y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 74
        { name = "Split 12-15", bounds = { x = cursorX+86,    y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 75
        { name = "Split 13-16", bounds = { x = cursorX+131-1, y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 76
        { name = "Split 14-17", bounds = { x = cursorX+131-1, y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 77
        { name = "Split 15-18", bounds = { x = cursorX+131-1, y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 78
        { name = "Split 16-19", bounds = { x = cursorX+175-2, y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 79
        { name = "Split 17-20", bounds = { x = cursorX+175-2, y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 80
        { name = "Split 18-21", bounds = { x = cursorX+175-2, y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 81
        { name = "Split 19-22", bounds = { x = cursorX+219-2, y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 82
        { name = "Split 20-23", bounds = { x = cursorX+219-2, y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 83
        { name = "Split 21-24", bounds = { x = cursorX+219-2, y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 84
        { name = "Split 22-25", bounds = { x = cursorX+263-2, y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 85
        { name = "Split 23-26", bounds = { x = cursorX+263-2, y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 86
        { name = "Split 24-27", bounds = { x = cursorX+263-2, y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 87
        { name = "Split 25-28", bounds = { x = cursorX+307-2, y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 88
        { name = "Split 26-29", bounds = { x = cursorX+307-2, y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 89
        { name = "Split 27-30", bounds = { x = cursorX+307-2, y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 90
        { name = "Split 28-31", bounds = { x = cursorX+351-2, y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 91
        { name = "Split 29-32", bounds = { x = cursorX+351-2, y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 92
        { name = "Split 30-33", bounds = { x = cursorX+351-2, y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 93
        { name = "Split 31-34", bounds = { x = cursorX+396-2, y = -cursorY+155+80, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 94
        { name = "Split 32-35", bounds = { x = cursorX+396-2, y = -cursorY+215+75, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 95
        { name = "Split 33-36", bounds = { x = cursorX+396-2, y = -cursorY+274+72, width = 6, height = 44 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 17 }, -- 96

        { name = "Street 1-2-3",    bounds = { x = cursorX-68,     y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 97
        { name = "Street 4-5-6",    bounds = { x = cursorX-24,     y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 96
        { name = "Street 7-8-9",    bounds = { x = cursorX+20,     y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 99
        { name = "Street 10-11-12", bounds = { x = cursorX+65-2,   y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 100
        { name = "Street 13-14-15", bounds = { x = cursorX+110-3,  y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 101
        { name = "Street 16-17-18", bounds = { x = cursorX+155-4,  y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 102
        { name = "Street 19-20-21", bounds = { x = cursorX+200-5,  y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 103
        { name = "Street 22-23-24", bounds = { x = cursorX+245-6,  y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 104
        { name = "Street 25-26-27", bounds = { x = cursorX+290-7,  y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 105
        { name = "Street 28-29-30", bounds = { x = cursorX+335-8,  y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 106
        { name = "Street 31-32-33", bounds = { x = cursorX+380-9,  y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 107
        { name = "Street 34-35-36", bounds = { x = cursorX+425-10, y = -cursorY+288+87, width = 32, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 108

        { name = "Basket 1-0-2",  bounds = { x = cursorX-89+1, y = -cursorY+176+87, width = 6, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 109
        { name = "Basket 0-2-00", bounds = { x = cursorX-89+1, y = -cursorY+205+85, width = 6, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 110
        { name = "Basket 2-00-3", bounds = { x = cursorX-89+1, y = -cursorY+233+87, width = 6, height = 6 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 11 }, -- 111

        { name = "Corner 1-2-4-5",       bounds = { x = cursorX+ -46, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 112
        { name = "Corner 2-3-5-6",       bounds = { x = cursorX+ -46, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 113
        { name = "Corner 4-5-7-8",        bounds = { x = cursorX+ -2, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 114
        { name = "Corner 5-6-8-9",        bounds = { x = cursorX+ -2, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 115
        { name = "Corner 7-8-10-11",      bounds = { x = cursorX+ 42, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 116
        { name = "Corner 8-9-11-12",      bounds = { x = cursorX+ 42, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 117
        { name = "Corner 10-11-13-14",    bounds = { x = cursorX+ 86, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 118
        { name = "Corner 11-12-14-15",    bounds = { x = cursorX+ 86, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 119
        { name = "Corner 13-14-16-17", bounds = { x = cursorX+ 131-1, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 120
        { name = "Corner 14-15-17-18", bounds = { x = cursorX+ 131-1, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 121
        { name = "Corner 16-17-19-20", bounds = { x = cursorX+ 175-2, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 122
        { name = "Corner 17-18-20-21", bounds = { x = cursorX+ 175-2, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 123
        { name = "Corner 19-20-22-23", bounds = { x = cursorX+ 219-2, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 124
        { name = "Corner 20-21-23-24", bounds = { x = cursorX+ 219-2, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 125
        { name = "Corner 22-23-25-26", bounds = { x = cursorX+ 263-2, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 126
        { name = "Corner 23-24-26-27", bounds = { x = cursorX+ 263-2, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 127
        { name = "Corner 25-26-28-29", bounds = { x = cursorX+ 307-2, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 128
        { name = "Corner 26-27-29-30", bounds = { x = cursorX+ 307-2, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 129
        { name = "Corner 28-29-31-32", bounds = { x = cursorX+ 351-2, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 130
        { name = "Corner 29-30-32-33", bounds = { x = cursorX+ 351-2, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 131
        { name = "Corner 31-32-34-35", bounds = { x = cursorX+ 396-2, y = -cursorY+176+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 132
        { name = "Corner 32-33-35-36", bounds = { x = cursorX+ 396-2, y = -cursorY+233+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 8 }, -- 133

        { name = "Top Line 0-00-1-2-3", bounds = { x = cursorX-89+1, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 6 }, -- 134

        { name = "Six Line 1 to 6",    bounds = { x = cursorX-46, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 135
        { name = "Six Line 4 to 9",     bounds = { x = cursorX-2, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 136
        { name = "Six Line 7 to 12",      bounds = { x = cursorX+42, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 137
        { name = "Six Line 10 to 15",     bounds = { x = cursorX+86, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 138
        { name = "Six Line 13 to 18",  bounds = { x = cursorX+131-1, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 139
        { name = "Six Line 16 to 21",  bounds = { x = cursorX+175-2, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 140
        { name = "Six Line 19 to 24",  bounds = { x = cursorX+219-2, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 141
        { name = "Six Line 22 to 27",  bounds = { x = cursorX+263-2, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 142
        { name = "Six Line 25 to 30",  bounds = { x = cursorX+307-2, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 143
        { name = "Six Line 28 to 33",  bounds = { x = cursorX+351-2, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 144
        { name = "Six Line 31 to 36",  bounds = { x = cursorX+396-2, y = -cursorY+288+87, width = 10, height = 10 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 5 }, -- 145

        { name = "1st Dozen 1 to 12",  bounds = { x = cursorX+466-8, y = -cursorY+155+80, width = 40, height = 50 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 146
        { name = "2nd Dozen 13 to 24", bounds = { x = cursorX+466-8, y = -cursorY+215+75, width = 40, height = 50 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 147
        { name = "3rd Dozen 25 to 36", bounds = { x = cursorX+466-8, y = -cursorY+274+72, width = 40, height = 50 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 148

        { name = "1st Column 1 to 34",     bounds = { x = cursorX-2, y = -cursorY+178, width = 174, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 149
        { name = "2nd Column 2 to 35", bounds = { x = cursorX+175-2, y = -cursorY+178, width = 174, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 150
        { name = "3rd Column 3 to 36", bounds = { x = cursorX+351-2, y = -cursorY+178, width = 174, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 151

        { name = "1st Half 1 to 18",  bounds = { x = cursorX-46,    y = -cursorY+122, width = 86, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 152
        { name = "2nd Half 19 to 36", bounds = { x = cursorX+396-3, y = -cursorY+122, width = 86, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 2 }, -- 153

        { name = "Red",   bounds = { x = cursorX+131-1, y = -cursorY+122, width = 86, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 1 }, -- 154
        { name = "Black", bounds = { x = cursorX+219-2, y = -cursorY+122, width = 86, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 1 }, -- 155
        { name = "Even",  bounds = { x = cursorX+42,    y = -cursorY+122, width = 86, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 1 }, -- 156
        { name = "Odd",   bounds = { x = cursorX+307-2, y = -cursorY+122, width = 86, height = 56 }, bet = 0, chip = menu:createImage({ path = "textures/cz/casino/roulette_chip.dds" }), payout = 1 }, -- 157
    }
    ...
    local betAreaWins = {       -- number     -- split      -- spilt       -- split 2     -- split 2     -- street      -- basket      -- basket      -- basket      -- corner      -- corner      -- corner      -- corner      -- 2xline      -- 2xline      -- dozen       -- column      -- half        -- r/b         -- odd/even
        ...
        { name =  "2", wins = { betAreas[4],  betAreas[40], betAreas[41],  betAreas[65],                 betAreas[97],  betAreas[109], betAreas[110], betAreas[111], betAreas[112], betAreas[113],                               betAreas[134], betAreas[135], betAreas[146], betAreas[150], betAreas[152], betAreas[155], betAreas[156] } },
        ...
        { name =  "4", wins = { betAreas[6],  betAreas[42],                betAreas[64],  betAreas[67],  betAreas[98],                                               betAreas[112], betAreas[114],                               betAreas[135], betAreas[136], betAreas[146], betAreas[149], betAreas[152], betAreas[155], betAreas[156] } },
        ...
        { name = "25", wins = { betAreas[27], betAreas[56],                betAreas[85],  betAreas[88],  betAreas[105],                                              betAreas[126], betAreas[128],                               betAreas[142], betAreas[143], betAreas[148], betAreas[149], betAreas[153], betAreas[154], betAreas[157] } },
        ...
        { name = "28", wins = { betAreas[30], betAreas[58],                betAreas[88],  betAreas[91],  betAreas[106],                                              betAreas[128], betAreas[130],                               betAreas[143], betAreas[144], betAreas[148], betAreas[149], betAreas[153], betAreas[155], betAreas[156] } },
        ...
        { name = "35", wins = { betAreas[37], betAreas[62], betAreas[63],  betAreas[95],                 betAreas[108],                                              betAreas[132], betAreas[133],                               betAreas[145],                betAreas[148], betAreas[150], betAreas[153], betAreas[155], betAreas[157] } },
    ...
    placeBetDown = function(e)
        ...
        if not betLabel or not betLabel.parent then
            if(DEBUG) then
                if not betLabel then mwse.log("no label") end
                if not labelBlock then mwse.log("no labelblock") end
                if not menuBox then mwse.log("no menubox") end
                if not menu then mwse.log("no menu") end
                mwse.log("wtf no label")
            end
            return
        end
    ...
    -- In retrospect, probably not necessary but whatever
    if not event.isRegistered(tes3.event.mouseButtonDown, placeBetDown) then event.register(tes3.event.mouseButtonDown, placeBetDown) end
    ...
    confirmButton:register("mouseClick", function()
        if betTotal > 0 then
            ...
            if playerGold >= betTotal then
                ...
                ------------DEBUG-----------
                if(DEBUG and tonumber(numSliderLabel.text) < 38 ) then randNum = tonumber(numSliderLabel.text) end
                if(DEBUG) then mwse.log("confirmbtn") end
                ----------------------------
                ...
                for _, area in ipairs(betAreaWins) do
                    ...
                    if((area.name == "00" and randNum == 37) or areaToNum == randNum) then
                        ...
                        for _, win in ipairs(area.wins) do
                            ...
                            if(DEBUG and win.bet > 0) then mwse.log(win.name) end
                        end
                ...
                betWins = 0 -- cleanup
                event.unregister(tes3.event.mouseButtonDown, placeBetDown)
                clearGamblingMenu()
                tes3ui.leaveMenuMode()
            else
                tes3.messageBox("You do not have enough gold to make a bet of %d. You have %d gold.", betTotal, playerGold)
...
-- Create the Mahjong Menu
local function createMahjongMenu()
    -- Clear existing menu
    --clearGamblingMenu()
    ...
    -- Create the menu
    local menu = tes3ui.createMenu({ id = menus.mahjongMenuID, fixedFrame = true })
    menu.width = 200
    menu.height = 150
    menu.minWidth = 200
    menu.minHeight = 150
    ...
    local tokenLabel = mainBlock:createLabel({ text = "Bet Amount: 1" })
    local betSlider = mainBlock:createSlider({ current = 0, max = 199, step = 1, jump = 10 })
    betSlider.width = menu.width * 0.75
    local oppLabel = mainBlock:createLabel({ text = "Player Count: 2" })
    local oppSlider = mainBlock:createSlider({ current = 0, max = 2, step = 1, jump = 1 })
    oppSlider.width = menu.width * 0.5
    ...
    -- Update Player Count
    oppSlider:register("PartScrollBar_changed", function()
        oppCount = oppSlider.widget.current+2
        oppLabel.text = string.format("Player Count: %d", oppCount)
    end)
    ...
    confirmButton:register("mouseClick", function()
        if betTotal > 0 then
            ...
            if playerGold >= betTotal then
                tes3.removeItem({ reference = tes3.player, item = "gold_001", count = betTotal })
                tes3.setGlobal("csn_mahjong_money", betTotal)
                tes3.setGlobal("csn_mahjong_opps",  oppCount)
                tes3.setGlobal("csn_mahjong_bet", 1)
    ...
    -- Enter menu mode
    tes3ui.enterMenuMode(menus.mahjongMenuID)
end
...
local function onActivate(e)
    ...
    elseif e.target.object.id:lower() == "csn_mahjong_box" then
        e.block = true
        if(tes3.getGlobal("csn_mahjong_bet") > 0) then tes3.messageBox("There is already an active game of Mazte.")
        elseif(tes3.getGlobal("csn_casino_banned") > 0) then tes3.messageBox("You have been banned from playing games here.")
        else createMahjongMenu() end
    end
end
...
local function rewardMoney(e)
    ...
    elseif e.target.object.id:lower() == "csn_mahjong_reward" then
        e.block = true
        tes3.addItem({ reference = tes3.player, item = "gold_001", count = tes3.getGlobal("csn_mahjong_result"), showMessage = true })
        tes3.setGlobal("csn_mahjong_wins", (tes3.getGlobal("csn_mahjong_wins") + 1))
    end
end

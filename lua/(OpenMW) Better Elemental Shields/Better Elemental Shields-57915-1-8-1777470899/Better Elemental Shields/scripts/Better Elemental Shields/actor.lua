...
local function onElementalShieldDamage(data)
	...
	if data.stun then
		...
		if math.random() < chance then
			if fatigueRevertTimerStopFunction then
				fatigueRevertTimerStopFunction()
				--fatigueRevertTimerStopFunction = nil --below
			else
...
local function onInactive()
	...
	if repeatedSlowApplication then
		repeatedSlowApplication()
		repeatedSlowApplication = nil
	end
	revertFatigue()
	removeAllVfx()

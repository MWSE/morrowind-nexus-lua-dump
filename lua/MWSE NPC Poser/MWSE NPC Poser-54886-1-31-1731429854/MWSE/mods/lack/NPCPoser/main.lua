...
local configDefault = {
	...
	-- nextAnimHotkey = tes3.scanCode.numpad7
	-- prevAnimHotkey = tes3.scanCode.numpad4
	-- nextIdle = tes3.scanCode.numpad8
	-- prevIdle = tes3.scanCode.numpad2
}
...
local function animate(e)
	...
	if ( e.isShiftDown and ( p.data.NPCPoser.posing == true ) ) then -- Cycle idles
		...
		tes3.messageBox("Idle %s", ( currIdle + 1 ))

...
local firstPersonMessages = {
    "Слишком тесно. Мне нужно больше места, чтобы встать.",
    "Нужно найти более открытое место, чтобы подняться.",
    "Я ударюсь головой, если встану сейчас.",
}

-- Messages for Khajiit
local firstPersonkahjiitMessages = {
    "Хаджиту нужно больше места, чтобы распрямиться.",
    "Хаджиту нужен простор, чтобы встать."
}

-- Messages in third person for those that prefer it
local thirdPersonMessages = {
    "Недостаточно места, чтобы встать.",
    "Нужно найти более открытое место, чтобы подняться.",
    "Слишком тесно, чтобы встать.",
}

...
do --register vanilla tools/stations
    ...
    local stations = {
        { id = "furn_anvil00", name = "Наковальня", toolIdPattern = "Молот"  },
        { id = "furn_t_fireplace_01", name = "Кузница", toolIdPattern = "Клещи"   },
        { id = "furn_de_forge_01", name = "Кузница", toolIdPattern = "Клещи" },
        { id = "furn_de_bellows_01", name = "Кузница", toolIdPattern = "Клещи" },
        { id = "Furn_S_forge", name = "Кузница", toolIdPattern = "Клещи" },
    }

...
local function addDegradationText(tooltip, item, itemData, conditionBlock)
    ...
    local degradationText = string.format("Деградация: %d", degradationLevel)
...
local function addEnhancementText(tooltip, item, itemData, conditionBlock)
    ...
    local enhancementText = string.format("Усиление: +%d", enhancementLevel)
...
local function getWeaponEnhanceSuffix(weapon)
    local default = "Предмет усилен"
    local typeMapping = {
        [tes3.weaponType.bluntOneHand] = "Предмет усилен",
        [tes3.weaponType.bluntTwoClose] = "Предмет усилен",
        [tes3.weaponType.bluntTwoWide] = "Предмет усилен",
        [tes3.weaponType.marksmanBow] = "Предмет усилен",
        [tes3.weaponType.marksmanCrossbow] = "Предмет усилен",
    }

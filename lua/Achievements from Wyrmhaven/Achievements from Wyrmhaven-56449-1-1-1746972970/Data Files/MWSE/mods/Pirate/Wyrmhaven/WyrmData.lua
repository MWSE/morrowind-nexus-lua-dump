...
function wData.onEquip(e)
    ...
    if not tes3.player.data.achievements.Wyrm_black_knight then
        ...
        if e.reference == tes3.player then --если игрок, то
          ...
          if bootsBlack and bootsBlack.object.id == "_WYRM_black_boots"
          and gauntlet_leftBlack and gauntlet_leftBlack.object.id == "_WYRM_black_gauntlet_left"
          and gauntlet_rightBlack and gauntlet_rightBlack.object.id == "_WYRM_black_gauntlet_right"
          and helmBlack and helmBlack.object.id == "_WYRM_black_helm"
          and cuirassBlack and cuirassBlack.object.id == "_WYRM_black_tabard"
          then
...
function wData.countSirUldorCorpse(e)
    ...
    if tes3.getJournalIndex { id = "WYRM_19_Chimeranyon" } == 30
        ...
        if e.reference == tes3.player then
            ...
            if shieldUldor and shieldUldor.object.id == "_WYRM_sir_uldor_corpse" then

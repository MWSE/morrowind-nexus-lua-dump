...
local function getClassSpecializationBonus()
    ...
    if classRecord and classRecord.specialization == "magic" then
...
local function registerClassBonusModifier()
    ...
    I.SkillFramework.registerDynamicModifier(SKILL_ID, "Staves_ClassSpecializationBonus", getClassSpecializationBonus)

...
local function isVivecLevitationAllow(data)
    return startsWith(data.cellName,"Vivec, Temple") or startsWith(data.cellName, "Ministry of Truth") 
end
...
return {
    ...
    isCities = isCities,
    isVivec = isVivec,
    isVivecLevitationAllow = isVivecLevitationAllow,

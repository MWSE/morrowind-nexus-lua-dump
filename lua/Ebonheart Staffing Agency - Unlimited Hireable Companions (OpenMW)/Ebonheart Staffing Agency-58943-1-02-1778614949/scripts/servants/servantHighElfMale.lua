...
local LABEL = "High Elf Male"
local NAME_KEY = "high_elf_male"
local IS_MALE = true
...
local FIRST_NAMES = { "Surerndur", "Caurtil", "Norion", "Aesmer", "Aesril", "Aicaano", "Aicessar", "Ainaame", "Alamar", "Aldarch", "Aldarnen", "Alderdon", "Aldimion", "Aldolin", "Aldotarel", "Almion", "Alrdorion", "Alturco", "Amaalmo", "Amballicil", "Ambalor", "Ambucilion", "Aminyon", "Amuur", "Amyril", "Anarume", "Ancalmo", "Ancarive", "Ancelhros", "Ancemen", "Ancolcalion", "Ancolnur", "Anconath", "Andame", "Andresalmo", "Andur", "Angamar", "Angardil", "Angedreth", "Angiente", "Anginil", "Ango", "Angolin", "Anirlo", "Anquen", "Antarandur", "Antur", "Anyon", "Aonus", "Aracar", "Arantar", "Arartar", "Arathel", "Arcarin", "Archmage", "Archmaster", "Arcorion", "Ardorin", "Arelian", "Arelmo", "Arillas", "Arindur", "Arrimoril", "Artisan", "Arunen", "Aryamo", "Aryon", "Astor", "Atalmo", "Ateldil", "Atirion", "Avys", "Babblebrook", "Bailiff", "Battlereeve", "Black", "Bombast", "Bosun", "Caalore", "Caalorne", "Caano", "Caerel", "Cainar", "Calanor", "Calastil", "Calcamar", "Caldandien", "Caldartur", "Caldelnalin", "Caldien", "Caldil", "Caledeen", "Calenus", "Calibar", "Calondil", "Calpelion", "Calpion", "Calpydir", "Calunorril", "Caluurion", "Camarino", "Candle-Maker", "Canonreeve", "Canuldil", "Filuntol", "Henaamo", "Henyon", "Sarandil", "Telomure", "Tendil", "Trelano", "Carethil", "Carmion", "Carnirrimo", "Cassirion", "Ceborn", "Cingarfin", "Cinildil", "Cinnar", "Cinosarion" }
local LAST_NAMES = { "Tilcalar", "Camaano", "Siniel", "Ateldil", "Two-Blades", "Lenarmen", "Areleth", "Calbalion", "Cintuumetil", "Ellildoril", "Erator", "Henlandon", "Hererquen", "Lisagnor", "Naramin", "Roland", "Sorriel", "Teldigaran", "Tuinorion", "Urcelmo", "Firen", "Farmeldo", "Rinfarrin", "Sinyon", "Valano", "Camarelur", "Sanamen", "Elpion", "Squan", "Malin", "Midalmo", "Vindur", "Simohil", "Tilnygaran", "Leythen", "Lloderion", "Monwe", "Turvon", "Urayel", "Earil", "Hadelar", "Andulalion", "Sintinlin", "Niramo", "Blenwyth", "Loganne", "Rilis", "Knight", "Tarma", "Cimerhros", "Lentidorn", "Thetathor", "Soravil", "Alarnon", "Elanar", "Fannariel", "Farulnor", "Hyircil", "Oradel", "Rolumdel", "Tanorian", "Moladucil", "Nemfarion", "Paredan", "Norfando", "Tanacar", "Uulion", "Celarus", "Earrel", "Firruldoril", "Nenaron", "Nuleros", "Enelon", "Linalion", "Naalirnenil", "Elundur", "Duure", "Erancar", "Mormalion", "Glenadir", "Ruurifin" }

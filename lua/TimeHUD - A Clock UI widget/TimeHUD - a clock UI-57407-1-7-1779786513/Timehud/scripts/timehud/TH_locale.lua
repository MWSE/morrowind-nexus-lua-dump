...
local translations = {
	German = {
		...
		["settings.border.desc"] = "Einen Rahmen an den Rändern des Hintergrunds zeichnen.",
		["settings.border.thickness"] = "Rahmendicke",
		["settings.border.size"] = "Rahmengröße",
		["settings.border.size.desc"] = "Rahmendicke in Pixeln.\nStandard: 2",
		["settings.border.color"] = "Rahmenfarbe",
		["settings.padding"] = "Innenabstand",
		["settings.padding.desc"] = "Innenabstand um den Text in Pixeln (X und Y).\nStandard: 4",
	...
	French = {
		...
		["settings.border.desc"] = "Dessiner une bordure sur les bords du fond.",
		["settings.border.thickness"] = "Épaisseur de bordure",
		["settings.border.size"] = "Taille de bordure",
		["settings.border.size.desc"] = "Épaisseur de la bordure en pixels.\nPar défaut : 2",
		["settings.border.color"] = "Couleur de bordure",
		["settings.padding"] = "Marge intérieure",
		["settings.padding.desc"] = "Espacement intérieur autour du texte en pixels (X et Y).\nPar défaut : 4",
	...
	Russian = {
		...
		["settings.border.desc"] = "Нарисовать рамку по краям фона.",
		["settings.border.thickness"] = "Толщина рамки",
		["settings.border.size"] = "Размер рамки",
		["settings.border.size.desc"] = "Толщина рамки в пикселях.\nПо умолчанию: 2",
		["settings.border.color"] = "Цвет рамки",
		["settings.padding"] = "Отступ",
		["settings.padding.desc"] = "Внутренний отступ вокруг текста в пикселях (X и Y).\nПо умолчанию: 4",
	...
	Polish = {
		...
		["settings.border.desc"] = "Narysuj ramkę wzdłuż krawędzi tła.",
		["settings.border.thickness"] = "Grubość ramki",
		["settings.border.size"] = "Rozmiar ramki",
		["settings.border.size.desc"] = "Grubość ramki w pikselach.\nDomyślnie: 2",
		["settings.border.color"] = "Kolor ramki",
		["settings.padding"] = "Wypełnienie",
		["settings.padding.desc"] = "Wewnętrzny odstęp wokół tekstu w pikselach (X i Y).\nDomyślnie: 4",
	...
	Hungarian = {
		...
		["settings.border.desc"] = "Keret rajzolása a háttér szélei mentén.",
		["settings.border.thickness"] = "Keretvastagság",
		["settings.border.size"] = "Keretméret",
		["settings.border.size.desc"] = "Keretvastagság pixelben.\nAlapértelmezett: 2",
		["settings.border.color"] = "Keretszín",
		["settings.padding"] = "Belső térköz",
		["settings.padding.desc"] = "Belső térköz a szöveg körül pixelben (X és Y).\nAlapértelmezett: 4",
	...
	Spanish = {
		...
		["settings.border.desc"] = "Dibujar un borde a lo largo de los bordes del fondo.",
		["settings.border.thickness"] = "Grosor del borde",
		["settings.border.size"] = "Tamaño del borde",
		["settings.border.size.desc"] = "Grosor del borde en píxeles.\nPor defecto: 2",
		["settings.border.color"] = "Color del borde",
		["settings.padding"] = "Relleno",
		["settings.padding.desc"] = "Espaciado interior alrededor del texto en píxeles (X e Y).\nPor defecto: 4",
	...
	Italian = {
		...
		["settings.border.desc"] = "Disegnare un bordo lungo i margini dello sfondo.",
		["settings.border.thickness"] = "Spessore del bordo",
		["settings.border.size"] = "Dimensione bordo",
		["settings.border.size.desc"] = "Spessore del bordo in pixel.\nPredefinito: 2",
		["settings.border.color"] = "Colore del bordo",
		["settings.padding"] = "Spaziatura",
		["settings.padding.desc"] = "Spaziatura interna attorno al testo in pixel (X e Y).\nPredefinito: 4",
	...
	Czech = {
		...
		["settings.border.thickness"] = "Tloušťka rámečku",
		["settings.border.size"] = "Velikost rámečku",
		["settings.border.size.desc"] = "Tloušťka rámečku v pixelech.\nVýchozí: 2",
		["settings.border.color"] = "Barva rámečku",
		["settings.padding"] = "Odsazení",
		["settings.padding.desc"] = "Vnitřní odsazení kolem textu v pixelech (X a Y).\nVýchozí: 4",
	...
	Portuguese = {
		...
		["settings.border.desc"] = "Desenhar uma borda ao longo das bordas do fundo.",
		["settings.border.thickness"] = "Espessura da borda",
		["settings.border.size"] = "Tamanho da borda",
		["settings.border.size.desc"] = "Espessura da borda em pixels.\nPadrão: 2",
		["settings.border.color"] = "Cor da borda",
		["settings.padding"] = "Preenchimento",
		["settings.padding.desc"] = "Espaçamento interno ao redor do texto em pixels (X e Y).\nPadrão: 4",
	...
	Romanian = {
		...
		["settings.border.desc"] = "Desenează o bordură de-a lungul marginilor fundalului.",
		["settings.border.thickness"] = "Grosime bordură",
		["settings.border.size"] = "Dimensiune bordură",
		["settings.border.size.desc"] = "Grosimea bordurii în pixeli.\nImplicit: 2",
		["settings.border.color"] = "Culoare bordură",
		["settings.padding"] = "Spațiere",
		["settings.padding.desc"] = "Spațiere interioară în jurul textului în pixeli (X și Y).\nImplicit: 4",
	...
	Japanese = {
		...
		-- Settings - Border
		["settings.border"] = "枠線",
		["settings.border.desc"] = "背景の縁に枠線を描画。",
		["settings.border.thickness"] = "枠線の太さ",
		["settings.border.size"] = "枠線のサイズ",
		["settings.border.size.desc"] = "枠線の太さをピクセル単位で指定。\nデフォルト：2",
		["settings.border.color"] = "枠線の色",
		["settings.padding"] = "余白",
		["settings.padding.desc"] = "テキスト周囲の内側余白（ピクセル、XとY共通）。\nデフォルト：4",
	...
	ChineseSimplified = {
		...
		-- Settings - Border
		["settings.border"] = "边框",
		["settings.border.desc"] = "沿背景边缘绘制边框。",
		["settings.border.thickness"] = "边框粗细",
		["settings.border.size"] = "边框大小",
		["settings.border.size.desc"] = "边框的像素厚度。\n默认：2",
		["settings.border.color"] = "边框颜色",
		["settings.padding"] = "内边距",
		["settings.padding.desc"] = "文字周围的内部间距（像素，X和Y均适用）。\n默认：4",
...
local settingsSection = storage.playerSection('Settings'.."TimeHUD".."General")

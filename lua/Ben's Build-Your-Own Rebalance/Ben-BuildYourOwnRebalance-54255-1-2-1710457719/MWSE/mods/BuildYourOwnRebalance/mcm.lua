...
local function createWeaponHomePage(template, defaultMcmConfig)
    ...
    page:createYesNoButton({
        ...
        description =
            "Yes = This mod will recalculate the value of pre-enchanted weapons from scratch using the \"Value Multiplier\" setting."..
    ...
    page:createSlider({
        ...
        description =
            "When \"Recalculate Value\" is \"Yes\": The new value of pre-enchanted weapons is equal to the item's UNENCHANTED value multiplied by this setting."..
...
local function createClothingHomePage(template, defaultMcmConfig)
    ...
    page:createYesNoButton({
        ...
        description =
            "Yes = This mod will recalculate the value of pre-enchanted clothing pieces from scratch using the \"Value Multiplier\" setting."..
    ...
    page:createSlider({
        ...
        description =
            "When \"Recalculate Value\" is \"Yes\": The new value of pre-enchanted clothing pieces is equal to the item's UNENCHANTED value multiplied by this setting."..
...
local function createArmorHomePage(template, defaultMcmConfig)
    ...
    page:createYesNoButton({
        ...
        description =
            "Yes = This mod will recalculate the value of pre-enchanted armor pieces from scratch using the \"Value Multiplier\" setting."..
    ...
    page:createSlider({
        ...
        description =
            "When \"Recalculate Value\" is \"Yes\": The new value of pre-enchanted armor pieces is equal to the item's UNENCHANTED value multiplied by this setting."..
...
local function getDefaultExclusionsCallback(filter, defaultItemIds)
    ...
    return function()
        ...
        for object in tes3.iterateObjects(filter) do
            if defaultItemIds[object.id] and common.shouldCacheObject(object) then
...
local function getExclusionsCallback(filter)
    ...
    return function()
        ...
        for object in tes3.iterateObjects(filter) do
            if common.shouldCacheObject(object) then
                table.insert(objectIds, object.id)
            end
        end
...
local function createMainHomePage(template, defaultMcmConfig)
    ...
    page:createYesNoButton({
        ...
        description =
            ...
            "\n\nDefault Value: " .. util.getYesNoString(defaultMcmConfig.condition.detectBoundItemsByName),
        variable = mwse.mcm.createTableVariable({
            table = mcmConfig.shared,
...
event.register(tes3.event.modConfigReady, onModConfigReady, { priority = config.eventPriority.modConfigReady.mcm })

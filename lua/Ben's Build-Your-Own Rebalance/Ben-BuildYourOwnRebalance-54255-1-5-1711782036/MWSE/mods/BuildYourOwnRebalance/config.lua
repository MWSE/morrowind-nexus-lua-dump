...
local defaultMcmConfig = {
    ...
    shared = {
        ...
        rebalanceCustomEnchantedItems = false,
        excludedItemIds = {
            -- ARMOR: Vanilla
    ...
    armor = {
        ...
        enchantedItem = {
            ...
            valueBase = 0, -- 0 to 1000
            valueMult = 1, -- 1.00 to 2.00
            valuePerMaxCharge = 10, -- 0 to 100
            valuePerEffectCost = 10, -- 0 to 100
...
local function upgradeConfig(mcmConfig, version)
    ...
    -- overwrite new defaults that mess with existing users
    -- items should not be rebalanced differently after upgrading
    
    if version < 1.5 then
        
        mcmConfig.armor.enchantedItem.valuePerMaxCharge = 0
        mcmConfig.armor.enchantedItem.valuePerEffectCost = 0
        
        mcmConfig.clothing.enchantedItem.valuePerMaxCharge = 0
        mcmConfig.clothing.enchantedItem.valuePerEffectCost = 0
        
        mcmConfig.weapon.enchantedItem.valuePerMaxCharge = 0
        mcmConfig.weapon.enchantedItem.valuePerEffectCost = 0
...
local function getVersion(mcmConfig)
    ...
    -- if version is invalid, assume <= 1.4 config
    return util.getNumber(mcmConfig.version, 1.4)

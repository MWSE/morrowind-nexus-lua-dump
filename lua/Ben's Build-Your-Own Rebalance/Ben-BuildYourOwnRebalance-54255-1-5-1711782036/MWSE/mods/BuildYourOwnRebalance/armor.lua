...
local function getSlot(armor)
    ...
    common.log("  Slot: %s | Not Supported", armor.slotName)
    return nil
...
local function rebalanceArmor(armor)
    ...
    local value = common.getItemValue(
        armor, gameConfig.armor.enchantedItem,
        unenchantedValue, unmodifiedArmor.value)
...
local function cacheArmor(armor)
    ...
    if not common.shouldCacheItem(armor) then return end

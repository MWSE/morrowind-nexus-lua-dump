...
I.Settings.registerGroup {
    ...
    settings = {
        ...
        {
            key = 'iDailyPerformanceLimit',
            renderer = 'number',
            name = 'ConfigDailyPerformanceLimit',
            description = 'ConfigDailyPerformanceLimitDesc',
            argument = {
                integer = true,
                min = 0,
            },
        ...
        {
            key = 'bRequireBlankSheetMusic',
            renderer = 'checkbox',
            name = 'ConfigRequireBlankSheetMusic',
            description = 'ConfigRequireBlankSheetMusicDesc',
            default = true,
        },
		{

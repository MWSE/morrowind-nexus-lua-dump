    ...
    engineHandlers = {
        ...
        onFrame = function(dt)
            ...
            if performOverlay and practiceSong then
                ...
                local wrapperOpacity = opacity / performOverlayTargetOpacity
                performOverlay.layout.props.alpha = wrapperOpacity
                performOverlayNotesWrapper.layout.props.alpha = opacity
                performOverlay.layout.content['background'].props.alpha = opacity
                performOverlay.layout.content['centerline'].props.alpha = opacity

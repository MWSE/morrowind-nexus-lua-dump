...
if (ssqn) and (ssqn.registerQBlock) then
	...
	ssqn.registerQBlock("DAT_CE_Umbermoth03_Callas")
	ssqn.registerQBlock("DAT_CE_Umbermoth03_AudMeni")
	ssqn.registerQBlock("DAT_CE_Caldera02_A")
	ssqn.registerQBlock("DAT_CE_Caldera02_B")
	ssqn.registerQBlock("DAT_VAR_gainotice")

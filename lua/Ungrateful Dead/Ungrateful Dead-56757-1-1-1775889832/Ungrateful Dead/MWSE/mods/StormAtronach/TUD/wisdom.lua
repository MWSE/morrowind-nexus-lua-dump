...
---@class WisdomEffect
---@field id integer Magic effect ID (tes3.effect.*)
---@field skill integer|nil Skill affected (tes3.skill.*)
---@field attribute integer|nil Attribute affected (tes3.attribute.*)
---@field min integer Minimum magnitude
---@field max integer Maximum magnitude
---@field duration integer Duration in seconds

---@class Wisdom
---@field saying string The wisdom phrase
---@field effects WisdomEffect[] List of effects
...
local wisdoms = {
    ...
    {   saying = "Never accept a bargain until you've bartered them down",
        effects = {

...
local function registerModConfig()
    ...
    page:createOnOffButton{
        label = "Powers Only",
        description = "When enabled, ancestral wisdom only triggers from powers. Disable to also trigger from regular spells with the Summon Ancestral Ghost effect.",
        configKey = "powersOnly",
    }

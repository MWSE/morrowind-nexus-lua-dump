return {
    ...
    MESSAGES_FOLLOW = {
        "The %s senses your mastery and bows its head in temporary service.",
        "Your will dominates the %s. It shall walk behind you... for now.",
        "A %s emerges, but your prowess in the magic arts binds it to your side.",
    },
    MESSAGES_REMOVE = {
        "The shattered artifact crumbles to ash, devoured by the rift it tore open.",
        "Your broken charge is consumed by Oblivion. Naught remains but bitter air.",
        "The broken thing dissolves in your hands, claimed as tithe by the realm beyond.",
        "The veil takes its due. The broken trinket is no more.",
    },
}
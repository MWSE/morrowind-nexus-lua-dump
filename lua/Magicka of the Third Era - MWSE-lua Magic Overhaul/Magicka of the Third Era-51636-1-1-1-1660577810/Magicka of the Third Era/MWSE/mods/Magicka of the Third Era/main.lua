...
local premade_spells = {
  ...
  a_ve_uniqsp_34_hardenbone = {fixed_cost = 18, skill_table = {[0] = 0, [1] = 0.25, [2] = 0.25, [3] = 0, [4] = 0, [5] = 0.5}}, -- designed to buff undead summons, but can be used as bad damage spell, hence the split
  a_ve_uniqsp_35_livingbomb = {fixed_cost = 16, skill_table = {[0] = 0.5, [1] = 0.25, [2] = 0.25, [3] = 0, [4] = 0, [5] = 0}}, -- alteration buff / bad damage spell
...
-- Custom price for spells, most useful for spells that have low/nonexistent magicka cost but should cost something.
local custom_price_spells = {
  a_ve_uniqsp_01_lifetap = {cost = 250},
  a_ve_uniqsp_15_lifetapgr = {cost = 350}
}
...
-- Shield
spell_table[3] = {coef = 0.14, mag_pow = 0.74, dur_pow = -0.25, range1_coef_mod = 0.35, range2_coef_mod = 0.4}
-- Elemental Shields
...
-- 20, 30s = 15
-- 44, 30s = 27
spell_table[48] = {coef = 0.32, mag_pow = 0.7, dur_pow = -0.3, range2_coef_mod = 1.3}
-- Calm Humanoid
...
-- 50, 60s = 26
-- 75, 60s = 34
spell_table[90] = {coef = 0.23, mag_pow = 0.85, dur_pow = -0.7, dur_min = 20, range1_coef_mod = 0.55, range2_coef_mod = 0.6, ignore_magmin = true}
-- Resist Frost
...
spell_table[93] = {coef = 0.27, mag_pow = 0.85, dur_pow = -0.7, dur_min = 20, range1_coef_mod = 0.55, range2_coef_mod = 0.6, ignore_magmin = true}
...
-- Does not work with this part of UI Expansion, unfortunately (UI Expansion uses different elements and bugs out sometimes), maybe I'll recreate some of the stuff

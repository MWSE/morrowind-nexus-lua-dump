...
-- Modifier effects
local modifier_effect_ids = {3400}
-- Modifier logic:
...
spell_table[15] = {coef = 0.66, mag_pow = 0.72, dur_pow = -0.13, area_pow = 0.115, range2_coef_mod = 1.4}
-- Frost Damage --
...
-- Drain Attribute
spell_table[17] = {coef = 0.135, mag_pow = 0.9, dur_pow = -0.75, dur_offset = 10, area_pow = 0.17, range0_const_cost = 100, range1_coef_mod = 0.7}
-- Drain Health
-- 100, 1s = 23
-- 200, 1s = 38
-- 100, 30s = 26
-- 200, 30s = 43
spell_table[18] = {coef = 0.5, mag_pow = 0.725, dur_pow = -0.69, area_pow = 0.1, range0_const_cost = 100, range2_coef_mod = 1.35}
-- Drain Magicka
...
-- 30s = 29
spell_table[7702] = {coef = 3.8, mag_pow = 0.7, dur_pow = -0.3, dur_offset = 20}
-- Summon Flesh Atronach
-- 30s = 26
spell_table[7703] = {coef = 3.4, mag_pow = 0.7, dur_pow = -0.3, dur_offset = 20}
-- Summon Iron Golem
-- 30s = 19
...
-- 30s = 31
spell_table[7706] = {coef = 4.15, mag_pow = 0.7, dur_pow = -0.3, dur_offset = 20}
-----------------
-- OAAB Grazelands
-----------------

...
local function registerMCM()
    local  sideBarDefault = (
        "When crouching with a shield equipped, your Block increases while your Speed is reduced. "
    )
    ...
    local template = mwse.mcm.createTemplate("Defensive Stance")
    template:saveOnClose(configPath, config)
    local page = template:createSideBarPage{}
    addSideBar(page)

    page:createOnOffButton{
        label = "Enable Defensive Stance",
    ...
    page:createTextField{
        ...
        description = "Determines how much your speed is reduced while in a defensive stance. ",
        variable = mwse.mcm.createTableVariable{
            id = "speedMultiplier",
            numbersOnly = true,
            table = config
    ...
    page:createTextField{
        ...
        description = "Determines how much your block is increased while in a defensive stance. ",
        variable = mwse.mcm.createTableVariable{
            id = "blockMultiplier",
            numbersOnly = true,
            table = config

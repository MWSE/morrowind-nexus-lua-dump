...
function projectile_speed_policy.applyBaselineLaunchSpeed(launch_data, context)
    ...
    if speed_plus then
        ...
        local final_speed, capped = projectile_speed_policy.applySpeedPlusMultiplier(baseline, launch.speed_plus_multiplier)
        ...
        details.speed_plus_multiplier = launch.speed_plus_multiplier
        details.speed_plus_capped = capped or launch.speed_plus_capped == true

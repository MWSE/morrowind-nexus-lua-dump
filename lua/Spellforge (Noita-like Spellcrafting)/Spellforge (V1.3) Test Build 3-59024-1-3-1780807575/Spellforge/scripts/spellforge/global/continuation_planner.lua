...
local function planBounceEvent(plan, ir, event, opts)
    ...
    if not source_entry then
        return reject(plan, ir, event, source_entry, bounce_continuation, "bounce_source_missing")
    end
...
local function planPierceEvent(plan, ir, event, opts)
    ...
    if not source_entry then
        return reject(plan, ir, event, source_entry, pierce_continuation, "pierce_source_missing")
    end

...
local function createPage(label)
	...
	page.sidebar:createHyperlink {
		...
		url = "https://www.nexusmods.com/morrowind/users/60236996?tab=user+files",
		postCreate = function(self)
			local outerContainer = self.elements.outerContainer
			if outerContainer then
				outerContainer.borderAllSides = self.indent
				---@diagnostic disable-next-line: inject-field
				outerContainer.alignY = 1.0
			end
			---@diagnostic disable-next-line: inject-field
...
categoryMisc:createLogLevelOptions{
	label = "Log Level",
	description = "Sets the verbosity of this mod's logging.",
	logger = "Character Sound Overhaul",

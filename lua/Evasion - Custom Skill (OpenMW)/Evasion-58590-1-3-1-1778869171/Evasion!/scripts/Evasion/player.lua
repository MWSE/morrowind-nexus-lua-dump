...
local function registerClassBonusModifier()
    ...
    I.SkillFramework.registerDynamicModifier(SKILL_ID, "Evasion_ClassSpecializationBonus", getClassSpecializationBonus)
...
local function migrateLegacyClassBonus()
    ...
    -- Older versions directly edited stat.base for the specialization bonus.
    -- Convert that saved state back out of base so Skill Framework can manage
    -- the bonus as a dynamic modifier instead.

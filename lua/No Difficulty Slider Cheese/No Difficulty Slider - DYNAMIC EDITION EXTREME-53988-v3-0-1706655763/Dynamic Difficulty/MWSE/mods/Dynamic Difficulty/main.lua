...
local function recalculateDifficulty()
	...
	tes3.getWorldController().difficulty = 0.74 + (tes3.player.object.level * 0.01)  -- difficulty / 100 TT: hack it. Starts on hard difficulty and increments by 2 each level, even bypassing the vanilla cap. 
end

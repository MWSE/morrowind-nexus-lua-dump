...
local uiUtil = require("scripts.AetheriusOutpost.util.ui")
...
local function compassActivate(recordId)
    ...
    elseif recordId == "zhac_ae_compass_silver" and not ownedShips[recordId] and types.Actor.inventory(self):countOf("zhac_shipkey_1") == 0 then
    ...
    elseif recordId == "zhac_ae_compass_silver" and not ownedShips[recordId] and types.Actor.inventory(self):countOf("zhac_shipkey_1") > 0 then
        ...
        drawUI()
        core.sendGlobalEvent("lockShipObject", true)
    elseif recordId == "zhac_ae_compass_steam" and not ownedShips[recordId] and types.Actor.inventory(self):countOf("zhac_shipkey_2") == 0 then
        ui.showMessage("You don't have control of this ship.")
    elseif recordId == "zhac_ae_compass_steam" and not ownedShips[recordId] and types.Actor.inventory(self):countOf("zhac_shipkey_2") > 0 then
        ownedShips[recordId] = true
        ownedShips[airshipOb.id] = true

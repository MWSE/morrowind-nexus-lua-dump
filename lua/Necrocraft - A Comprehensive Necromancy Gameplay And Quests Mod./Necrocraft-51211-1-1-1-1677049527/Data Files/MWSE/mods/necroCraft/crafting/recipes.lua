...
recipes.bonepiles = {
	{
		...
		previewScale = 1.3,
		previewHeight = -20,
		previewMesh = "NecroCraft\\skel.nif",
		materials = {
	...
	},
	{
		...
		previewMesh = "NecroCraft\\skel_weak.nif",
	...
	},
{
		...
		previewMesh = "NecroCraft\\bonelord_2n.nif",
	...
	{
		id = "NC_bonelord_misc",
		previewMesh = "NecroCraft\\bonelord_n.nif",
	...
	},
	{
		...
		previewScale = 1.2,
		previewHeight = 50,
		previewMesh = "NecroCraft\\bone_spider.nif",
...
recipes.corpses = {
	...
	-- {
	-- 	id = "AB_Furn_CorpseWrapped01",
	-- 	name = "Restore Body",
	-- 	description = "Restores the body and prepares it for resurrection",
	-- 	materials = {
	-- 		-- { material = "nc_soulgem2", count = 1 }
	-- 	},
	-- 	knownByDefault = false, --if false, checks `tes3.player.data.craftingFramework.recipes["alchemyTable_misc"].known`
	-- 	previewScale = 2,
	-- 	previewHeight = 90,
	-- 	category = strings.humanoids,
	-- 	customRequirements = {
	...
	-- 	},
	-- 	skillRequirements = {
	-- 		{ skill = "NC:CorpsePreparation", requirement = 100 }
	-- 	},
	-- 	craftCallback = function() event.trigger("Necrocraft:BodyCrafted") end,
	-- 	positionCallBack = function() event.trigger("Necrocraft:BodyPositioned") end
	-- },

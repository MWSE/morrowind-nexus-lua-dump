...
local function onCellChanged(e)
	...
	for ref in e.cell:iterateReferences(tes3.objectType.book) do
		if ref.id == "sc_summonskeletalservant" then 
			...
			book = tes3.createReference{object = book, position = {ref.position.x, ref.position.y, ref.position.z+4}, orientation=ref.orientation, cell=e.cell}

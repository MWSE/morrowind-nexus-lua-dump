...
-- player strayed, trespassing crime, escort continues
...
return {
    ...
    eventHandlers = {
        ...
        NightPatrol_EscortConfirmed = function(data)
            if escortGuard and data.guard == escortGuard then
        ...
        NightPatrol_NoShelter = function(data)
            if escortGuard and data.guard == escortGuard then
        ...
        NightPatrol_GuardAtDoor = function(data)
            if escortGuard and data.guard == escortGuard then
                escortPhase = 'waiting'
        ...
        NightPatrol_EscortEnded = function(data)
            if escortGuard and data.guard == escortGuard then
                endCombat()
            end
        end,

...
local function dispUpdate(e)
    ...
    if (tes3.getPlayerCell().id == 'Balmora, Caius Cosades\' House' and tes3.getJournalIndex {id = 'A2_6_Incarnate'} < 50) then
        hideAgent()
    elseif (tes3.getPlayerCell().id == 'Balmora, Caius Cosades\' House' and tes3.getJournalIndex {id = 'A2_6_Incarnate'} >= 50 and tes3.getJournalIndex {id = 'AA_Stormwatch'} < 10) then
        showAgent()

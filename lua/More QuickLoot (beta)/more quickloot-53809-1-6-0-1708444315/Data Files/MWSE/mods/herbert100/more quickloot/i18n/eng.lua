    ...
    mcm = {
        ...
        UI = {
            ...
            misc = {
                ...
                show_tooltips = {
                    label = "Should tooltips be shown?",
                    description = 'This settings affect the behavior of tooltips when a QuickLoot menu is active.\n\n\z
                        \z
                        The options are:\n\z
                        \t"Don\'t show tooltips": Tooltips will not be shown (when QuickLoot menus are active).\n\z\z
                        \z
                        \t"Show item tooltips": Tooltips for the currently selected item will be shown.\n\z\z
                        \z
                        \t"Show container tooltips": Tooltips for the container will be shown.\n\n\z
                        \z
                        More specifically, the "Show item tooltips" setting will display additional information about the highlighted item in whichever QuickLoot menu is open. \z
                        This can show you information about ingredients (when looking at plants), information about skills (when looking at trainers), and durability information (when looking at items). \n\n\z
                        \z
                    ...
                    options = {
                        dont = "Don't show tooltips",
                        item = "Show item tooltips",
                        container = "Show container tooltips",
                    },
                },

                play_switch_sounds = {
                    label = "Sound to play when switching menu modes:",
        ...
        organic = {
            ...
            mi = {
                ...
                min_chance = {
                    label="Item stack: Minimum total chance",
            ...
            misc = {
                ...
                sn_dist = {
                    label="Group nearby plants: distance", 
                ...
                take_all_min_chance = {
                    label="Harvest All: Skip items with chance less than", id="take_all_min_chance",
        ...
        pickpocket = {
            ...
            misc = {
                ...
                determinism_cutoff = {label = "Determinism cuttoff percentage",
                ...
                take_all_min_chance = {
                    label="Take All: Skip items with chance less than",
                ...
                min_chance = { label = "Minimum take chance",
                ...
                max_chance = { label = "Maximum take chance",
        ...
        advanced = {
            ...
            compat = {
                ...
                mousedown_priority = {
                    label="mouseButtonDown event priority: event priority",

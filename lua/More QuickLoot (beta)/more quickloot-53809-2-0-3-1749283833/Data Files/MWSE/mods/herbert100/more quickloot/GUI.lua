...
function GUI.new()
	...
	do -- make columns 
		...
		self.weights_col = make_column(self, columns_blk, "icons/weight.tga", false, uids.weights_col, uids.weights_col_outer)
...
function GUI:set_index(item_index)
	...
	event.trigger(defns.EVENT_IDS.item_selected, {container=container, gui=self, item=item}, {filter=container.cls_name})

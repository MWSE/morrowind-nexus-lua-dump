...
local gh_status = tes3.isLuaModActive("graphicHerbalism") and defns.misc.gh.installed
...
do
    ...
    ---@param path string
    local function is_mod_installed(path)
        return lfs.attributes(string.format("Data Files/MWSE/mods/%s/main.lua", path:gsub("%.","/"))) ~= nil
    end

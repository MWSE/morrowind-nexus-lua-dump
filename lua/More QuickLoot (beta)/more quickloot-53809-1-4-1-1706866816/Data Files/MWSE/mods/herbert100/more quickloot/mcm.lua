...
local layout = {
    ...
    {id="main", type=mt.page, add_log = true,
        ...
        { id = "take_nearby", type=mt.category,
            { id = "take_nearby_dist",          type=mt.slider,  min=0, max = 2000, step = 50, jump = 100,},
    ...
    {id = "organic", type=mt.page, config=config.organic,
        ...
        {id = "misc", type=mt.category,
            ...
            {id="show_chances", type=mt.dropdown, {"Never show chances", defns.ui_show_chances.never}, {"Decide based on Alchemy level", defns.ui_show_chances.lvl}, {"Always show chances", defns.ui_show_chances.always}},
    ...
    {id="pickpocket", type=mt.page, config=config.pickpocket,
        ...
        {id = "misc",                   type=mt.category,
            ...
            {id="show_chances", type=mt.dropdown, {"Never show chances", defns.ui_show_chances.never}, {"Decide based on Security level", defns.ui_show_chances.lvl}, {"Always show chances", defns.ui_show_chances.always}},
            {id="show_chances_lvl", type=mt.slider, },
            {id="show_chances_100", type=mt.btn, },
            {id="determinism", type=mt.btn, },
            {id="determinism_cutoff", type=mt.slider,min=50, },
    ...
    {id="advanced", type=mt.page, config=config.advanced,
        ...
        {id="compat", type=mt.category,
            ...
            {id="activate_key_priority",            type=mt.textfield, numbersOnly=true,},

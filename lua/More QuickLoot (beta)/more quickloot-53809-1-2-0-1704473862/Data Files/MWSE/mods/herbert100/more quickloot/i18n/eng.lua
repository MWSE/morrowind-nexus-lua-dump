    ...
    mcm = {
        ...
        main = {
            ...
            take_all_distance = {
                ...
                Setting it to 0 will disable this feature.\z
                ",
            },
        ...
        reg = {
            ...
            sn_dist = {
                label="How close should nearby containers be?",
            ...
            mi = {
                ...
                mode_m = {
                    label="How to decide (when modifier key is held)",
        ...
        organic = {
            ...
            mi = {
                ...
                mode_m = {
                    label="How to decide (modifier key)?",

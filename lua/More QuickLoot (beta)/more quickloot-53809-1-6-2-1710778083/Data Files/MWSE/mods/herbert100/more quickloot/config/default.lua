...
local default = {
    ...
    keys = {
        ...
        custom = { keyCode=tes3.scanCode.f, }, ---@type mwseKeyMouseCombo
        take_all = { keyCode=tes3.scanCode.r, }, ---@type mwseKeyMouseCombo
...
---@diagnostic disable-next-line: assign-type-mismatch
    ...
    UI = {
        ...
        play_switch_sounds2 = 2, ---@type false|2

        show_msgbox = true,
        show_lucky_msg = true,
        show_tooltips = defns.show_tooltips.item, ---@type MQL.defns.show_tooltips
        show_name = true,
        show_controls = true,
        show_weight = true,
        show_gold = true,

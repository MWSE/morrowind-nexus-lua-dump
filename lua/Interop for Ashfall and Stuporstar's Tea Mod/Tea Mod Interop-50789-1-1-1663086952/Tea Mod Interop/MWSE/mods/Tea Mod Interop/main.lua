...
if ashfall then
	...
	ashfall.registerWaterContainers{
		teamod_teacup_ST10 = "cup",
		teamod_teacup_ST11 = "cup",
		teamod_teacup_ST12 = "cup",
		teamod_teacup_ST05 = "cup",
		teamod_teacup_ST06 = "cup",
		teamod_teacup_Q2 = "cup",
		teamod_teacup_ST07 = "cup",
		teamod_teacup_ST08 = "cup",
		teamod_teacup_ST09 = "cup",
		teamod_teacup_QG = "cup",
		teamod_teacup_ST01 = "cup",
		teamod_teacup_ST02 = "cup",
		teamod_teacup_ST03 = "cup",
		teamod_teacup_cali_red = "cup",
		teamod_mug_kb = "tankard",
		teamod_teacup_cali_silv = "cup",
		teamod_teacup_ST04 = "cup",
		teamod_teacup_Q6 = "cup",
		teamod_teacup_Q7 = "cup",
		st_bugjug = "pitcher",
		st_bugmug = "tankard",
		
	}
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_kb02",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_q2",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_q6",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_q7",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_qg",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_qgl",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st01",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st02",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st03",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st04",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st05",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st06",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st07",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st08",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st09",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st10",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st11",
	data = {type = "kettle",
	capacity = 130}
	})
	
	ashfall.registerUtensil({
	id = "teamod_coffeepot_st12",
	data = {type = "kettle",
	capacity = 130}
	})

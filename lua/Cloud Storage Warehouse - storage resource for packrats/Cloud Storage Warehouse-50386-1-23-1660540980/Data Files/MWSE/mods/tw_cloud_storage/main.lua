...
local storeForType = {
    ...
    [tes3.objectType.ammunition] = "tw_weapons_store",
...
local enabledStores = {
    ...
    tw_tools_store     = true,  
    tw_safe_store      = false    -- manual only do not auto store in here - but recover on panic.
}
...
----------------------------------------------------------------------------------------------------
--[[
local function getSlots(item, itemData)
...
--local function isItemQuickKeyed(item, itemData)
    for i = 1, 9 do
        local slot = tes3.getQuickKey({ slot = i })
        if (slot) then
            if (slot.item == item and slot.itemData == itemData) then
                return true
            end
        end
    end
...
if ( lSafestore ) then
  tes3.messageBox("This is a manual store only, nothing has been stored.")
  return
end
...
-- Gather up equipped items and blacklisted
...
for _, stack in pairs(tes3.player.object.inventory) do
  ...
  if blacklist[ stack.object.id ] then
    -- don't touch anything in the blacklist.     
  else
    ...
    if (blocklist[stack.object]) then
      ...
      --  mwse.log("1*****  item = %s", stack.object.id)
      ...
      for _, stackData in ipairs(stack.variables or {}) do
        ...
        --mwse.log("2*****  item = %s", stack.object.id)
        end
      end
    else
      table.insert(transferOrders, { item = stack.object, count = stack.count })
      --mwse.log("3*****  item = %s", stack.object.id)
    end
  end
end
...
for _, order in ipairs(transferOrders) do
  store = getStoreForItem(order.item)
	...
	if ( store ~= nil )  then
    if (  isItemStoreEnabled(order.item) ) then
    ...
    if lStore == 1 then 
        messageBox{
            ...
            buttons = { {text = "Weapons",     callback = function() timer.delayOneFrame(function() AllowActivate = true; tes3.player:activate(tes3.getReference("tw_weapons_store")) end) end },
                        ...
                        {text = "Safe",        callback = function() timer.delayOneFrame(function() AllowActivate = true; tes3.player:activate(tes3.getReference("tw_safe_store")) end) end },
        ...
        elseif lSafestore == 1 then
            timer.delayOneFrame(function() AllowActivate = true; tes3.player:activate(tes3.getReference("tw_safe_store")) end)
        end
    end
end
...
--[[      
      {
    [  "tw_store01_"         ] = true, -- {  act = "tw_store01_act"        , misc = "tw_store01_misc"           },
    [  "tw_store02_"         ] = true, -- {  act = "tw_store02_act"        , misc = "tw_store02_misc"           },
    [  "tw_store03_"         ] = true, -- {  act = "tw_store03_act"        , misc = "tw_store03_misc"           },
    [  "tw_store04_"         ] = true, -- {  act = "tw_store04_act"        , misc = "tw_store04_misc"           },
    [  "tw_store05_"         ] = true, -- {  act = "tw_store05_act"        , misc = "tw_store05_misc"           },
    [  "tw_store06_"         ] = true, -- {  act = "tw_store06_act"        , misc = "tw_store06_misc"           },
    [  "tw_weapons_01_"      ] = true, -- {  act = "tw_weapons_01_act"     , misc = "tw_weapons_01_misc"        },
    [  "tw_weapons_02_"      ] = true, -- {  act = "tw_weapons_02_act"     , misc = "tw_weapons_02_misc"        },
    [  "tw_weapons_03_"      ] = true, -- {  act = "tw_weapons_03_act"     , misc = "tw_weapons_03_misc"        },
    [  "tw_weapons_04_"      ] = true, -- {  act = "tw_weapons_04_act"     , misc = "tw_weapons_04_misc"        },
    [  "tw_weapons_05_"      ] = true, -- {  act = "tw_weapons_05_act"     , misc = "tw_weapons_05_misc"        },
    [  "tw_weapons_06_"      ] = true, -- {  act = "tw_weapons_06_act"     , misc = "tw_weapons_06_misc"        },
    [  "tw_cloths_01_"       ] = true, -- {  act = "tw_cloths_01_act"      , misc = "tw_cloths_01_misc"         },
    [  "tw_cloths_02_"       ] = true, -- {  act = "tw_cloths_02_act"      , misc = "tw_cloths_02_misc"         },
    [  "tw_cloths_03_"       ] = true, -- {  act = "tw_cloths_03_act"      , misc = "tw_cloths_03_misc"         },
    [  "tw_cloths_04_"       ] = true, -- {  act = "tw_cloths_04_act"      , misc = "tw_cloths_04_misc"         },
    [  "tw_cloths_05_"       ] = true, -- {  act = "tw_cloths_05_act"      , misc = "tw_cloths_05_misc"         },
    [  "tw_cloths_06_"       ] = true, -- {  act = "tw_cloths_06_act"      , misc = "tw_cloths_06_misc"         },
    [  "tw_armour_01_"       ] = true, -- {  act = "tw_armour_01_act"      , misc = "tw_armour_01_misc"         },
    [  "tw_armour_02_"       ] = true, -- {  act = "tw_armour_02_act"      , misc = "tw_armour_02_misc"         },
    [  "tw_armour_03_"       ] = true, -- {  act = "tw_armour_03_act"      , misc = "tw_armour_03_misc"         },
    [  "tw_armour_04_"       ] = true, -- {  act = "tw_armour_04_act"      , misc = "tw_armour_04_misc"         },
    [  "tw_armour_05_"       ] = true, -- {  act = "tw_armour_05_act"      , misc = "tw_armour_05_misc"         },
    [  "tw_armour_06_"       ] = true, -- {  act = "tw_armour_06_act"      , misc = "tw_armour_06_misc"         },
    [  "tw_armour_07_"       ] = true, -- {  act = "tw_armour_07_act"      , misc = "tw_armour_07_misc"         },
    [  "tw_armour_08_"       ] = true, -- {  act = "tw_armour_08_act"      , misc = "tw_armour_08_misc"         },
    [  "tw_armour_09_"       ] = true, -- {  act = "tw_armour_09_act"      , misc = "tw_armour_09_misc"         },
    [  "tw_tools_01_"        ] = true, -- {  act = "tw_tools_01_act"       , misc = "tw_tools_01_misc"          },
    [  "tw_tools_02_"        ] = true, -- {  act = "tw_tools_02_act"       , misc = "tw_tools_02_misc"          },
    [  "tw_tools_03_"        ] = true, -- {  act = "tw_tools_03_act"       , misc = "tw_tools_03_misc"          },
    [  "tw_tools_04_"        ] = true, -- {  act = "tw_tools_04_act"       , misc = "tw_tools_04_misc"          },
    [  "tw_tools_05_"        ] = true, -- {  act = "tw_tools_05_act"       , misc = "tw_tools_05_misc"          },
    [  "tw_tools_06_"        ] = true, -- {  act = "tw_tools_06_act"       , misc = "tw_tools_06_misc"          },
    [  "tw_books_01_"        ] = true, -- {  act = "tw_books_01_act"       , misc = "tw_books_01_misc"          },
    [  "tw_books_02_"        ] = true, -- {  act = "tw_books_02_act"       , misc = "tw_books_02_misc"          },
    [  "tw_books_03_"        ] = true, -- {  act = "tw_books_03_act"       , misc = "tw_books_03_misc"          },
    [  "tw_books_04_"        ] = true, -- {  act = "tw_books_04_act"       , misc = "tw_books_04_misc"          },
    [  "tw_books_05_"        ] = true, -- {  act = "tw_books_05_act"       , misc = "tw_books_05_misc"          },
    [  "tw_books_06_"        ] = true, -- {  act = "tw_books_06_act"       , misc = "tw_books_06_misc"          },
    [  "tw_misc01_"          ] = true, -- {  act = "tw_misc01_act"         , misc = "tw_misc01_misc"            },
    [  "tw_misc02_"          ] = true, -- {  act = "tw_misc02_act"         , misc = "tw_misc02_misc"            },
    [  "tw_misc03_"          ] = true, -- {  act = "tw_misc03_act"         , misc = "tw_misc03_misc"            },
    [  "tw_misc04_"          ] = true, -- {  act = "tw_misc04_act"         , misc = "tw_misc04_misc"            },
    [  "tw_misc05_"          ] = true, -- {  act = "tw_misc05_act"         , misc = "tw_misc05_misc"            },
    [  "tw_misc06_"          ] = true, -- {  act = "tw_misc06_act"         , misc = "tw_misc06_misc"            },
    [  "tw_ingred_01_"       ] = true, -- {  act = "tw_ingred_01_act"      , misc = "tw_ingred_01_misc"         },
    [  "tw_ingred_02_"       ] = true, -- {  act = "tw_ingred_02_act"      , misc = "tw_ingred_02_misc"         },
    [  "tw_ingred_03_"       ] = true, -- {  act = "tw_ingred_03_act"      , misc = "tw_ingred_03_misc"         },
    [  "tw_ingred_04_"       ] = true, -- {  act = "tw_ingred_04_act"      , misc = "tw_ingred_04_misc"         },
    [  "tw_ingred_05_"       ] = true, -- {  act = "tw_ingred_05_act"      , misc = "tw_ingred_05_misc"         },
    [  "tw_ingred_06_"       ] = true, -- {  act = "tw_ingred_06_act"      , misc = "tw_ingred_06_misc"         },
    [  "tw_potions_01_"      ] = true, -- {  act = "tw_potions_01_act"     , misc = "tw_potions_01_misc"        },
    [  "tw_potions_02_"      ] = true, -- {  act = "tw_potions_02_act"     , misc = "tw_potions_02_misc"        },
    [  "tw_potions_03_"      ] = true, -- {  act = "tw_potions_03_act"     , misc = "tw_potions_03_misc"        },
    [  "tw_potions_04_"      ] = true, -- {  act = "tw_potions_04_act"     , misc = "tw_potions_04_misc"        },
    [  "tw_potions_05_"      ] = true, -- {  act = "tw_potions_05_act"     , misc = "tw_potions_05_misc"        },
    [  "tw_potions_06_"      ] = true, -- {  act = "tw_potions_06_act"     , misc = "tw_potions_06_misc"        },
    [  "tw_scroll_01_"       ] = true, -- {  act = "tw_scroll_01_act"      , misc = "tw_scroll_01_misc"         },
    [  "tw_scroll_02_"       ] = true, -- {  act = "tw_scroll_02_act"      , misc = "tw_scroll_02_misc"         },
    [  "tw_scroll_03_"       ] = true, -- {  act = "tw_scroll_03_act"      , misc = "tw_scroll_03_misc"         },
    [  "tw_scroll_04_"       ] = true, -- {  act = "tw_scroll_04_act"      , misc = "tw_scroll_04_misc"         },
    [  "tw_scroll_05_"       ] = true, -- {  act = "tw_scroll_05_act"      , misc = "tw_scroll_05_misc"         },
    [  "tw_scroll_06_"       ] = true, -- {  act = "tw_scroll_06_act"      , misc = "tw_scroll_06_misc"         },
    [  "tw_soulgems_01_"     ] = true, -- {  act = "tw_soulgems_01_act"    , misc = "tw_soulgems_01_misc"       },
    [  "tw_soulgems_02_"     ] = true, -- {  act = "tw_soulgems_02_act"    , misc = "tw_soulgems_02_misc"       },
    [  "tw_soulgems_03_"     ] = true, -- {  act = "tw_soulgems_03_act"    , misc = "tw_soulgems_03_misc"       },
    [  "tw_soulgems_04_"     ] = true, -- {  act = "tw_soulgems_04_act"    , misc = "tw_soulgems_04_misc"       },
    [  "tw_soulgems_05_"     ] = true, -- {  act = "tw_soulgems_05_act"    , misc = "tw_soulgems_05_misc"       },
    [  "tw_soulgems_06_"     ] = true, -- {  act = "tw_soulgems_06_act"    , misc = "tw_soulgems_06_misc"       },
    [  "tw_keys_01_"         ] = true, -- {  act = "tw_keys_01_act"        , misc = "tw_keys_01_misc"           },
    [  "tw_keys_02_"         ] = true, -- {  act = "tw_keys_02_act"        , misc = "tw_keys_02_misc"           },
    [  "tw_keys_03_"         ] = true, -- {  act = "tw_keys_03_act"        , misc = "tw_keys_03_misc"           },
    [  "tw_keys_04_"         ] = true, -- {  act = "tw_keys_04_act"        , misc = "tw_keys_04_misc"           },
    [  "tw_keys_05_"         ] = true, -- {  act = "tw_keys_05_act"        , misc = "tw_keys_05_misc"           },
    [  "tw_keys_06_"         ] = true, -- {  act = "tw_keys_06_act"        , misc = "tw_keys_06_misc"           },
    [  "tw_apparatus_01_"    ] = true, -- {  act = "tw_apparatus_01_act"   , misc = "tw_apparatus_01_misc"      },
    [  "tw_apparatus_02_"    ] = true, -- {  act = "tw_apparatus_02_act"   , misc = "tw_apparatus_02_misc"      },
    [  "tw_apparatus_03_"    ] = true, -- {  act = "tw_apparatus_03_act"   , misc = "tw_apparatus_03_misc"      },
    [  "tw_apparatus_04_"    ] = true, -- {  act = "tw_apparatus_04_act"   , misc = "tw_apparatus_04_misc"      },
    [  "tw_apparatus_05_"    ] = true, -- {  act = "tw_apparatus_05_act"   , misc = "tw_apparatus_05_misc"      },
    [  "tw_apparatus_06_"    ] = true, -- {  act = "tw_apparatus_06_act"   , misc = "tw_apparatus_06_misc"      },
    --{  "tw_bagofholding_misc"
  }
--]]  
  ...
  if ( string.sub( target:lower(), -3 ) == "act" ) then
    ...
    if itemlist[ item ] then -- string.sub("%s%s", e.target.id:lower() ) then  -- , "act") ] then
...
--mwse.log("************* WTF! ************  %s", cell)  
    ...
    if e.activator == tes3.player then
        ...
        elseif (e.target.id == "tw_safestore_01_act") or (e.target.id == "tw_safestore_02_act") or (e.target.id == "tw_safestore_03_act") or
               (e.target.id == "tw_safestore_04_act") or (e.target.id == "tw_safestore_05_act") or (e.target.id == "tw_safestore_06_act") then
            lSafestore = 1       
        ...
        enabledStores = {
            ...
            tw_safe_store      = (lStore == 1 or lSafestore == 1)  --true,
        }        

--messageBox("lStore = %s  lKey = %s  books = %s ",lStore, lKeys, lBooks   )

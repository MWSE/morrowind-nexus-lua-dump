...
function this.onCreate(parent)
    ...
    local header = pane:createLabel{ text = "Weather Adjuster - от Sun's Reach Laboratorum\nверсия " .. verString }
    ...
    mwse.mcm.createOnOffButton(configBlock,
        {
            class = "OnOffButton",
            label = "Показывать сообщения об изменении региона",
            leftSide = false,

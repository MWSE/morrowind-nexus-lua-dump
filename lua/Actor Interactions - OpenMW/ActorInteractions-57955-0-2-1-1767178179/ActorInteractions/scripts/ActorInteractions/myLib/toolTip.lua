...
local RANGED_WEAPON = require('scripts.ActorInteractions.myLib.myTypes').RANGED_WEAPON
local RANGED_AMMO   = require('scripts.ActorInteractions.myLib.myTypes').RANGED_AMMO
...
local mouse         = require('scripts.ActorInteractions.myLib.myUtils').mouse
...
toolTip.showToolTip = function(thing, forcePos)
        ...
        if data.condition then
                ...
                --         data.condition, max
                -- ))
                table.insert(valueCol, gui.makeGUIBar(value, max, 130, sizes.TOOLTIP_TEXT_SIZE, 'ff0000'))
        end
        ...
        if record.enchant then
                ...
                if enchantment.type ~= core.magic.ENCHANTMENT_TYPE.CastOnce
                    and enchantment.type ~= core.magic.ENCHANTMENT_TYPE.ConstantEffect then
                        ...
                        table.insert(cRow, gui.makeGUIBar(value, max, 130, sizes.TOOLTIP_TEXT_SIZE, 'ff0000'))

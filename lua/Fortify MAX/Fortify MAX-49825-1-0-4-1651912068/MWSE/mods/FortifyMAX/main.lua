...
local function onInitialized()
    ...
    common.logMsg("Main", string.format("interop.magicka = %s. interop.fatigue = %s", interop.magicka, interop.fatigue))
...
-- Low priority to ensure Attribute Effect Tweaks can set its interop variable before we check it.

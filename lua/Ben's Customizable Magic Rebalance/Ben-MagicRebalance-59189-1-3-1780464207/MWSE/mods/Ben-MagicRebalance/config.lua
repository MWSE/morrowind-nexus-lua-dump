...
local defaultMcmConfig = {
    ...
    spell = {
        ...
        weakEffectIds = {
            ...
            [tes3.effect.curePoison] = true,
            [tes3.effect.cureParalyzation] = true,
            [tes3.effect.cureCommonDisease] = true,
            [tes3.effect.cureBlightDisease] = true,
            [tes3.effect.cureCorprusDisease] = true,
            ...
            [tes3.effect.spellAbsorption] = true,
            ...
            -- Manipulate
            [tes3.effect.calmCreature] = true,
            [tes3.effect.calmHumanoid] = true,
            [tes3.effect.frenzyCreature] = true,
            [tes3.effect.frenzyHumanoid] = true,
            [tes3.effect.rallyCreature] = true,
            [tes3.effect.rallyHumanoid] = true,
            [tes3.effect.turnUndead] = true,
            [tes3.effect.demoralizeCreature] = true,
            [tes3.effect.demoralizeHumanoid] = true,
            [tes3.effect.commandCreature] = true,
            [tes3.effect.commandHumanoid] = true,

            -- Traverse
            [tes3.effect.slowFall] = true,
            [tes3.effect.jump] = true,
            [tes3.effect.swiftSwim] = true,
            [tes3.effect.levitate] = true,
            [tes3.effect.feather] = true,
            [tes3.effect.burden] = true,
            [tes3.effect.waterBreathing] = true,
            [tes3.effect.waterWalking] = true,
            [tes3.effect.almsiviIntervention] = true,
            [tes3.effect.divineIntervention] = true,
            [tes3.effect.mark] = true,
            [tes3.effect.recall] = true,

            -- Explore
            [tes3.effect.open] = true,
            [tes3.effect.lock] = true,
            [tes3.effect.light] = true,
            [tes3.effect.nightEye] = true,
            [tes3.effect.detectAnimal] = true,
            [tes3.effect.detectEnchantment] = true,
            [tes3.effect.detectKey] = true,
            [tes3.effect.charm] = true,
            [tes3.effect.telekinesis] = true,
...
local staticConfig = { -- config values that aren't exposed to the player
    ...
    spell = {
        npcMinDuration = 3,
        npcMaxDuration = 60,
        npcMaxDurationParalyze = 10,
        npcMaxMagnitudeBlind = 75,
        npcMaxMagnitudeSound = 150,
        npcUpdateAutoCalcSpellPicks = true,
        npcSpellPicksPerMagicSchool = 2,
        npcSpellPicksConjurationMax = 1,
        npcReplaceHighCostSpells = true,
        npcReplaceDamageWithDrain = true,

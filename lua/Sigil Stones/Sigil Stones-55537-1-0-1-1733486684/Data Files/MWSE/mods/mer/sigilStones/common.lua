---@class SigilStones.Common
local common = {}
common.config = require("mer.sigilStones.config")
local i18n = mwse.loadTranslations("mer.sigilStones")

---@type SigilStones.i18n
...
--Initialise all files in a directory

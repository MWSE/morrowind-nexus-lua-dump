return {
    ...
    -- Frequency per second for checking the wounded status
    checkWoundedRefreshRate = 0.1,

    -- Frequency per second for checking if a healer or a healing item is needed
    checkNeedsHealingRefreshRate = 1,

...
this.UIData = {
    hunger = {
        ...
        getTooltip = function()
            return string.format (
                ( "Голод усиливается, когда персонажу холодно. " ..
                "Ешьте, чтобы утолить чувство голода. Готовьте мясо и овощи на " ..
                "гриле, чтобы повысить их питательность. " ..
                "\n\nВаш текущий уровень голода %d%%. %s" ),
    ...
    thirst = {
        ...
        getTooltip = function()
            return string.format(
                ("Жажда усиливается, когда персонажу жарко. " ..
                "Пейте воду, чтобы утолить жажду. Не забудьте прокипятить грязную воду перед употреблением. " ..
                "\n\nВаш текущий уровень жажды %d%%. %s"),
    ...
    tiredness = {
        ...
        getTooltip = function()
            return string.format(
                ("Усталость наступает со временем и восстанавливается во время отдыха. " ..
                "Чтобы быстрее восстановить усталость, спите на кровати или спальнике.  " ..
                "\n\nВаш текущий уровень усталости %d%%. %s"),

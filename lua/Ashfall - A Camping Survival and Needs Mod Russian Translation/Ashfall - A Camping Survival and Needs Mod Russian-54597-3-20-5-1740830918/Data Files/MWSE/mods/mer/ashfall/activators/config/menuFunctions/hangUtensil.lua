...
local function utensilSelect(campfire)
    timer.delayOneFrame(function()
        common.helper.showInventorySelectMenu{
            title = "Выберите посуду",
            noResultsText = "У вас нет посуды.",
            filter = function(e)
...
return {
    ...
    tooltip = function()
        return common.helper.showHint("Вы можете повесить посуду, поставив ее прямо на опоры.")
    end,
    tooltipDisabled = {
        text = "У вас нет подходящей посуды."
    },

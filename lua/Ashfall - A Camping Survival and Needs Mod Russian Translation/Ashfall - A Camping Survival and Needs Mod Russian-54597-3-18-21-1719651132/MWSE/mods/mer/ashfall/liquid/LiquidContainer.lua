...
function LiquidContainer.transferLiquid(from, to, amount)
    ...
    if item and item.name then
        tes3.messageBox('%s наполняется %s.', common.helper.getGenericUtensilName(item), from:getLiquidName())
    end
    -- waterHeat

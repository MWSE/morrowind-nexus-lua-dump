...
return {
    ...
    callback = function(reference)
        ...
        local stewName = foodConfig.isStewNotSoup(reference.data.stewLevels) and "рагу" or "суп"
        tes3.messageBox("Ваши спутники едят %s.", stewName)

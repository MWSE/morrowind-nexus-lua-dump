...
local bushCraftingRecipes = {
    ...
    master = {
        ...
        },
        {
            ...
            description = "Маленькая лютня из дерева и кожи.",
            materials = {
                { material = "wood", count = 2 },
                { material = "leather", count = 1 },
                { material = "fibre", count = 4 },
...
local workbenchRecipes = {
    ...
    apprentice = {
        ...
        --Small Awning
        {
            ...
            name = "Навес (малый)",
            description = "Кожаный навес, который можно установить на земле.",
            materials = {
                { material = "leather", count = 2 },
                { material = "wood", count = 2 },
                { material = "rope", count = 2 },
        ...
        --OAAB Barricade
        {
            ...
            name = "Заграждение",
            description = "Деревянное заграждение, которое можно установить на земле.",
            materials = {
                { material = "wood", count = 4 },
                { material = "rope", count = 2 },
            },
        ...
        --OAAB wALL
        {
            ...
            description = "Большая деревянная стена.",
            materials = {
                { material = "wood", count = 5 },
            },
            category = this.categories.structures,
        ...
        --Roof Small
        {
            ...
            name = "Соломенная крыша (малая)",
            description = "Небольшая соломенная крыша для деревянного строения.",
            materials = {
                { material = "straw", count = 8 },
                { material = "wood", count = 2 },
                { material = "rope", count = 2 },
        ...
        --Roof Larger
        {
            ...
            name = "Соломенная крыша (большая)",
            description = "Большая соломенная крыша для деревянного строения.",
            materials = {
        ...
        --OAAB Market Stand
        {
            ...
            name = "Торговая палатка",
            description = "Большая торговая палатка.",
            materials = {
                { material = "wood", count = 5 },
                { material = "rope", count = 2 },
                { material = "fabric", count = 4 },

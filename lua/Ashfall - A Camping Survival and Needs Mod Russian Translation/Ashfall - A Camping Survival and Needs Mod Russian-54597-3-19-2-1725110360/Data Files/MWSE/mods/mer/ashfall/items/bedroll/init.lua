...
BedRoll.buttons = {
    sleep = {
        ...
        tooltipDisabled = function()
            return {
                text = tes3.canRest{ checkForSolidGround = false } and "Здесь нельзя отдыхать." or "Вы не можете отдыхать - враги близко."
            }
        end,
    },
    layDown = {
        ...
        tooltipDisabled = function()
            return {
                text = tes3.canRest{} and "Здесь нельзя отдыхать." or "Вы не можете отдыхать - враги близко."
            }
        end,
    },
    pickUp = {

...
WoodStack.buttons = {
    addWood = {
        ...
        tooltip = function()
            return common.helper.showHint(
                "Вы можете добавлять дрова, бросая их прямо в стопку дров."
            )
        end,
        ...
        tooltipDisabled = {
            text = function()
                ...
                return playerHasWood and "Штабель заполнен" or "У вас отсутствуют дрова"
            end
        },
        callback = function(e)
            local reference = e.reference
            ...
            if spaceRemaining == 0 then
                tes3.messageBox("Штабель заполнен.")
                return
            end
            ...
            common.helper.createSliderPopup{
                ...
                okayCallback = function()
                    ...
                    tes3.messageBox("Добавлено %s%s.", t.amount > 1 and t.amount .. " " or "", tes3.getObject("ashfall_firewood").name)
    ...
    takeWood = {
        ...
        tooltipDisabled = {
            text = "В штабеле отсутствуют дрова"
        },
        callback = function(e)
            local reference = e.reference
            local woodAmount = WoodStack.getWoodAmount(reference)

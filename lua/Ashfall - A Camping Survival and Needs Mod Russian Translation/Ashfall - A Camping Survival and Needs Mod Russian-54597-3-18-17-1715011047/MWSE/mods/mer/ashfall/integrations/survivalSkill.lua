...
local skills = {
    survival = {
        ...
        description = "Навык Выживание определяет вашу способность справляться с суровыми погодными условиями и выполнять такие действия, как разведение костров и приготовление пищи на них. Более высокий навык выживания также снижает вероятность пищевого отравления или дизентерии при употреблении грязной воды.",
    ...
    bushcrafting = {
        ...
        description = "Навык Ремесленник определяет вашу способность создавать предметы из подручных материалов, собранных в дикой местности. Более высокий навык Ремесленник открывает больше рецептов для создания предметов.",

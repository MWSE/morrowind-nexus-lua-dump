    ...
    do --General Settings Page
        ...
        do --Default Settings Category
            ...
            categoryOverrides:createYesNoButton{
                ...
                variable = mwse.mcm.createTableVariable{
                    ...
                    --restartRequiredMessage = "1Changing this setting requires a game restart to come into effect."
                }
            }
        ...
        do --Miscellanious Category
            ...
            categoryMisc:createYesNoButton{
                ...
                description = "Когда вы испытываете жажду, ваша максимальная магия (а, следовательно, и текущая магия) уменьшается. По умолчанию уталение жажды восстанавливает то же количество текущей магии, что и было потеряно из-за жажды, даже если у вас есть знак Атронаха. Отключите этот параметр, чтобы предотвратить увеличение магии. Имейте в виду, что вам, как Атронаху, нужно будет найти способы восстановить свою магию уталения жажды.",
                variable = mwse.mcm.createTableVariable{ id = "atronachRecoverMagickaDrinking", table = config }
            }

            categoryMisc:createYesNoButton{
                label = "Зелье влаги",
                description = "При включении этой функции, то употребление зелья обеспечит небольшое количество жидкости.",

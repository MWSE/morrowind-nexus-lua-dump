...
local function getStewMenuText(merchantObj)
    ...
    return string.format("Горячая пища (%d зол.)", cost)
end
...
local function makeTooltip()
    ...
    local labelText = "Купите рагу или суп."

...
this.enchantments = {
    fire = {
        id = "_fire_01",
        description = "зачарованные на урон огнем",
        ingredients = {
    ...
    fireCruel = {
        id = "_fire_02",
        description = "зачарованные на сильный урон огнем",
        ingredients = {
    ...
    fireDire = {
        id = "_fire_03",
        description = "зачарованные на очень сильный урон огнем",
        ingredients = {
    ...
    frost = {
        id = "_frost_01",
        description = "зачарованные на урон холодом",
        ingredients = {
    ...
    frostCruel = {
        id = "_frost_02",
        description = "зачарованные на сильный урон холодом",
        ingredients = {
    ...
    frostDire = {
        id = "_frost_03",
        description = "зачарованные на очень сильный урон холодом",
        ingredients = {
    ...
    shock = {
        id = "_shock_01",
        description = "зачарованные на урон молнией",
        ingredients = {
    ...
    shockCruel = {
        id = "_shock_02",
        description = "зачарованные на сильный урон молнией",
        ingredients = {
    ...
    shockDire = {
        id = "_shock_03",
        description = "зачарованные на очень сильный урон молнией",
        ingredients = {
    ...
    poison = {
        id = "_poison_01",
        description = "зачарованные на отравление",
        ingredients = {
    ...
    poisonCruel = {
        id = "_poison_02",
        description = "зачарованные на сильное отравление",
        ingredients = {
    ...
    poisonDire = {
        id = "_poison_03",
        description = "зачарованные на очень сильное отравление",
        ingredients = {
    ...
    paralyse = {
        id = "_paralyse_01",
        description = "зачарованные на парализацию цели",
        ingredients = {
    ...
    cupid = {
        id = "_cupid",
        description = "зачарованные на усмирение врагов",
        ingredients = {
    ...
    mageBain = {
        id = "_magebane",
        description = "зачарованные на дезориентацию заклинателей",
        ingredients = {
    ...
    fury = {
        id = "_fury",
        description = "зачарованные на обширный урон огнем, холодом, молнией",
        ingredients = {
            { id = "ingred_fire_salts_01", count = 1 },
            { id = "ingred_frost_salts_01", count = 1 },
            { id = "ingred_scrap_metal_01", count = 1 }

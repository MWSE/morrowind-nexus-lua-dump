...
stuff.abType = {
	...
	[8] = "[AURA]",
	[9] = "[PASSIVE]",
	[10] = "[TECHNIQUE]: ACTIVATED",
	[11] = "[PASSIVE]",
	[12] = "[TRIGGERED]: SPECIFIC",
	[13] = "[PASSIVE]",
	[14] = "[PASSIVE]",
	[15] = "[TECHNIQUE]: ACTIVATED",
	[16] = "[AURA]",
	[17] = "[PASSIVE]",
	[18] = "[PASSIVE]",
	[19] = "[PASSIVE]",
...
stuff.abDescription = {
	...
	[37] = "The colony provides.",
	[38] = "O, to be skittering about in the darkness, free of scrutiny..!",
	[39] = "The most terrible of agonies are often delivered in the smallest of packages.",
	[40] = "Many bodies. One single mind.",
	...
	[47] = "Some objects may not be innately immovable, but simply refuse to be moved.",
...
stuff.abTypeNPC = {
	...
	[113] = "[TECHNIQUE]: ACTIVATED",
	[114] = "[TRIGGERED]: WILDERNESS",
	[115] = "[TECHNIQUE]: ACTIVATED",
	[116] = "[TRIGGERED]: JOB",
	[117] = "[AURA]",
	[118] = "[TECHNIQUE]: ACTIVATED",
	[119] = "[AURA]",
	[120] = "[COMBAT]",
	...
	[124] = "[PASSIVE]",
	[125] = "[PASSIVE]",
	[126] = "[TECHNIQUE]: ACTIVATED",
	[127] = "[TECHNIQUE]: ACTIVATED",
	[128] = "[TECHNIQUE]: ACTIVATED",
	[129] = "[COMBAT]",
	[130] = "[PASSIVE]",
	[131] = "[COMBAT]",
...
stuff.abDescriptionNPC2 = {
	...
	[40] = "",
	[41] = "Archaeologists can potentially unearth artifacts or trash. Some sites are more promising than others.",
...
stuff.patronGifts = {
	...
	[7] = "The Cleric earns the Strength to protect and the Endurance to stand fast in the face of hardship through their own hard work, every 3 levels.",
...
stuff.patronTypes = {
	...
	[14] = "[TECHNIQUE]: ACTIVATED",
	[15] = "[TRIGGERED]: LEVEL UP",
	[16] = "[COMBAT]",
	[17] = "[COMBAT]",
	[18] = "[COMBAT]",
	[19] = "[COMBAT]",
	[20] = "[TECHNIQUE]: ACTIVATED",
	[21] = "[COMBAT]",
	[22] = "[TRIGGERED]: SPECIFIC",
...
stuff.guildTrainedMessages = {
	[1] = "This organism was chosen for further study by the Guild of Mages due to its abnormal affinity to magicka.",
	[2] = "The Guild of Fighters trained this creature to swiftly deal with any threat on command.",
	[3] = "The Thieves Guild trained this creature to steal all sorts of items from unsuspecting marks or hard-to-reach places.",
	[4] = "The Blades utilized this creature to carry coded messages quickly and discreetly across all manner of terrain.",
	[5] = "The Temple blessed this creature, fashioning it into a living proof of the power of the Tribunal.",
	...
	[13] = "The East Empire Company taught this creature to fill their purses by surveying caves and sniffing out natural glass and ebony deposits.",
	[14] = "The Twin Lamps trained this creature to navigate labyrinthine tunnels, leading many slaves to freedom while eluding their lost pursuers.",
	[15] = "This creature once roamed about with Ashlanders, and was trained to hunt other beasts alongside the Ashland nomads.",
	[16] = "The Camonna Tong used this creature as a drug mule for some time, causing the creature to develop an odd immunity to poison.",
	[17] = "House Dres instilled a deep bias against all non-Dunmer races in this creature, in order to aid in intimidating or subduing slaves.",
	[18] = "House Indoril, through traditional ceremony, bestowed upon this creature a protective Ancestral Guardian.",
	[19] = "The Imperial Archaeological Society commissioned this specially trained creature to help detect sites of archaeological interest.",
	[20] = "The Imperial Astrological Society permanently altered this creature after attuning it to various doom stones for study.",
	[21] = "This creature toured the world at the behest of the Imperial Geographical Society, traveling with various adventurers."
}

stuff.guildTrainedHints = {
	[1] = "Technique Points increase by 1.",
	[2] = "Attacks deal 1-4 flat additional damage.",
	[3] = "(Agility) Retrieve nearby items as a technique. Only certain, smaller items may be retrieved.",
	[4] = "+1 Speed every 2 levels, and +1 Agility every 3 levels.",
	[5] = "Perform the Almsivi Intervention ritual on the party as a technique.",
	[6] = "May bestow one of nine blessings upon the party as a technique.",
	[7] = "Technique Points increase by 5.",
	[8] = "Ash Creatures incite a fervor upon this creature in combat.",
	[9] = "(Reputation) House Hlaalu provides a small stipend each level. Increases with player reputation and companion level.",
	[10] = "Attacks from this creature have a 5% chance of dealing critical damage.",
	[11] = "Prevents resting from being interrupted.",
	[12] = "Passively detect nearby enchanted items.",
	[13] = "Automatically detect the presence of nearby glass and ebony deposits.",
	[14] = "Immediately escape most interiors as a technique.",
	[15] = "Attacks from this creature deal 5% additional damage to all other creatures.",
	[16] = "",
	[17] = "Attacks from this creature deal 7% additional damage to all non-Dunmer humanoids.",
	[18] = "An Ancestral Guardian protects this creature in combat, also providing a shield.",
	[19] = "Detect the presence of ruins both dwemer and daedric, as well as most shipwrecks.",
	[20] = "As the months change, so too do the creature's benefits.",
	[21] = "Technique Points increase by 1."
}
...
stuff.npcMessage = {
	...
	[95] = "With each action, the course of history is altered.",
	[96] = "Will the scribes write of them as well? Or will they be forgotten?",
	[97] = "For every scar, a story. For every failure, a lesson.",
	[98] = "Even masters must train to retain the title.",
	[99] = "You can feel it now. The apex is in sight. The summit.",
	[100] = "Having left your mark on the world, you journey on with your allies at your side..."
}

    ...
    MCM = {
        main_page = {
            ...
            auto_close = {
                ...
                desc = 'This setting governs whether containers should be closed automatically after being opened.\n\n\z
                    \z
            ...
            auto_close_if_empty ={
                ...
                desc = "This setting requires the previous setting to be enabled.\n\n\z
                    \z

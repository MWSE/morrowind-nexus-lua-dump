...
function common.is_pickupable(ref)
    return common.pickupable[ref.object.objectType] or
        ref.object.objectType == tes3.objectType.light and ref.object.canCarry
        or false
end
...
do -- set meshes to replace 
    ...
    common.meshes_to_replace = {
        ...
        ['o\\contain_barrel_01.nif'] = config.barrel_rivet and 'AC\\Anim_Barrel_01.nif' or 'AC\\Anim_Barrel_noRivet.nif',

...
this.akaviri = {
    ...
    name = "Akaviri",
    description = (
        "Akaviri or Men of Akavir are a human race native to Akavir.\n\nAdmixture of Akaviri blood flowing in your veins grants you bonus to long blade at a cost of penalty to blunt weapon. \n\nBonus to Long Blade (+10) and penalty to Blunt Weapon (-10) are traits of those with Akaviri ancestry."
    ),
    doOnce = function()
		mwscript.addSpell{
            reference = tes3.player, 
            spell = "mtrLineage_Akaviri"
        }
		tes3.modStatistic({
            reference = tes3.player,
...
this.giant = {
    ...
    doOnce = function()
		tes3.player.scale = tes3.player.scale * 1.15
		mwscript.addSpell{
            reference = tes3.player, 
            spell = "mtrLineage_Giant"
        }
		tes3.modStatistic({
            reference = tes3.player,
...
this.dwemer = {
    ...
    name = "Dwemer",
    description = (
        "Dwemer, also known as Dwarves and Deep Elves, were an elven race living in Morrowind and Hammerfell.\n\nAdmixture of Dwemer blood flowing in your veins grants you bonus to intelligence, enchanting and armorer at a cost of penalty to personality and luck. \n\nBonus to Intelligence (+10), bonus to Enchant (+10), bonus to Armorer (+10), penalty to Personality (-10) and Luck (-10) are traits of those with Dwemer ancestry."
    ),
    doOnce = function()
		tes3.modStatistic({
            reference = tes3.player,
...
this.naga = {
    ...
    name = "Naga",
    description = (
        "Naga are a breed of Argonians who live in deeper parts of Black Marsh. They are described as having \"huge mouths filled with dripping needle-like fangs\". \n\nAdmixture of Naga blood flowing in your veins grants you bonus to strength at a cost of penalty to intelligence. \n\nBonus to Strength (+10) and penalty to Intelligence (-10) are traits of those with Naga ancestry."
    ),
    doOnce = function()
		tes3.player.scale = tes3.player.scale * 1.05
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "mtrLineage_Naga"
        }
		tes3.modStatistic({
            reference = tes3.player,
            attribute = tes3.attribute.intelligence, 

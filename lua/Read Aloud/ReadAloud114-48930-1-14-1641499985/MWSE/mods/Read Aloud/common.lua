...
["([%W]?)("..CONSONANT..")([Aa])([cfhlmqr]%W)"] = "%1%2%3%3%4", -- double vocal in 3 letters e.g. Bal --> Baal
["([%W])[Uu][Ss](%s)"] = "%1as%2", -- us --> as

["([bB])attlemage"] = "%1attle-mage",
["[Mm]orrowind's"] = "Morro-wind's",
["([Tt])hu'um"] = "%1huum",
["%s("..CONSONANT..")y("..CONSONANT.."[%s%p<$])"] = "%1i%2",

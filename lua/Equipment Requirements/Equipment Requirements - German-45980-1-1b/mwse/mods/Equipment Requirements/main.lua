...
local armorClassInfo = {
  [0] = {text = "Leichte Rüstung",  name = "lightArmor"},
  [1] = {text = "Mittlere Rüstung", name = "mediumArmor"},
  [2] = {text = "Schwere Rüstung",  name = "heavyArmor"},
}
...
local weaponTypeInfo = {
    ...
    ["MarksmanBow"]       = {text = "Schütze",     name= "marksman"},
    ["MarksmanCrossbow"]  = {text = "Schütze",     name= "marksman"},
    ["MarksmanThrown"]    = {text = "Schütze",     name= "marksman"},
    ["Arrow"]             = {text = "Schütze",     name= "marksman"},
    ["Bolt"]              = {text = "Schütze",     name= "marksman"},
}
...
local function reqTooltip(e)
	...
	if skillReq then
        local text = string.format("Benötigt %s : %u", skillInfo.text, skillReq)
  	...
  	if e.reference == tes3.player then
        ...
        if skillReq then
            if tes3.mobilePlayer[skillInfo.name].current < skillReq then
                tes3.messageBox("Eure %s-Fähigkeit ist zu niedrig um %s anzulegen.", skillInfo.text, e.item.name)
                return false
            end
        end
    end

...
local weaponTypeInfo = {
    ["ShortBladeOneHand"] = {text = "Kurzwaffe",  name= "shortBlade"},
    ["LongBladeOneHand"]  = {text = "Langwaffe",   name= "longBlade"},
    ["LongBladeTwoClose"] = {text = "Langwaffe",   name= "longBlade"},
    ["BluntOneHand"]      = {text = "Stumpfe Waffe", name= "bluntWeapon"},
    ["BluntTwoClose"]     = {text = "Stumpfe Waffe", name= "bluntWeapon"},
    ["BluntTwoWide"]      = {text = "Stumpfe Waffe", name= "bluntWeapon"},

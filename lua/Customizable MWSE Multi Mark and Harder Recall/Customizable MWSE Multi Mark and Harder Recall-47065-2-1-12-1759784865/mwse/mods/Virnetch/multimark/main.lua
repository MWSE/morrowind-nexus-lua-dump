...
--Create Mark Menu
	...
	local MarkLabel = MarkLabelBlock:createLabel({ text = "You have " .. MarksLeft .. "/" .. MarksTotal .. " Marks left. Where do you want to mark your current location?" })
	...
	local companionLabel = companionLabelBlock:createLabel({ text = "Add companions to Recall them to you later." })
...
--Create Recall Menu
	...
	local RecallLabel = RecallLabelBlock:createLabel({ text = 'You have '..MarksUsed..' Marks placed. Where do you want to recall?' })
	...
	companionLabelBlock.autoHeight = true
	companionLabelBlock.widthProportional = 5 / 6
	local companionLabel = companionLabelBlock:createLabel({ text = "Recall companions to your location." })
	companionLabel.wrapText = true
	companionLabel.widthProportional = 1
...
local function registerModConfig()
	...
	markCategory:createOnOffButton{
		label = "Skip recall confirmation",
		description = "If enabled, the confirmation prompt when recalling to a location will be skipped. Holding shift while clicking on a location will ignore this setting to allow the deletion of marked locations. Default: Off",
		variable = EasyMCM.createTableVariable{

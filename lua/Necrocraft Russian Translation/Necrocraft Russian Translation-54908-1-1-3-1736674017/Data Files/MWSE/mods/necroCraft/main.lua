...
local function onTooltipDrawn(e)
	...
	label.wrapText = true
	tooltip:createLabel{id=tes3ui.registerID("HelpMenu_weight"), text="Вес: "..string.format("%.2f", misc.weight)}
	tooltip:createLabel{id=tes3ui.registerID("HelpMenu_value"), text="Цена: "..tostring(misc.value)}

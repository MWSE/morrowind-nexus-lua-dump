...
return {
    ...
    name = "Дитя звезд",
    description = (
        "Вы родились под светом звезд и заслужили благоволение Созвездий. " ..
        "Ночью под открытым небом ваша удача увеличивается на " ..
        starChildLuckClear .. " пунктов в ясную погоду и " ..
        starChildLuckCloudy.. " пунктов в облачную погоду. "
        ...
        local function update()
            ...
            if isNight and isOutdoors and luckLevel then
                ...
                if not data.starChild.luck or luckLevel ~= data.starChild.luck then
                    ...
                    tes3.messageBox("Созвездия благоволят вам.")
                end
            else

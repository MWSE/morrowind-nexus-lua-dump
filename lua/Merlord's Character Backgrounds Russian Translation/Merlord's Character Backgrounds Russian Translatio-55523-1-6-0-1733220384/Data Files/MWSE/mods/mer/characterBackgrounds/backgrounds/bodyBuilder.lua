...
local background = interop.addBackground{
    ...
    name = "Бодибилдер",
    description = (
        "У вас потрясающее тело. Когда вы его демонстрируете, люди просто тают. " ..
        "Когда на вас нет рубашки и кирасы, вы получаете +10 к привлекательности. " ..
        "К сожалению, ваше тело - лучшее, что у вас есть, и, не " ..
        "видя вашей красоты, окружающие быстро осознают, насколько вы неинтересны. " ..
        "Когда на вас надета рубашка или кираса, вы получаете -10 к привлекательности. "
    ),
    defaultData = {
        buffed = false,
        debuffed = false,

...
function Telescope.showMenu()
    ...
    local header = block:createLabel{ text = "Dwemer Telescope" }
    header.color = tes3ui.getPalette("header_color")
    block:createLabel{ text = "- Scrollwheel to Zoom" }
    ...
    block:createLabel{ text = string.format("- Press %s to Exit", activateText:upper())}
end
...
function Telescope.activate(e)
    ...
    elseif e.isObservatory then
        tes3.messageBox("The telescope doesn't seem to be working.")
        return
    else
...
---@return boolean #True if the comet has been seen through the telescope this viewing
function Telescope.hasViewedComet()
    return common.config.tempData.telescopeCometViewed == true
end

---Flag to indicate the comet has been viewed this viewing
function Telescope.setCometViewed()
    common.config.tempData.telescopeCometViewed = true
end

function Telescope.unsetCometViewed()
    common.config.tempData.telescopeCometViewed = false
end

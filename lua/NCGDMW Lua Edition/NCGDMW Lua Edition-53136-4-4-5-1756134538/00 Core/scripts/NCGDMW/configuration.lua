...
local config = {
    ...
    skillUseTypes = {
        ...
        [Skills.acrobatics.id] = {
            [UseTypes.Acrobatics_Jump] = { key = "Jump", gain = 0.15, vanilla = 0.15 },
    ...
    jumpGainLandingHeightFactor = 1,
    jumpGainLandingFallDamageMaxFactor = 1.25,
    jumpGainMaxDistFactor = 0.2,
    jumpGainWaterFactor = 0.25,
    jumpGainLavaFactor = 1.5,
}

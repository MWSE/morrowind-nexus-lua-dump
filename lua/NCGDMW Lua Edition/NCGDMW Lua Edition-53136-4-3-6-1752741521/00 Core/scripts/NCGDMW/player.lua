...
local function init(clearAll)
    ...
    if not isInitialized or not state.isCRELMode then
...
local function onUpdate(deltaTime)
    ...
    if softInitAsked or (not isInitialized and not isStarwindMode and T.Player.isCharGenFinished(self)) then

...
local openmw049ornewer = core.API_REVISION >= 56
if openmw049ornewer then
...
local function decayStatsMenu(skills, decayMem, starwindNames, decayRate, growthRate)
    ...
    local rightBlock = {
        ...
        gap10,
        head(L("Settings")),
        row(L("growthRate"), growthRate),
        row(L("decayRate"), decayRate)
    }
...
local function getDescriptionIfOpenmw48(key)
    if not openmw049ornewer then
...
local function initSettings()
    ...
    if not openmw049ornewer then
        ...
        playerStorage:set("skillIncreaseConstantFactor", nil)
        playerStorage:set("skillIncreaseSquaredLevelFactor", nil)
        playerStorage:set("skillIncreaseFromBooks", nil)
    end
    I.Settings.registerGroup {
        ...
        settings = {
            ...
            },
            {
                ...
                description = getDescriptionIfOpenmw48("skillIncreaseConstantFactor_description"),
                default = "vanilla",
                argument = {
                    l10n = MOD_NAME,
                    items = { "vanilla", "half", "quarter" },
                    disabled = not openmw049ornewer,
                },
                renderer = "select",
            },
            {
                ...
                description = getDescriptionIfOpenmw48("skillIncreaseSquaredLevelFactor_description"),
                default = "disabled",
                argument = {
                    l10n = MOD_NAME,
            ...
            },
            {
                ...
                renderer = "checkbox",
                description = getDescriptionIfOpenmw48(""),
            },
            {
                key = "starwindNames",
            ...
            {
                key = "showIntro",
                name = "Show the mod startup message",
                default = true,
                renderer = "checkbox"
            },
            {
                key = "debugMode",
                name = "Print debug messages to the console",
                default = false,
                renderer = "checkbox"
            },
        }

        ...
        settings = {
            {
                ...
                renderer = mDef.renderers.decay_rate,
                argument = {
                    l10n = mDef.MOD_NAME,
            ...
            },
            {
                ...
                name = "skillDecayReductionRate_name",
                description = "skillDecayReductionRate_description",
            ...
            },
            {
                ...
                name = "skillDecayIntelligenceFactor_name",
                description = "skillDecayIntelligenceFactor_description",
                default = 0,
                renderer = mDef.renderers.number,
...
return {
    ...
    getSkillDecayReductionRates = function(key)

...
local MOD_ID         = require('scripts.oneKeyActionsList.settingsData').MOD_ID
...
local gui            = require('scripts.oneKeyActionsList.myLib.myGUI')
...
input.registerTrigger {
        key = o.showoneOneKeyActionsListWindow.argument.key,
        l10n = MOD_ID,
}

input.registerTrigger {
        key = o.GP_showoneOneKeyActionsListWindow.argument.key,
        l10n = MOD_ID,
}
...
I.Settings.registerGroup {
        ...
        settings = {
                ...
                getSettingsFor(o.windowAlpha),

                makeSeparator('Keyboard Keybinds'),
                makeReset({ o.showoneOneKeyActionsListWindow.key }),
                getSettingsFor(o.showoneOneKeyActionsListWindow),

                makeSeparator('Controller Keybinds'),
                makeReset({ o.GP_showoneOneKeyActionsListWindow.key }),
                getSettingsFor(o.GP_showoneOneKeyActionsListWindow),

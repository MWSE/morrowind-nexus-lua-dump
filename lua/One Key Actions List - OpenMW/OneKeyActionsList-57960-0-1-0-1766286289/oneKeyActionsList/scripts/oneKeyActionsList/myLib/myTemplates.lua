...
---@param padding {}
---@return table
local function getTemplate(thickness, padding, bg, bgTex, alpha, tileV, tileH)
...
local InactiveTab = {
        content = ui.content {
                {
                        template = getTemplate('none', { 1, 0, 0, 0 }, true, textures.inactiveTab, 1, false, true),
                        props = {
                                relativeSize = util.vector2(1, 1),
                                -- alpha = 0.5,
...
--                                 {
--                                         -- template = getTemplate('thin', { 0, 0, 0, 0 }, false),
--                                         template = getTemplate('thick', { 0, 0, 0, 0 }, true, textures.highlight, false, false),
--                                         props = {
--                                                 relativeSize = util.vector2(1, 1),
--                                                 alpha = 0.7,
...
--                         content = ui.content {
--                                 {
--                                         template = getTemplate('none', { 0, 0, 0, 0 }, true, textures.highlight, false, false),
--                                         props = {
--                                                 relativeSize = util.vector2(1, 1),
--                                                 alpha = 1,
...
local entryHighlight = {
        content = ui.content {
                {
                        template = getTemplate('none', { 0, 0, 0, 0 }, true, textures.highlight, 0.7, false, false),
                        props = {
                                relativeSize = util.vector2(1, 1),
...
local entryNormal = {
        content = ui.content {
                {
                        template = getTemplate('none', { 0, 0, 0, 0 }, false),
                        props = {
                                relativeSize = util.vector2(1, 1),

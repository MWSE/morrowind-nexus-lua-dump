local templates = require('scripts.oneKeyActionsList.myLib.myTemplates')
local colors = require('scripts.oneKeyActionsList.myLib.myConstants').colors
local sizes = require('scripts.oneKeyActionsList.myLib.myConstants').sizes
...
local function createTabs(tabs, defaultTab)
        ...
        function self.updateContentContainer()

...
local L = core.l10n(settings.l10n, 'en')
...
function Core.formatZoneMessage(zone)
  if zone == 'insulting' then return L('zone_insulting') end
  if zone == 'low'       then return L('zone_low') end
  if zone == 'close'     then return L('zone_close') end
  if zone == 'success'   then return L('zone_success') end
  if zone == 'critical'  then return L('zone_critical') end
  return L('zone_overpay')
end

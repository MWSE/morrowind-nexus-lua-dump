...
local function createUI()
  ...
  for k,v in ipairs(items) do 
    ...
    local basePrice = rechargeAmt * gemPrice * (1.1 - enchantSkill/100) * 0.1
    ...
    if playerGold >= rechargePrice then
      repairImg.events = {
        ...
        mouseRelease = async:callback(function(data, elem)
          ...
          destroyUI()
          core.sendGlobalEvent('FUJI_doRecharge', { actor = self.object, item = v, actualMax = maxCharge, gold = playerGoldObj, price = rechargePrice })

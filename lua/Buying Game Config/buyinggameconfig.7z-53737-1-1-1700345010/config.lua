...
addCategoryToRegionExport("glass", {"Ald-ruhn", "Grazelands Region", "Almas Thirr"})
addCategoryToRegionExport("pottery", {"Ald-ruhn", "Roth Roryn", "Andothren", "Stirk", "Almas Thirr"})
addCategoryToRegionExport("ingmine", {"Karthwasten", "Dagon Fel", "Arvud", "Grazelands Region", "Molag Mar", "Raven Rock", "Firewatch", "Helnim"})
...
addCategoryToRegionImport("food", {"Ald-ruhn", "Maar Gan", "Ghostgate", "Dagon Fel", "Firewatch", "Helnim", "Arvud", "Molag Mar", "Dragonstar East", "Dragonstar West", "Stirk", "Nivalis", "Padomaic Ocean Region", "Distant Horizon"})

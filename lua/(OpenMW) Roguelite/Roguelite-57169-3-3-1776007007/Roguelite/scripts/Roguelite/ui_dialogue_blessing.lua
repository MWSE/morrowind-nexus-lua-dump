...
local maxSelections = (runDB:get("UNLOCKED_BLESSINGS") or 0) + S_EXTRA_BLESSINGS
...
local availableBlessings = {
	...
	{id = "swift", name = "Swift Feet", description = "+20 Speed and Athletics when out of combat"},
	...
	{id = "disposition", name = "Beloved by All", description = core.API_REVISION >= 111 and "100 <3, calm power, 10 mercantile, +1000 merchant gold" or "100 base dispositions + 20 mercantile + calm power"},
	...
	{id = "wither", name = "Withering Aura", description = "Enemies lose up to 3% of your health per second"},
...
---uuuelse
---uuu	table.insert(availableBlessings,{id = "gatherer", name = "Gatherer", description = "Sometimes receive additional ingredients"})
end

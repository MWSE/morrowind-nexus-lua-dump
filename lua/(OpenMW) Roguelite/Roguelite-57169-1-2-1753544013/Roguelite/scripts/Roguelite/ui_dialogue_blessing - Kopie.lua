...
local availableBlessings = {
    ...
    {id = "hitchance", name = "Warrior's Precision", description = "+30% hit chance"}, 
    {id = "feather", name = "Windwalker's Blessing", description = "150 Feather"}, 
    {id = "sanctuary", name = "Ghostly Shroud", description = "+30% sanctuary"}, 
    {id = "attribute", name = "Blessed by Azura", description = "One attribute starts at 80 but levels slowly"}, 
    {id = "skillup", name = "Divine Inspiration", description = "Skill-up has 35% chance to grant +1 to an attribute"}, 
    {id = "maxgains", name = "Perfect Growth", description = "Always maximum attribute gains on level up"}, 
	{id = "scholar", name = "Lorekeeper's Gift", description = "Skill books grant 7 skill points"},
    {id = "birthsign", name = "Stellar Alignment", description = "Additional birthsign"}, 
    {id = "sneak", name = "Shadow Dancer", description = "Sneak without speed loss and without effort"}, 
    ...
    {id = "soulstone", name = "Soul Hunter", description = "35% chance soulstone on kill"}, 
    {id = "resurgence", name = "Erin's Resurgence", description = "Beneficial buffs get re-applied once"}, 
    --{id = "blocking", name = "Shield Master", description = "When Blocking: 25% Chance to stun target"},
}

if I.HUDMarkers and I.HUDMarkers.version >=6 then
	table.insert(availableBlessings,{id = "herbalist", name = "Green Thumb", description = "Detect ingredients from 120 ft away (via HUDMarkers)"})
end

...
flex.content:add{ props = { size = v2(1, 1) * 1 } }
flex.content:add(textElement("Challenge requirements will increase by "..math.floor((playerSection:get("HARDCORE_PENALTY")-1)*100+0.01).."% when you die the first time", darkerFont, fontSize*0.8))

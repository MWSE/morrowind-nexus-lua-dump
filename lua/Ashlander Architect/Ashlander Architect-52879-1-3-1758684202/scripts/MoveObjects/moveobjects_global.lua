...
local function onUpdate()
    if (player == nil) then
        player = I.DaisyUtilsAA.getPlayer()
    end
...
local function runExportSwitch(player)
    I.tes3ConvTool.generateJsonForSettlement(I.CellSave.getCellNewObjs(player.cell))
end
return {
    ...
    eventHandlers = {
        addTree = addTree,
        dropOne = dropOne,
        runExportSwitch = runExportSwitch,

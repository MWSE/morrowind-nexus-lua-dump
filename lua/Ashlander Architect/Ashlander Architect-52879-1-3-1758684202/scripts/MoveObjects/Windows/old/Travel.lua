...
local function clickFive()
    ...
    if (custData5 ~= nil) then
        ...
        I.DaisyUtils.teleportItemToCell(player, dataInUse.travel5destcellname,
...
local function clickSix()
    ...
    I.TravelWindow.clearWindow()
    core.sendGlobalEvent("clearTempActor")
    I.DaisyUtils.teleportItemToCell(player, dataInUse.travel6destcellname,
...
local function renderTravelOptions(playerref, travelnpcid)
    ...
    local content3 = {}
    local content4 = {}
    table.insert(content, I.DaisyUtilsUI.textContent(""))
...
local function addDestination(name, Tarpos, npc, disposition)
    ...
    price = I.DaisyUtils.getBarterOffer(npc, price, disposition, true)

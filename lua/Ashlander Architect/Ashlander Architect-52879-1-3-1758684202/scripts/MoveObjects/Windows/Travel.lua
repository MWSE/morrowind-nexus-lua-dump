...
local function travelToDestination(destCellName, destPos, destRot, price)
    ...
    print(destRot)
    I.DaisyUtilsAA.removeItem("gold_001", price)
    ...
    I.UI.setMode()
    I.DaisyUtilsAA.teleportItemToCell(self.object, destCellName, destPos, createRotation(0, 0, destRot))
end
...
local function renderTravelOptions(travelActor)
    ...
    table.insert(content, I.DaisyUtilsUI_AA.textContent(""))

...
if types.Player.quests == nil or I.UI == nil or I.UI.setMode == nil then
...
local function TTA_setControlState(state)
    ...
    if state == false then
        I.UI.setMode('Alchemy', { windows = { I.UI.WINDOW.Alchemy } })
    end
end
...
return{eventHandlers = {TTA_ShowMessage = TTA_ShowMessage,TTA_setControlState = TTA_setControlState,
        UiModeChanged       = function(data)
            ...
            if data.newMode == "Alchemy" then
                ...
                core.sendGlobalEvent("TTA_EnterAlchemy")
            elseif data.oldMode == "Alchemy" then
                core.sendGlobalEvent("TTA_ExitAlchemy")

...
function this.addItemNameCell(row, item)
	...
	local nameText = i18n("emptySlotText")
...
function this.addItemIconHeader(row)
	...
	iconCell:createLabel({ text = i18n("iconColumn") })
end
...
function this.addSlotNameHeader(row)
	...
	slotCell:createLabel({ text = i18n("slotColumn") })
end
...
function this.addItemConditionHeader(row)
	...
	conditionCell:createLabel({ text = i18n("conditionColumn") })
end
...
function this.addItemEnchantmentChargeHeader(row)
	...
	enchantmentChargeCell:createLabel({ text = i18n("enchantmentChargeColumn") })
end
...
function this.addItemNameHeader(row)
	...
	itemCell:createLabel({ text = i18n("itemNameColumn") })
end
...
function this.addWeaponTable(equipWindowScroll, weaponSlots)
	...
	if not itemsWereShown and config.showEmptySlotsOnly then
		this.addAllSlotsAreFilledRow(equipWindowScroll, i18n("allSlotsAreFilledWeapon"))
	end
...
function this.addArmorTable(equipWindowScroll, armorSlots)
	...
	if not itemsWereShown and config.showEmptySlotsOnly then
		this.addAllSlotsAreFilledRow(equipWindowScroll, i18n("allSlotsAreFilledArmor"))
	end
...
function this.addClothingTable(equipWindowScroll, clothingSlots)
	...
	if not itemsWereShown and config.showEmptySlotsOnly then
		this.addAllSlotsAreFilledRow(equipWindowScroll, i18n("allSlotsAreFilledClothing"))
	end
...
function this.addAllSlotsAreFilledRow(scrollPane, itemType)
	...
	itemCell:createLabel{ text = "--- " .. i18n("allSlotsAreFilledStart") .. " " .. itemType .. " " .. i18n("allSlotsAreFilledEnd") .. " ---"}.color = { 0.4, 0.4, 0.4 }
end

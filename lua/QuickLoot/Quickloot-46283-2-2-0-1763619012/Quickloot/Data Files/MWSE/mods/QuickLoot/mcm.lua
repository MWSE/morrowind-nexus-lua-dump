...
credits:createHyperlink{
    text = "codering - Scripting, mod compatibility",
    exec = "start https://next.nexusmods.com/profile/RingComics/mods?gameId=100",
}
credits:createHyperlink{
...
toggles:createOnOffButton{
    label = "Show gold and weight",
    description = "Displaying gold and weight from the quickloot menu.\n\nDefault: On\n\n",
    variable = EasyMCM:createTableVariable{
        id = "showGoldAndWeight",
        table = config,
    },
}
toggles:createOnOffButton{
...
toggles:createOnOffButton{
    ...
    description = "Highlight owned containers where taking an item would be stealing.\n\nDefault: On\n\n",
    variable = EasyMCM:createTableVariable{
        id = "showOwned",
        table = config,
    },
...
toggles:createOnOffButton{
    label = "Persistent corpse disposal",
    description = "Allow disposal of corpses flagged as persistent. This may break some quests if they rely on the corpse being accessible.\n\nDefault: On\n\n",
    variable = EasyMCM:createTableVariable{
        id = "disposePersistent",
        table = config,
    },
}

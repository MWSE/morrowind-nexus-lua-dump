...
local function makeSlotSpells(class, tier, hardcore)
    local prefix = "areq_burden_" .. class .. "_"
    local suffix = "_t" .. tier .. (hardcore and "_h" or "")
    local t = {}
...
local BURDEN_SPELLS_HARDCORE = {
    HEAVY  = { [2] = makeSlotSpells("heavy",  2, true), [3] = makeSlotSpells("heavy",  3, true), [4] = makeSlotSpells("heavy",  4, true) },
    MEDIUM = { [2] = makeSlotSpells("medium", 2, true), [3] = makeSlotSpells("medium", 3, true), [4] = makeSlotSpells("medium", 4, true) },
    LIGHT  = { [2] = makeSlotSpells("light",  2, true), [3] = makeSlotSpells("light",  3, true), [4] = makeSlotSpells("light",  4, true) },
    BOUND  = {
        helmet         = "areq_burden_bound_helmet_h",
        cuirass        = "areq_burden_bound_cuirass_h",
        left_gauntlet  = "areq_burden_bound_left_gauntlet_h",
        right_gauntlet = "areq_burden_bound_right_gauntlet_h",
        boots          = "areq_burden_bound_boots_h",
        carried_left   = "areq_burden_bound_shield_h",
    },
}
...
return {
    ...
    BURDEN_SPELLS_HARDCORE = BURDEN_SPELLS_HARDCORE,

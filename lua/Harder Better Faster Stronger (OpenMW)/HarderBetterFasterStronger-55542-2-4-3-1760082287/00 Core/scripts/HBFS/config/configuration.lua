...
local function percentIncreaseArgument(disabled, allowHeaders, requiresOMW50)
    return {
        l10n = mDef.MOD_NAME,
        disabled = disabled,
        allowHeaders = allowHeaders,
        requiresOMW50 = requiresOMW50,
        withIncrease = false,
        perActor = false,
        base = { min = 0, max = 9999 },
...
module.settings = {
    ...
    physicalDamagePercent = {
        ...
        argument = percentIncreaseArgument(not mDef.isOpenMW050, true, not mDef.isOpenMW050),
    },
    magicDamagePercent = {
        order = 4,
        section = sections.player,
    ...
    deathDamagesEquipmentCondition = {
        order = 1,
        section = sections.actors,
        renderer = "checkbox",
        default = true,
...
module.presetBaseRatios = {
    [module.presetsBase.Easier] = -0.5,
    [module.presetsBase.Easy] = -0.25,
...
module.presetPercentRatios = {
    ...
    [percentKey(dynamicStats.magicka)] = 0.5,

...
for key, setting in pairs(module.settings) do
    if setting.enum then
        ...
        setting.argument = { items = items, l10n = mDef.MOD_NAME }
    else
...
module.presetPercentRatios = {
    ...
    [module.settings.magicDamagePercent.key] = 0.5,
    [module.settings.sunDamagePercent.key] = 0.2,
    [percentKey(attributes.strength)] = 0.5,
    [percentKey(attributes.agility)] = 0.5,
    [percentKey(attributes.endurance)] = 1.0,
    [percentKey(attributes.willpower)] = 0.5,

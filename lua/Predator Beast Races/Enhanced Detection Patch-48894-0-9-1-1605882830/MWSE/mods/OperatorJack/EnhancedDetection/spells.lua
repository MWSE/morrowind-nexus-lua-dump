...
local spellIds = {
    khajiitScentAbility = "q_Khajiit_ScentAbility",
    khajiitScentSpell = "q_Khajiit_ScentSpell",
    argonianScentAbility = "q_Argonian_ScentAbility",
    argonianScentSpell = "q_Argonian_ScentSpell",
...
local function registerSpells()
    framework.spells.createComplexSpell({
        id = spellIds.khajiitScentAbility,
        name = "Scent",
        magickaCost = 0,
        effects = {
            [1] = {
    ...
    framework.spells.createComplexSpell({
        id = spellIds.argonianScentAbility,
        name = "Scent",
        magickaCost = 0,
        effects = {
            [1] = {
    ...
    framework.spells.createComplexSpell({
        id = spellIds.argonianScentSpell,
        name = "Scent",
        magickaCost = 0,
        effects = {
            [1] = {

...
--[[Scrapped for one reason or another, kept for eventual unlikely changes in the future

--ARENTHI --Renamed according to Project Tamriel
this.arenthi = {
    id = "arenthi",
    name = "Arenthi",
    description = (
        "Arenthians are inhabitants of northern part Valenwood province - area around the city of Arenthia which borders Colovia and Elsweyr. Bosmers living there enjoy more cosmopolitan lifestyle than any other inhabitants of Valenwood. \n\nAdherence to Arenthi customs grants bonuses to Security, Light Armor, Speechcraft, Mercantile, Alchemy, Short Blade, Intelligence, Personality (+5) and penalties to Acrobatics, Marksman, Sneak (-10), Speed, Agility (-5) to those being faithful to their culture."
    ),
	checkDisabled = function()
        local race = tes3.player.object.race.id
...
--BORAELTH -- Renamed according to Project Tamriel
this.boraelth = {
    id = "boraelth",
    name = "Boraelth",
    description = (
        "Boraelthi are Bosmer strictly abiding by the Green Pact code. Isoliationist in temperament they often chose to live deep in Valenwood forests.\n\nAdherence to Boraelth customs grants bonuses to Acrobatics, Axe, Blunt Weapon, Heavy Armor, Medium Armor, Sneak, Agility, Strength (+5) and penalties to Mercantile, Speechcraft, Security, Long Blade, Spear, Alchemy, Personality, Intelligence (-5) to those being faithful to their culture." --Name roughly meaning coming from Hrafnir's Bor=Loyal and Aelth=Leaf. I'm aware of Project Tamriel: Anam, Tehl, Bos'hau, Hanae, Or-Thaud, but these tribes/cultures just don't work in this mod
    ),
	checkDisabled = function()
        local race = tes3.player.object.race.id
        return race ~= "Wood Elf"
...
--ARADORRMERREN -- Used word by Smitehammer with declension by Hrafnir, changed to be fully Smitehammer's
this.aradorrmerren = {
    id = "aradorrmerren",
    name = "Aradorrmerren",
    description = (
        "Ashlanders or Aradorrmeri are Dunmeri nomadic herder-hunters who reject the Tribunal and preserve the ancient customs of the Chimer. They see material wealth as purposeless. \n\nAdherence to Aradorrmerren customs grants bonuses to Marksman, Light Armor, Mysticism, Alteration, Spear, Medium Armor, Agility, Endurance (+5) and penalties to Mercantile, Speechcraft, Security, Destruction, Short Blade, Heavy Armor, Personality, Intelligence (-5) to those being faithful to their culture." --Name based on unofficial Dunmeris dictionaries by Smitehammer and Hrafnir. From Arador-Ashlands, Aradorr-of Ashlands, Aradorrmer-Ashlander, Aradorrmeri-Ashlanders, Aradorrmerren-Ashlander's;of Ashlanders
    ),
	checkDisabled = function()
        local race = tes3.player.object.race.id
        return race ~= "Dark Elf"
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "mtrCultures_Aradorrmerren"
        }
		tes3.modStatistic({
            reference = tes3.player,
            attribute = tes3.attribute.intelligence, 

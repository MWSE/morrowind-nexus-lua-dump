...
this.colovar = {
    ...
    name = "Colovar",
    description = (
        "Colovari are inhabitants of northern part of Colovia - northwestern part of Cyrodiil province. Main difference between them and Colovians is that Colovari are extremely proud of their Nordic roots and view themselves as more noble people.\n\nAdherence to Colovar customs grants bonuses to Axe, Long Blade, Heavy Armor, Medium Armor, Blunt Weapon, Speechcraft, Strength, Endurance (+5), Resist Frost (25%) and penalties to Sneak, Illusion, Conjuration, Alteration, Destruction, Security, Intelligence, Agility (-5), Weakness to Fire (25%) to those being faithful to their culture." --Project Tamriel name for Colo-Nordic culture
    ),
	checkDisabled = function()
        local race = tes3.player.object.race.id
        return race ~= "Imperial"
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "mtrCultures_Colovar"
        }
		mwscript.addSpell{
            reference = tes3.player, 
            spell = "mtrCultures_Colovar2"
        }
		tes3.addItem{
            reference = tes3.player,

...
local function cjJump(count)
    if jumping or acrobaticsDamage ~= 0 or acrobaticsModifier ~= 0 then
         ambient.playSoundFile('Sound/Fx/fall.wav')
        return
    end
...
local function onKeyPress(key)
    ...
    if self.controls.sneak then return end
...
return {
    engineHandlers = {
        ...
        onLoad = function(data)
            ...
            acrobaticsModifier = data.acrobaticsModifier
            acrobaticsDamage = data.acrobaticsDamage
        ...
        onSave = function()
            return {
                ...
                acrobaticsDamage = acrobaticsDamage,
                jumping = jumping
            }
        end

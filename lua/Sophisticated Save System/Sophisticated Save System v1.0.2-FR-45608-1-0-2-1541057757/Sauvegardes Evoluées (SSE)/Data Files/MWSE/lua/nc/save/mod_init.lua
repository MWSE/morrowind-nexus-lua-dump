...
configShowEnableDisableFeatureMenu = function(e)
	...
	tes3.messageBox({
		message = "Configuration de SOE\Activation/Désativation des fonctions",
		buttons = {
			"Chargement rapide de la dernière sauvegarde: " .. (config.loadLatestSave and "Enabled" or "Disabled"),
			"Sauvegarde toutes les " .. config.timeBetweenAutoSaves .. " Minutes: " .. (config.saveOnTimer and "Enabled" or "Disabled"),
			"Sauvegarde auto en début de combat: " .. (config.saveOnCombatStart and "Enabled" or "Disabled"),
...
configShowConfigSaveCountMenu = function(e)
	...
	-- Show menu. Delay it by one frame.
	tes3.messageBox({
		message = "Quantité à conserver: " .. (config.maxSaveCount ~= 0 and config.maxSaveCount or "All"),
		buttons = { "-", "Back", "+" },
...
configShowConfigTimerMenu = function(e)
	...
	-- Show menu. Delay it by one frame.
	tes3.messageBox({
		message = "Espacement des sauvegardes: " .. config.timeBetweenAutoSaves .. "m",
		buttons = { "-", "Back", "+" },
...
configShowConfigMinimumTimerMenu = function(e)
	...
	-- Show menu. Delay it by one frame.
	tes3.messageBox({
		message = "Délai minimum entre les sauvegardes: " .. config.minimumTimeBetweenAutoSaves .. "m",
		buttons = { "-", "Back", "+" },
...
configShowMainMenu = function(e)
	...
	tes3.messageBox({
		...
		buttons = {
			"Conditions",
			"Quantité à conserver",
			"Espacement des sauvegardes",
			"Délai minimum entre les sauvegardes",
			"Fermer ce Menu"
		},

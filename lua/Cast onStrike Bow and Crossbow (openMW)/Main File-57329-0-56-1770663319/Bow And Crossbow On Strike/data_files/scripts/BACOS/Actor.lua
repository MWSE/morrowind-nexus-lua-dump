...
I.Combat.addOnHitHandler(function(attack)
	if attack.successful==true then
		if attack.weapon and attack.weapon:isValid()==true then
...
--				print(EnchantRecord,EnchantRecord.type,core.magic.ENCHANTMENT_TYPE.CastOnUse)
				if EnchantRecord and ((BACOSSettingsG:get("OnlyOnstrikeG")==false and EnchantRecord.type==core.magic.ENCHANTMENT_TYPE.CastOnUse) or EnchantRecord.type==core.magic.ENCHANTMENT_TYPE.CastOnStrike) then

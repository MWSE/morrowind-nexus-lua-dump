local config = mwse.loadConfig("Training Manual", {
    limitMajor = true,
    limitMinor = true,
    limitMisc = true,
    majorLimit = 100,
...
local function registerConfig()
    ...
    local template = mwse.mcm.createTemplate("Training Manual")
    template:saveOnClose("Training Manual", config)
    template:register()
    ...
    local settings = page:createCategory("Training Manual Settings\n\n\n\nMajor Skills")

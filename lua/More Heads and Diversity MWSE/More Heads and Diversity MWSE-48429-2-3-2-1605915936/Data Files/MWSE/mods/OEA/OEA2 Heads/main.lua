...
local function IntoExistence(e)
	...
	if (e.reference.baseObject.race.sourceMod ~= "Morrowind.esm") and (e.reference.baseObject.race.sourceMod ~= "Bloodmoon.esm") and (e.reference.baseObject.race.sourceMod ~= "Tribunal.esm") then
		return
	end

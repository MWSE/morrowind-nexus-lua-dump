...
local function registerMCM()
    ...
    page:createYesNoButton{
        ...
        description = "Добавляет подсказки к рыбам с их описанием. Требуется мод Tooltips Complete.",
        variable = mwse.mcm.createTableVariable{ id = "enableFishTooltips", table = config.mcm },
        restartRequired = true,
    }

    page:createYesNoButton{
        label = "Включить динамическую камеру",
        description = "Включает динамическую камеру во время рыбной ловли.",

...
local KillXPSource = category:createSlider({
	label = i18n('mcmKillXPSourceLabel'),
	description = i18n('mcmKillXPSourceDes'),
	min = 0,
	max = 3,
	step = 1,
	jump = 1,
	variable = mwse.mcm.createTableVariable{id = 'KillXPSource', table = config},
})

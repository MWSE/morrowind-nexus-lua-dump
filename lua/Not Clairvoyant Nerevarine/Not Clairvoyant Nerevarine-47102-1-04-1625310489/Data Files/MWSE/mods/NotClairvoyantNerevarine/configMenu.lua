...
local function RegisterModConfig()
	...
	-- tes3.messageBox('RegisterModConfig language %s', language);
	-- mwse.log('RegisterModConfig language %s', language);
	-- sLang = GetLanguage();
	sLang = tes3.getLanguage();
	this.sLang = sLang;
...
function modConfigMenu.onCreate(container)
    ...
    local header = pane:createLabel{ text = 'version 1.04' };

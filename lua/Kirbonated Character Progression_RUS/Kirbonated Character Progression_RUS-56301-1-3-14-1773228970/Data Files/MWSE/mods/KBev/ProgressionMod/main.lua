...
local function onDeath(e)
	...
	elseif mcm.enemyXPEnabled and (e.reference.baseObject.objectType == tes3.objectType.creature or e.reference.baseObject.objectType == tes3.objectType.npc) then

    ...
    settings = {
        {
            ...
            description = "(If turning off, make sure your queue is empty)",
            renderer = "checkbox",
            default  = true,
        },
        {
        ...
        },
        {
            ...
            description = "Requires Popup Side set to 2 (Right). 1:TL, 2:TR, 3:BL, 4:BR",
            renderer = "number",
            default  = 1,

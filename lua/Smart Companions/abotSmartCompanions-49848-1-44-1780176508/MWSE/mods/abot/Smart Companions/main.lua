...
function L.timedTravelProcess()
	...
	if ab01boDest then
		...
		if logLevel2 then
			mwse.log('%s: ab01boDest = %s, boDestValue = %s', funcPrefix, ab01boDest, boDestValue)
		end
	end
	local ssDestValue = 0
	if ab01ssDest then
		...
		if logLevel2 then
			mwse.log('%s: ab01ssDest = %s, ssDestValue = %s', funcPrefix, ab01ssDest, ssDestValue)
		end
	end
	local goDestValue = 0
	if ab01goDest then
		...
		if logLevel2 then
			mwse.log('%s: ab01goDest = %s, goDestValue = %s', funcPrefix, ab01goDest, goDestValue)
		end
	end

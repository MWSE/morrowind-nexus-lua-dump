...
autoAttack = 0, -- 0. No - 1. Yes, Only current companions - 2. Yes, Any follower
...
local warpLevSpell, waterWalkSpell -- created in modConfigReady()
...
[["More %s. Could I keep some for myself?"]],
[["%s. I like that."]],
}
...
local function checkStartAutoAttack()
	-- should really replace diligent defenders
...
local function modConfigReady()
	...
	warpLevSpell = tes3.createObject({objectType = tes3.objectType.spell,
		id = 'ab01smcoLevitate',
		name = 'Warping',
		castType = tes3.spellType.curse, -- curses are less sticky
		alwaysSucceeds = true,
		sourceLess = true,
		effects = {{id = tes3_effect_levitate, min = 400, max = 400}}
	})

	waterWalkSpell = tes3.createObject({objectType = tes3.objectType.spell,
		id = 'ab01smcoWaterwalking',
		name = 'Water Walking',
		castType = tes3.spellType.curse,
		alwaysSucceeds = true,
		sourceLess = true,
		effects = {{id = tes3_effect_waterWalking, min = 1, max = 1}}
	})

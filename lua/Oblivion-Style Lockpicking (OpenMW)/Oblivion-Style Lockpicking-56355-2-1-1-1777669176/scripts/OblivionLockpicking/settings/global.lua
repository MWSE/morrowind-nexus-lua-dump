...
I.Settings.registerGroup {
    ...
    settings = {
        ...
        {
            key = 's_SkillAffectsChance',
            renderer = 'select',
            name = 'SkillAffectsChance',
            description = 'SkillAffectsChanceDesc',
            default = 'SkillChecks_Automatic',
            argument = {
                l10n = 'OblivionLockpicking',
                items = {
                    'SkillChecks_Disabled',
                    'SkillChecks_Automatic',
                    'SkillChecks_Hardcore',
                }
            },
        },
        {
        ...
        {
            key = 'b_UseIntelligence',
            renderer = 'checkbox',
            name = 'UseIntelligence',
            description = 'UseIntelligenceDesc',
            default = false,
        }
    },
}
I.Settings.registerGroup {
    ...
    settings = {
        ...
        {
            key = 'n_SkillCheckAttemptInterval',
            renderer = 'number',
            name = 'SkillCheckAttemptInterval',
            description = 'SkillCheckAttemptIntervalDesc',
            default = 0.5,
            argument = {
                min = 0.1,
                max = 1.0,

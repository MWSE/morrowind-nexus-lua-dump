...
I.Settings.registerGroup {
    ...
    settings = {
        {
            key = 'b_FreePickMovement',
            renderer = 'checkbox',
            name = 'FreePickMovement',
            description = 'FreePickMovementDesc',
            default = false,
        },
        {
            key = 'b_AutoEquip',
        ...
        {
            key = 'b_DarkenBackground',
            renderer = 'checkbox',
            name = 'DarkenBackground',
            description = 'DarkenBackgroundDesc',
            default = true,
        },
        {
            key = 'f_DarkenStrength',
            renderer = 'number',
            name = 'DarkenStrength',
            default = 0.5,
            argument = {
        ...
        {
            key = 'b_BlurBackground',
            renderer = 'checkbox',
            name = 'BlurBackground',
            description = 'BlurBackgroundDesc',
            default = true,
        },
        {
            key = 'f_BlurStrength',
        ...
        {
            key = 'b_TimingWindowGlow',
            renderer = 'checkbox',
            name = 'TimingWindowGlow',
            description = 'TimingWindowGlowDesc',
            default = false,
        },
        {
            key = 'c_TimingWindowGlowColor',
            renderer = 'color',
            name = 'TimingWindowGlowColor',

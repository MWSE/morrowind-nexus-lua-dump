...
local interopLabel = page:createCategory("Interop")

interopLabel:createSlider{
    label = "Smooth Talker - Patience lost when bugging NPC",
    description = "If Persuasion limit is active, and using Smooth Talker, the NPC will lose patience from talking to an NPC who want to be left alone. This determines how much.",
    defaultSetting = defaultConfig.patienceLost_SmoothTalker,
    showDefaultSetting = true,
    max = 5,
    min = 1,
    variable = mwse.mcm.createTableVariable{
        id = "patienceLost_SmoothTalker",
        table = config
    }
}

...
local function init()
    ...
    sb_achievements.registerAchievement {
        ...
        category  = cats.main,
        condition = function()
            return tes3.getJournalIndex { id = "B1_UnifyUrshilaku" } >= 50 and tes3.getJournalIndex { id = "B2_AhemmusaSafe" } >= 50 and tes3.getJournalIndex { id = "B3_ZainabBride" } >= 50 and tes3.getJournalIndex {id = "B3_KillWarLovers"} >= 55
        end,
    ...
    sb_achievements.registerAchievement {
        ...
        condition = function()
            ...
            return tes3.getJournalIndex {id = "C0_Act_C"} >= 20 and (tes3.getJournalIndex {id = "B8_MeetVivec"} >= 50 or tes3.getJournalIndex {id = "CX_BackPath"} >= 50) and pData.gotKeening()
        end,
    ...
    sb_achievements.registerAchievement {
        ...
        category  = cats.faction,
        condition = function()
            return tes3.getFaction("East Empire Company").playerRank >= 9
        end,

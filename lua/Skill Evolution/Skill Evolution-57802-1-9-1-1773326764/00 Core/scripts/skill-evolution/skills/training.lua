...
module.onSkillTrained = function(state, skillId, skillLevel)
    ...
    if range[1] == 2 and range[2] == 2 then return end

    local timePassed = mDef.logRangeFunctions[mDef.logRangeTypes.scaledTrainingDuration](state.skills.base[skillId], range[1], range[2])

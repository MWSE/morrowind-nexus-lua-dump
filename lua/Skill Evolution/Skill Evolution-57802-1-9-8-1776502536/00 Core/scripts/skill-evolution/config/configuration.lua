...
return {
    skillUseTypes = UseTypes and {
        ...
        [Skills.armorer.id] = {
            [UseTypes.Armorer_Repair] = { key = "Repair", gain = 0.5, vanilla = 0.4 },
        },
        [Skills.athletics.id] = {
        ...
        [Skills.mercantile.id] = {
            [UseTypes.Mercantile_Success] = { key = "Success", gain = 0.35, vanilla = 0.3 },
    ...
    -- special value (interpreted as 0 by SE) when the vanilla value is 0, but we need a different value so the skill use is triggered
    skillZeroGainHack = 0.123,

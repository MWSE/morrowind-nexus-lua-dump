...
I.Settings.registerGroup {
  ...
  settings = {
    ...
    name = 'Strength Cap',
    description = 'The maximum value your Strength can be increased to.\n(Default: 100, Minimum: 100, Maximum: 999)',
    default = 100
    },
    {
    key = 'IntelligenceCap',
    ...
    description = 'The maximum value your Intelligence can be increased to.\n(Default: 100, Minimum: 100, Maximum: 999)',
    default = 100
    },
    {
    key = 'WillpowerCap',
    ...
    argument = { min = 100, max = 999 },
    name = 'Willpower Cap',
    description = 'The maximum value your Willpower can be increased to.\n(Default: 100, Minimum: 100, Maximum: 999)',
    default = 100
    },
    {
    key = 'AgilityCap',
    ...
    argument = { min = 100, max = 999 },
    name = 'Agility Cap',
    description = 'The maximum value your Agility can be increased to.\n(Default: 100, Minimum: 100, Maximum: 999)',
    default = 100
    },
    {
    key = 'SpeedCap',
    ...
    argument = { min = 100, max = 999 },
    name = 'Speed Cap',
    description = 'The maximum value your Speed can be increased to.\n(Default: 100, Minimum: 100, Maximum: 999)',
    default = 100
    },
    {
    key = 'EnduranceCap',
    ...
    argument = { min = 100, max = 999 },
    name = 'Endurance Cap',
    description = 'The maximum value your Endurance can be increased to.\n(Default: 100, Minimum: 100, Maximum: 999)',
    default = 100
    },
    {
    key = 'PersonalityCap',
    renderer = 'number',
    argument = { min = 100, max = 999 },
    name = 'Personality Cap',
    description = 'The maximum value your Personality can be increased to.\n(Default: 100, Minimum: 100, Maximum: 999)',
    default = 100
    }
  }
}
...
local function getAttributeCap(attribute)
  
  if (attribute == 'Strength') then
    return settings:get('StrengthCap')
  elseif (attribute == 'Intelligence') then
    return settings:get('IntelligenceCap')
  elseif (attribute == 'Willpower') then
    return settings:get('WillpowerCap')
  elseif (attribute == 'Agility') then
    return settings:get('AgilityCap')
  elseif (attribute == 'Speed') then
    return settings:get('SpeedCap')
  elseif (attribute == 'Endurance') then
    return settings:get('EnduranceCap')
  elseif (attribute == 'Personality') then
    return settings:get('PersonalityCap')
  else
    return 100
  end
...
local function incrementAttribute(attribute)
  ...
  --create the initial cap value, will change based on attribute
  cap = getAttributeCap(attribute)

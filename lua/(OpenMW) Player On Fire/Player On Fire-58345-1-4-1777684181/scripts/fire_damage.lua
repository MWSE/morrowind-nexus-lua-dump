...
local cachedSettings = {
    ...
    PRINT_LOG    = get('PRINT_LOG'),
    ANIMATIONS_ENABLED = get('ANIMATIONS_ENABLED'),
}
        ...
        onUpdate = function(dt)
                ...
                if fire and fire:isValid() then
                    ...
                    if math.abs(dz) < cachedSettings.BURN_HEIGHT then
                        ...
                        if hDistSq < cachedSettings.BURN_RADIUS_SQ then
                            hitFound = true
                            if cachedSettings.PRINT_LOG then
                                print("[POF P] Player burned by object: " .. tostring(fire.recordId))
                            end
                            break
                        end
                    end
            ...
            if hitFound then
                ...
                if damage > 0 then
                    ...
                    if cachedSettings.ANIMATIONS_ENABLED then

...
constants.addSWEConstants = function()
...
constants.holidayMatrix = {
    -- 01 Morning Star
    {
        ["01"] = { l10n("holiday_desc_new_life"), l10n("holiday_desc_triune"), l10n("holiday_desc_clavicus") },
    ...
    {
        ["03"] = { l10n("holiday_desc_tales_and_tallows"), l10n("holiday_desc_ancestors"), l10n("holiday_desc_nocturnal") },

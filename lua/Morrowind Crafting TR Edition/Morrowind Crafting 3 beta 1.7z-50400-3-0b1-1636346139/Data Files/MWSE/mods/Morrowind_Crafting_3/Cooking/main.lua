...
function this.createWindow()
	...
	local button_pickup = button_block:createButton{ id = "FirePickupButton", text = "Pick Up"}
...
local function mc_tool_activate(e)
	if (e.activator == tes3.player) then
		if ( e.target.object.id == "mc_logfire" ) or ( e.target.object.id == "mc_campfire" ) or ( e.target.object.id == "lm_cookstove" ) then

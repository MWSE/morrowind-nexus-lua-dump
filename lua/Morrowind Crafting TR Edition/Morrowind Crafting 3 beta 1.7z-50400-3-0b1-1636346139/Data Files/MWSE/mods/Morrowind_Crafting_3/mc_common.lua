...
function this.qtySlider(maxNumber)
	...
	local slider = pBlock:createSlider({ current = 0, min = 0, max = maxNumber, step = 1, jump = 5 })
...
function this.removeFrostSoul()
	if this.removeSoulGem("T_Dae_Cre_AtroFrCyr_01") then
	elseif this.removeSoulGem("atronach_frost") then
...
function this.removeDremoraSoul()
	...
	elseif this.removeSoulGem("T_Dae_Cre_Drem_01") then
...
function this.countFrostSouls()
	local ttl = this.countSoulGems(tes3.player.object.inventory, "T_Dae_Cre_AtroFrCyr_01") 
		+ this.countSoulGems(tes3.player.object.inventory, "atronach_frost") 
...
function this.countDremoraSouls()
	local ttl = this.countSoulGems(tes3.player.object.inventory, "dremora") 
		...
		+ this.countSoulGems(tes3.player.object.inventory, "T_Dae_Cre_Drem_01") 
...
local function onSkillReady()
	...
	{	name 			=		"Smithing", 							 	--default: skill id
		...
		description 	= 		"Skill allows you to create and salvage weapons and armor from various materials.",		--optional
...
--local function onSkillReady()
	...
	{	name 			=		"Fletching", 							 	--default: skill id
		...
		description 	= 		"Skill allows you to create weapons that involve fletching such as arrows, crossbow bolts, and thrown darts.",		--optional
...
--local function onSkillReady()
	...
	{	name 			=		"Sewing", 							 	--default: skill id
		...
		description 	= 		"Skill allows you to weave bolts of cloth, rugs and tapestries; sew clothing of cloth, animal hides and furs; create items such as pillows, sparring mats, bedrolls, bags and sacks.",		--optional
		specialization 	= 		tes3.specialization.stealth,					--optional. Icon background is gray if none set
		active			=		"active"									--defaults to "active"
		}
	)
...
--local function onSkillReady()
	...
	{	name 			=		"Crafting", 							 	--default: skill id
		...
		description 	= 		"Skill allows the creation of jewelry, glass, wickerware, lighting and even alchemical equipment.",		--optional
		specialization 	= 		tes3.specialization.stealth,					--optional. Icon background is gray if none set
		active			=		"active"									--defaults to "active"
		}
	)
...
--local function onSkillReady()
	...
	{	name 			=		"Metalworking", 							 	--default: skill id
		...
		description 	= 		"Skill allows the making of metal-based lights, furniture, chests, barrels and other metallic items.",						--optional
...
--local function onSkillReady()
	...
	{	name 			=		"Masonry", 							 	--default: skill id
		...
		attribute 		=		tes3.attribute.strength,					--optional
		description 	= 		"Skill gives you the ability to use clay, stone and other materials to create urns, culdems, bowls and other clay items.",						--optional
		specialization 	= 		tes3.specialization.combat,					--optional. Icon background is gray if none set
		active			=		"active"									--defaults to "active"
		}
	)
...
--local function onSkillReady()
	...
	{	name 			=		"Mining", 							 	--default: skill id
		...
		description 	= 		"Skill gives you the ability to mine ores and minerals from particular rocks and crystals, mostly found underground.",						--optional
		specialization 	= 		tes3.specialization.combat,					--optional. Icon background is gray if none set
		active			=		"active"									--defaults to "active"
		}
	)
...
--local function onSkillReady()
	...
	{	name 			=		"Woodworking", 							 	--default: skill id
		...
		attribute 		=		tes3.attribute.intelligence,					--optional
		description 	= 		"Skill gives you the ability to build or carve various types of wooden furniture, containers, or decorations.",						--optional
		specialization 	= 		tes3.specialization.magic,					--optional. Icon background is gray if none set
		active			=		"active"									--defaults to "active"
		}
	)
...
--local function onSkillReady()
	...
	{	name 			=		"Cooking", 							 	--default: skill id
		...
		attribute 		=		tes3.attribute.personality,					--optional
		description 	= 		"Skill gives you the ability to turn raw materials into delicious dishes, soups, breads and desserts, brew beverages, and prepare various medicines and toxins.",						--optional
		specialization 	= 		tes3.specialization.magic,					--optional. Icon background is gray if none set
		active			=		"active"									--defaults to "active"
		}
	)

...
makerlist = {
	...
	ingreds = {
		{id = "mc_sand", count = 20},
		{id = "ingred_kwama_cuttle_01", count = 2}
		},
	yieldCount = 1,
	difficulty = 45,
	group = "Glassware",
	...
	ingreds = {
		{ id = "mc_sand", count = 1 },
		{ id = "food_kwama_egg_01", count = 2 },
		{ id = "Magicka", count = 15 }
		},
	unlock = { id = "mc_soulgem_success", index = 1 },
	yieldCount = 2,
	difficulty = 25,
	group = "Miscellaneous",
	taskTime = 0.5
	...
	{id = "Misc_SoulGem_Lesser",
	ingreds = {
		{ id = "mc_sand", count = 1 },
		{ id = "food_kwama_egg_01", count = 1 },
		{ id = "Magicka", count = 15 }
		},
	unlock = { id = "mc_soulgem_success", index = 2 },
	yieldCount = 1,
	difficulty = 50,
	group = "Miscellaneous",
	taskTime = 0.5
	...
	{id = "Misc_SoulGem_Common",
	ingreds = {
		{ id = "mc_sand", count = 2 },
		{ id = "food_kwama_egg_01", count = 1 },
		{ id = "Magicka", count = 30 }
		},
	unlock = { id = "mc_soulgem_success", index = 3 },
	yieldCount = 1,
	difficulty = 75,
	group = "Miscellaneous",
	taskTime = 0.5
	...
	{id = "Misc_SoulGem_Greater",
	ingreds = {
		{ id = "mc_sand", count = 3 },
		{ id = "food_kwama_egg_01", count = 1 },
		{ id = "Magicka", count = 45 }
		},
	unlock = { id = "mc_soulgem_success", index = 4 },
	yieldCount = 1,
	difficulty = 100,
	group = "Miscellaneous",
	taskTime = 0.5
	...
	ingreds = {
		{ id = "mc_sand", count = 4 },
		{ id = "food_kwama_egg_01", count = 1 },
		{ id = "Magicka", count = 150 }
		},
	unlock = { id = "mc_soulgem_success", index = 5 },
	yieldCount = 1,
	difficulty = 125,
	group = "Miscellaneous",
	taskTime = 0.5

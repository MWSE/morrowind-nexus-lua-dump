...
local function onSpellCast(e)
    ...
    for _, stack in pairs(tes3.player.object.equipment) do
        ...
        then table.insert(equippedR, stack)
        end
    end
    ...
    if equippedR[1] and equippedR[1].itemData and equippedR[1].object.enchantment and equippedR[1].object.enchantment.castType == 2 then
        chargeR1 = equippedR[1].itemData.charge
    end
    if equippedR[2] and equippedR[2].itemData and equippedR[2].object.enchantment and equippedR[2].object.enchantment.castType == 2 then
        chargeR2 = equippedR[2].itemData.charge
    end

    if equippedR[3] and equippedR[3].itemData and equippedR[3].object.enchantment and equippedR[3].object.enchantment.castType == 2 then
...
local function onMobileActivated(e)
    ...
    if not (e.mobile.object:offersService(tes3.merchantService.spells)) then
        return
    end

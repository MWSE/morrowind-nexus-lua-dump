...
function list.damage(type, target)
    ...
    elseif type == tes3.physicalAttackType.chop then
        if (mod.gougeEyes == 2) then
            local activpart = target.bodyPartManager:getActiveBodyPart(tes3.activeBodyPartLayer.base, tes3.activeBodyPart.head)
...
Sequence: Thrust, Chop, Thrust
Description: Causes large damage and drains extra fatigue.]],
    gougeEyes = [[Gouge Eyes
Sequence: Slash, Slash, Chop
Description: Blinds the opponent and does extra damage.]],
    uppercut = [[Uppercut
Sequence: Slash, Slash, Thrust, Chop
Description: Knocks the opponent backwards and down and does extra damage.]],
    stun = [[Stun
Sequence: Thrust, Chop, Chop, Thrust
Description: Temporarily paralyzes the enemy and does extra damage.]],
    snapNeck = [[Snap Neck
Sequence: Chop, Chop, Slash, Slash, Thrust
Description: Finishing move that breaks the opponent's neck.]]
}

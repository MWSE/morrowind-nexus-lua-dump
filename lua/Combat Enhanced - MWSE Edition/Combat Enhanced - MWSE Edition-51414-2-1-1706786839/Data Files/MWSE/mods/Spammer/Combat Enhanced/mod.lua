...
function mod.onSkillRaised(e)
    local list = { [tes3.skill.bluntWeapon] = blunt, [tes3.skill.axe] = axe, [tes3.skill.longBlade] = sword, [tes3.skill.shortBlade] = dagger, [tes3.skill.spear] = lance, [tes3.skill.handToHand] = box }

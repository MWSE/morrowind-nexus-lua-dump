...
function list.damage(type, target)
    ...
    elseif type == tes3.physicalAttackType.chop then
        ...
        if mod.frenzy == 3 then
            mod.frenzy = 0
            local equippedArmor = tes3.getEquippedItem({
                actor = target,
        ...
        elseif mod.frenzy > 0 then
            mod.frenzy = mod.frenzy + 1
        end
    elseif type == tes3.physicalAttackType.slash then
        ...
        elseif mod.spin == 2 then
            mod.spin = mod.spin + 1
        else
            mod.spin = 0
        end
        if mod.behead < 3 then
            mod.behead = 0
        elseif mod.behead == 3 then
            mod.behead = mod.behead + 1
        else
            mod.behead = 0
...
list.def = {
    hack = [[Hack
Chop, Slash, Chop
Quick blows to tire out the opponent and make their attack slower.]],
    cleave = [[Cleave
Slash, Chop, Slash
High damage attack that can knock out the enemy.]],
    spin = [[Shield Break
Chop, Thrust, Slash, Slash
Breaks your enemy's shield.]],
    frenzy = [[Frenzy
Slash, Chop, Chop, Chop
Damages the enemy's Cuirass.]],
    behead = [[Behead
Thrust, Chop, Chop, Slash, Slash

    ...
    engineHandlers = {
        onActivate = function(object, actor)
          if actor.recordId == 'player' and object.type == types.NPC then
            core.sendGlobalEvent('Rss_SetActiveTravelData', { tData = travelData[object.recordId] } )
            world.players[1]:sendEvent('Rss_SetActiveTravelData', { tData = travelData[object.recordId] } )
          end
        end,
        onPlayerAdded = function (player) 
          ...
          world.players[1]:sendEvent('Rss_GetListOfTravelActors', { list = travelActorsList } )
        end
    },
    eventHandlers = { 

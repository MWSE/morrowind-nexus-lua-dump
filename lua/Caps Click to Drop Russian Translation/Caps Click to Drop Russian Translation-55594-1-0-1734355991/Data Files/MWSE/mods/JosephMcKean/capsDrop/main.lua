...
local function registerModConfig()
	local template = mwse.mcm.createTemplate("Горячая клавиша \"Выбросить из инвентаря\"")
	...
	settings:createKeyBinder{
		label = "Назначить горячую клавишу \"Выбросить из инвентаря\" (По умолчанию: Caps Lock)",

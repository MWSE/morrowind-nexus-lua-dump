...
addCustomCellData(SAFETY_CELL, 2, KRL_Vector(-2953, 1155, 2515), KRL_Angle(0, 90))
...
addCustomCellData(LIBRARY_CELL, 3, KRL_Vector(4097, 2648, 15104), KRL_Angle(0, 0))
...
addCustomCellData(FATH_CELL, 4, KRL_Vector(4, -104, -68), KRL_Angle(0, 0))
...
addCustomCellData(CAFE_CELL, 5, KRL_Vector(386, 22, 1), KRL_Angle(0, 180))
...
addCustomCellData(IMPOSTERS_CELL, 6, KRL_Vector(-130, 324, 209), KRL_Angle(0, 0))
...
addCustomCellData(SURPRISE_CELL, 7, KRL_Vector(997, -1026, 128), KRL_Angle(0, 90))
...
addCustomCellData(STORY_CELLS, 8, KRL_Vector(-109622, 146967, 296), KRL_Angle(0, 180))
...
addCustomCellData(LOOSE_CELL, 10, KRL_Vector(3691, 4447, 13346), KRL_Angle(0, 0))

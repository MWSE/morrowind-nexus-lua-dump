...
setupScriptedObject("krl_crank_rearrange", function(pid, cellName, object)
    if Players[pid].data.customVariables.pulledRearrangeCrank then
        tes3mp.MessageBox(pid, -1, "You already randomized your skills.")
        return
    end

    KRL_RandomizeSkills(pid)

    Players[pid].data.customVariables.pulledRearrangeCrank = true

    tes3mp.MessageBox(pid, -1, "Your skills have been randomized.")

    KRL_KickFromGameGui(pid)
end)

...
config.gameMode = "Kazooie Rogue Like"
...
config.instancedSpawn = {
    cellDescription = "Kazooie, Start",
    position = {1130.3388671875, -387.14947509766, 193},
    rotation = {0.04, 1.55},
    text = "Welcome to Kazooie's Rogueish Adventure! Please read the book on the table!",
...
config.defaultRespawn = {
    cellDescription = "Kazooie, Death",
    position = {4978, 4171, 14270},
...
config.allowSuicideCommand = false

-- Whether players should be allowed to use the /fixme command
config.allowFixmeCommand = false
...
config.disallowedNameStrings = {"faggot", "gas the ", "Hitler", "nigga", "nigger"}

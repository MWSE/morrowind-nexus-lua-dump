...
local function updatePendingThrow(data)
    ...
    runtimeSection:set('pendingPerksEnabled', data.perksEnabled)
    runtimeSection:set('pendingCriticalEnabled', data.criticalEnabled)
    runtimeSection:set('pendingTwinFlightEnabled', data.twinFlightEnabled)
    runtimeSection:set('pendingBleedEnabled', data.bleedEnabled)
    runtimeSection:set('pendingParalyzeEnabled', data.paralyzeEnabled)
end
...
local function clearPendingThrow()
    ...
    runtimeSection:set('pendingPerksEnabled', nil)
    runtimeSection:set('pendingCriticalEnabled', nil)
    runtimeSection:set('pendingTwinFlightEnabled', nil)
    runtimeSection:set('pendingBleedEnabled', nil)
    runtimeSection:set('pendingParalyzeEnabled', nil)
end
...
local function updateRuntimeSettings(data)
    ...
    runtimeSection:set('perksEnabled', data.perksEnabled)

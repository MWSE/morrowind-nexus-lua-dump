...
if not H[r] and not BList[bid] and (m.actorType == 1 and m.flee < 70 and (cf.vamp or not r.baseObject.head.vampiric) or ((ob.biped or ob.type ~= 0 or ob.usesEquipment) and not Summon[bid]))

...
function sounds.addSound(id, filename)
    ...
    -- local existingSound = tes3.getObject(id)
    -- if existingSound and existingSound.objectType == tes3.objectType.sound then
    --     -- The sound is already registered, skip adding it again
    --     mwse.log("[bsSounds] : %s is already registered", id)
    --     return
    -- end
    ...
    -- mwse.log("---------------------------------SOUNDS--------------------------------")
    -- mwse.log("[bsSounds] : Creating sound with id - %s", id)
    -- mwse.log("[bsSounds] : getObject after creation - %s", tes3.getObject(id))

    -- if sound then
    --     mwse.log("[bsSounds] : %s registered", sound.id)
    -- else
    --     mwse.log("[bsSounds] : %s FAILED TO REGISTER", id)
    -- end
end

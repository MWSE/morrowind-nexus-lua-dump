...
I.Settings.registerGroup {
    ...
    settings = {
        {
            key         = 'SHOW_ENEMY_BAR',
            name        = 'show_enemy_bar_name',
            description = 'show_enemy_bar_desc',
            renderer    = 'checkbox',
            default     = DEFAULTS.SHOW_ENEMY_BAR,
        },
        {
        ...
        {
            key         = 'SCALE_PLAYER_BARS',
            name        = 'scale_player_bars_name',
            description = 'scale_player_bars_desc',
            renderer    = 'checkbox',
            default     = DEFAULTS.SCALE_PLAYER_BARS,
        },
    }
}

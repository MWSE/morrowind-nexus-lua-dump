...
local settingsTemplate = {
    ...
    settings = {
        ...
        },
        {
            ...
            description = "After a tome is converted, multiplier to increase chance of getting another.",
            renderer = RENDERER_SLIDER,
            default = 0.7,
        ...
        },
        {
            ...
            renderer = RENDERER_SLIDER,
            default = 50,
            argument = { min = 0, max = 1000, step = 5, default = 50, showDefaultMark = true, showResetButton = false, width = 150, thickness = 15, bottomRow = true, unit = "%", },
        },
        {
            key = "MAX_CAST_CHANCE",
            ...
            renderer = RENDERER_SLIDER,
            default = 200,
            argument = { min = 0, max = 1000, step = 5, default = 200, showDefaultMark = true, showResetButton = false, width = 150, thickness = 15, bottomRow = true, unit = "%", },
        },
        {
...
-- add new settings page here eventually    
        {
            key = "INSIGHT_MULT",
            name = "Insight Effect",

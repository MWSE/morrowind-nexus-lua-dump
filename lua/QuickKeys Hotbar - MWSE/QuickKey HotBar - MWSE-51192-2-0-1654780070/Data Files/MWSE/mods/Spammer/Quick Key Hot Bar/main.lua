...
local function registerModConfig()
    ...
    if tes3.isLuaModActive("Virnetch\\HotKeys") then
        local page2 = template:createSideBarPage({label="HotKeys Extended Compatibilty"})
        page2.sidebar:createInfo{ text = "Welcome to \""..mod.name.."\" Configuration Menu. \n \n \n A mod by Spammer."}
    ...
    category:createOnOffButton{label = "Compatibility On/Off", description = "Switch between compatibility mode and normal mode.", variable = mwse.mcm.createTableVariable{id = "onOff", table = cf}}

    category:createKeyBinder{label = "Next Bar", description = " ", allowCombinations = false, variable = mwse.mcm.createTableVariable{id = "keyN", table = cf, restartRequired = false, defaultSetting = {keyCode = tes3.scanCode.keyRight, isShiftDown = false, isAltDown = false, isControlDown = false}}}
    category:createKeyBinder{label = "Previous Bar", description = " ", allowCombinations = false, variable = mwse.mcm.createTableVariable{id = "keyP", table = cf, restartRequired = false, defaultSetting = {keyCode = tes3.scanCode.keyLeft, isShiftDown = false, isAltDown = false, isControlDown = false}}}
    end

...
local function exerciseSkill(amount)
    I.SkillProgression.skillUsed("alteration", I.SkillProgression.SKILL_USE_TYPES.Acrobatics_Jump, amount)
end
...
if not types.Actor.activeEffects or not ambLoaded then --Don't run the mod if we are not running the up to date version of the game

...
-- CHECA OS skillups ARMAZENADOS QUE FOREM MENORES E SOBRESCREVE COM OS MAIORES
local function setGreater()

    for i=1, 8, 1 do
        if tes3.getGlobal(getGlobalName(i)) < tes3.mobilePlayer.levelupsPerAttribute[i] then
            tes3.setGlobal(tes3.getGlobal(getGlobalName(i)), tes3.mobilePlayer.levelupsPerAttribute[i])
            print("Setting " .. tes3.getGlobalName(i) .. " to " .. tes3.mobilePlayer.levelupsPerAttribute[i])
        elseif tes3.getGlobal(getGlobalName(i)) == tes3.mobilePlayer.levelupsPerAttribute[i] then
            print("tes3.mobilePlayer.levelupsPerAttribute[" .. i .. "] == " .. tes3.getGlobal(getGlobalName(i)))
        else
            tes3.mobilePlayer.levelupsPerAttribute[i] = tes3.getGlobal(getGlobalName(i))
            print("Setting tes3.mobilePlayer.levelupsPerAttribute[" .. i .. "] " .. " to " .. tes3.getGlobal(getGlobalName(i)))
        end
    end
...
local function registerModConfig()
    ...
    category:createButton({
     ...
     category:createButton({
        buttonText = "Print Globals",
        description = "",
        callback = function(self)
            print("Globals values: ")
            for i=1, 8, 1 do
                tes3ui.logToConsole(getGlobalName(i) .. '\t\t' .. tes3.getGlobal(getGlobalName(i)))
                print(getGlobalName(i) .. '\t\t' .. tes3.getGlobal(getGlobalName(i)))
            end
        end
    })

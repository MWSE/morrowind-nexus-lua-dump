local defaultConfig = {
    ...
    cell_whitelist = { -- Cells named like tombs, but aren't really tombs.
        "Llarethi Ancestral Tomb, Secret Hideout", -- Tamriel Rebuilt
        "Sotha Sil, Othran Ancestral Tomb", -- Sotha Sil Expanded
        "Sotha Sil, Arendu Ancestral Tomb"
    }
}

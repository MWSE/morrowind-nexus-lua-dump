...
local function onActivate(object,actor)
  ...
  print(types.NPC.record(object).class)
  if types.NPC.record(object).class == "mage service" or types.NPC.record(object).class == "Spellsword" then
    if types.NPC.record(object).servicesOffered.Spellmaking == false then return end
    types.Actor.spells(object):add("spellsword_frost")
    types.Actor.spells(object):add("spellsword_fire")
    types.Actor.spells(object):add("spellsword_shock")
  end

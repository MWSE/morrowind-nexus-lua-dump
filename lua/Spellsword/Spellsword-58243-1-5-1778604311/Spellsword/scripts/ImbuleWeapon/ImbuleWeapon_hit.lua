...
local function applyVfx(effects)
  local trigger = "spellsword_effect"
...
--      print("Hit sound:",hitSound)
      if hitSound == "" or hitSound == nil then
...
--    print("Slash-fire combo")
    ...
    if buffDamage == nil then return damage end
...
--            print("LOWEST SKILL:",lowestSkillname)

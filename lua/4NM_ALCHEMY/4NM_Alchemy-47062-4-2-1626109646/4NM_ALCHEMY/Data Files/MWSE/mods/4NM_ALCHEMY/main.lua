...
local Curint, Curluck, Curalch, Flag
local function onUiActivated(e)
	...
	if mode then for i, ef in pairs(tes3.dataHandler.nonDynamicData.magicEffects) do ef.isHarmful = not ef.isHarmful end	Flag = true end

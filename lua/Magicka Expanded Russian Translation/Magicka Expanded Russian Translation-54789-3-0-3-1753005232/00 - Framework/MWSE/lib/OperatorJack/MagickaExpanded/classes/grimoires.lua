...
local function tryLearningSpells(grimoire)
    ...
    if (hasMagicka) then
        ...
        tes3.messageBox(
            "Изучая гримуар и практикуя описанные в нем заклинания, вы чувствуете, как новые заклинания проникают в ваш разум.")
    else
        tes3.modStatistic({
            reference = tes3.mobilePlayer,
            name = "magicka",
        ...
        tes3.messageBox(
            "Изучая гримуар, вы обнаружили, что у вас недостаточно магии, чтобы практиковать описанные в нем заклинания и выучить их.")
    end
...
local function onBookGetText(e)
    ...
    if (newSpell) then
        ...
        tes3.messageBox("Вы пытаетесь прочитать гримуар, не можете узнать ничего нового.")
    end
end

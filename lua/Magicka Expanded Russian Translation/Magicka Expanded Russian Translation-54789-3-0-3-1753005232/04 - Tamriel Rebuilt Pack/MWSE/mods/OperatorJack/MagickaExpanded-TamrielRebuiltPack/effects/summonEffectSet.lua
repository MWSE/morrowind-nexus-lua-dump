...
framework.effects.conjuration.createBasicSummoningEffect({
    ...
    name = "Вызов бронированного центуриона-героя",
    description = getDescription("бронированного центуриона-героя"),
    baseCost = 50,
...
framework.effects.conjuration.createBasicSummoningEffect({
    ...
    name = "Вызов Равнинного страйдера",
    description = getDescription("Равнинного страйдера"),
    baseCost = 40,
...
framework.effects.conjuration.createBasicSummoningEffect({
    ...
    name = "Вызов Велка",
    description = getDescription("Велка"),
    baseCost = 15,

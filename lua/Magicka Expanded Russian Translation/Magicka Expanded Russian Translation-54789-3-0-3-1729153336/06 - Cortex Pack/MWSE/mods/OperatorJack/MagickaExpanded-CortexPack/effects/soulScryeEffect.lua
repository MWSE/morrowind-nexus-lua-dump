...
framework.effects.mysticism.createBasicEffect({
    ...
    name = "Виденье души",
    description = "В активном состоянии позволяет заклинателю видеть навыки и состояние цели.",
...
local function createSoulScryeUi(reference, tooltip)
    ...
    local label = container:createLabel({text = "Виденье души"})
    ...
    level:createLabel({text = "Уровень: " .. reference.object.level})

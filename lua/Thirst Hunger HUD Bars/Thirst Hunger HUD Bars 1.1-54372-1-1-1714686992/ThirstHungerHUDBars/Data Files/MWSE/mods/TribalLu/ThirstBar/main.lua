local mod = {
    ...
    ver = "1.0",
    author = "TribalLu",
    cf = {onOff = true, slider = 1, sliderpercent = 945, switch = true, Xwidth = 65, Xheight = 14}
            }
...
local function createFillbar(element)
    ...
    --block.absolutePosAlignY = 945/1000
...
local function createMenuMultiBloodFillbar(e)
    ...
    menuThirstBar = createFillbar(menuMultiFillbarsBlock)
end
...
local function registerModConfig()
    ...
    subcat:createSlider{label = "Vertical", description = "Change the bars position vertically. [Default: 945]", min = 0, max = 1000, step = 1, jump = 100, variable = mwse.mcm.createTableVariable{id = "sliderpercent", table = cf}}

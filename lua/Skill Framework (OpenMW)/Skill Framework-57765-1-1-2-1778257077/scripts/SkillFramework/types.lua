...
--- @field modIntegration SkillIntegrationProps properties for compatibility with other mods
...
--- @class SkillIntegrationProps
--- @field statsWindow SkillStatsWindowProps properties for Stats Window Extender integration

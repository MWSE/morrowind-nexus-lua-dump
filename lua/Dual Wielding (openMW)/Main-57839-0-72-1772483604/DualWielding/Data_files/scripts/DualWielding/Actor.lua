...
----------------
	if attack.weapon and attack.weapon~=types.Actor.getEquipment(attack.attacker)[types.Actor.EQUIPMENT_SLOT.CarriedRight] and attack.weapon:isValid()==true then

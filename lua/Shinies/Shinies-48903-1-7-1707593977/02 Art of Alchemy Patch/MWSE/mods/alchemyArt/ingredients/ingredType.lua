...
ingredType.insoluble = { -- stones, ores, gems, metals - solid ingredients that can't be consumed or used in potions before grinding
    ...
    ingred_rune_R_01 = true,
    ingred_rune_f_01 = true,
    ingred_rune_Y_01 = true,
    ingred_rune_a_01 = true,
    ingred_rune_B_01 = true,
    ingred_rune_E_01 = true,
    ingred_rune_h_01 = true,
    ingred_rune_P_01 = true,
    ingred_rune_M_01 = true,
    ingred_rune_S_01 = true,
    ingred_rune_V_01 = true,
    ingred_rune_Z_01 = true,
    ingred_rune_C_01 = true,
    ingred_rune_d_01 = true,
    ingred_rune_g_01 = true,
    ingred_rune_i_01 = true,
    ingred_rune_j_01 = true,
    ingred_rune_k_01 = true,
    ingred_rune_l_01 = true,
    ingred_rune_n_01 = true,
    ingred_rune_o_01 = true,
    ingred_rune_q_01 = true,
    ingred_rune_t_01 = true,
    ingred_rune_u_01 = true,
    ingred_rune_w_01 = true,
    ingred_rune_x_01 = true,
    MG_Agate1 = true,
    MG_Aventurine1 = true,
    MG_Azurite = true,
    MG_Carnelian1 = true,
    ...
    MG_Haematite = true,
    MG_Olivine = true,
    ingred_raw_glass_red = true,
    ingred_raw_glass_orange = true,
    ingred_raw_glass_yellow = true,
    ingred_raw_glass_cyan = true,
    ingred_raw_glass_white = true,
    ingred_raw_glass_magenta = true,
    ingred_raw_glass_blue = true,
    MG_Tiger3 = true,
    MG_Tiger2 = true,
    MG_Tiger1 = true,
    MG_Lazurite1 = true,

...
--thank you lord and saviour Kirbonated for the bug report for my shitty mod on your lovely framework :)
    perks.magicMaster = perkFramework.createPerk({
        id = "hat_magicmaster",
        name = "Magic Master",
        lvlReq = 19, --19 instead of 20 because the framwork seems to not take in skills updated mid levelup for customReq, so if i set it 1 lower, people who aim for the perk at level 19 will have access to it at the intended level 20
        customReq = function() 
            return (
                (tes3.mobilePlayer.conjuration.base >= 100) 
                or (tes3.mobilePlayer.destruction.base >= 100) 
                or (tes3.mobilePlayer.alteration.base >= 100) 
                or (tes3.mobilePlayer.mysticism.base >= 100) 
                or (tes3.mobilePlayer.restoration.base >= 100) 
                or (tes3.mobilePlayer.illusion.base >= 100)) 
            end,

...
local function initCoins()
    ...
    common.septimCopper.name = "Septim (Gold)"
    common.septimPaper0010 = tes3.getObject("AB_Misc_CoinTriune")
    common.septimPaper0020 = tes3.getObject("AB_Misc_CoinDram001")
    common.septimPaper0050 = tes3.getObject("misc_dwrv_coin00")
    common.septimPaper0100 = tes3.getObject("AB_Misc_CoinTriune10")
...
local function initOnLoad()
    ...
    common.bankers = {
        ...
        "Constans Atrius",
	"segunivus mantedius",
	"IEO_augustus_severinus",
	"luce_cyn_nolus_atrius",
    }

...
I.Settings.registerRenderer(D.renderers.number, function(value, set, argument)
...
local npcLevel = 10
I.Settings.registerRenderer(D.renderers.scalingPercent, function(value, set, argument)
    local currPercent = D.difficultyPercent(value, argument.playerLevel)

...
local function computeStats(player)
    ...
    newSpeechcraft = math.min(newSpeechcraft, T.Player.stats.skills.speechcraft(player).base + S.globalStorage:get("maxSpeechcraftDifference"))

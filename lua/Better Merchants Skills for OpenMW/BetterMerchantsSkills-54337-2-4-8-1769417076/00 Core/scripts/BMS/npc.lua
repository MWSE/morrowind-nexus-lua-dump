...
local function getNewMods(kind)
    ...
    -- Set skill mods
    local npcMercMod = mods.npc.mercantile + npcSkillModDiff
    local pcMercMod = mods.pc.mercantile + pcSkillModDiff
    if state.isMinPrice then
        npcMercMod = math.floor(npcMercMod)
        pcMercMod = math.ceil(pcMercMod)
    elseif state.isMaxPrice then
        npcMercMod = math.ceil(npcMercMod)
        pcMercMod = math.floor(pcMercMod)
    else
        npcMercMod = util.round(npcMercMod)
        pcMercMod = util.round(pcMercMod)
    end
    newMods.npc[Skills.mercantile.id] = npcMercMod
    newMods.pc[Skills.mercantile.id] = pcMercMod

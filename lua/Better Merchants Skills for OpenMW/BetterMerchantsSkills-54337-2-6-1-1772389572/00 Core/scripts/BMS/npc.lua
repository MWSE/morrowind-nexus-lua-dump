...
local function computeStats()
    ...
    state.skills.mercantile = {
        [mC.buffType.service] = math.floor(baseServiceSkills),
        [mC.buffType.barter] = math.floor(barterMercantile),
        [mC.buffType.haggling] = math.floor(baseHagglingSkills),
        [mC.buffType.persuasion] = math.floor(basePersuasionSkills),
    }

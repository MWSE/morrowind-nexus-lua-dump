...
module.supportedUiModes = {
    Dialogue = module.buffType.persuasion,
    Barter = module.buffType.barter,
    SpellCreation = module.buffType.service,
    Enchanting = module.buffType.service,
    MerchantRepair = module.buffType.service,
    SpellBuying = module.buffType.service,
    Training = module.buffType.service,
    Travel = module.buffType.service,
}

...
fpDuration = 180, -- duration of footprints in real time seconds.
...
--[[local function updateSimulationClock()
...
local function checkStartfpTimer()
	...
	local dur = math.remap(fpDuration, 60, 240, 1, 3) - (0.1 * math.random())
	if logLevel2 then

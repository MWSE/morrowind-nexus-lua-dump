    ...
    if e.firingWeapon.type == (tes3.weaponType.marksmanBow or tes3.weaponType.marksmanCrossbow) then
        ...
        if weapEnchant.castType == tes3.enchantmentType.onStrike or tes3.enchantmentType.onUse then
            ...
            if equippedBow then
                ...
                enchantCostBow = tes3.calculateChargeUse({ enchant = e.firingWeapon.enchantment, mobile = e.firingReference.mobile })
            ...
            if equippedXbow then
                ...
                enchantCostXbow = tes3.calculateChargeUse({ enchant = e.firingWeapon.enchantment, mobile = e.firingReference.mobile })

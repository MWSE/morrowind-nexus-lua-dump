...
local heights = {
	...
	["am_eater.nif"] = { 45, keys={"idle2"}, focal=util.vector3(0, 25, 40) },	--headpos 52
	["am_fishman.nif"] = { 45, keys={"idle2", "idle3", "idle"} },
	["am_luteplaying.nif"] = { 45, keys={"idle2", "idle"}, focal=util.vector3(0, 0, 44) },	--headpos 62
	["am_reader2.nif"] = { 45, keys={"idle2", "idle3", "idle4"} },
	["am_sitting.nif"] = { 52, keys={"idle2", "idle3", "idle4"}, focal=util.vector3(0, 30, 40) },	-- headpos 52
	...
	["barsitter.nif"] = { 52, keys={"idle2", "idle3", "idle4", "idle5"}, focal=util.vector3(0, 30, 35) },	-- headpos 52
	["wallean.nif"] = { 120, keys={"idle9"}, focal=util.vector3(0, -29, 102) },	-- headpos 120

	["anim_sitpleading.nif"] = { 45, keys={"idle9"} },
	["anim_sitthreatening.nif"] = { 45, keys={"idle9"} },

	-- Shadow of Aetherius
	["sit1.nif"] = { keys={"idle9"}, focal=util.vector3(0, -11, 90) },	-- headpos 90
	["sit2.nif"] = { keys={"idle9"}, focal=util.vector3(0, -30, 25)},	-- headpos -40, 25
	["sit3.nif"] = { keys={"idle9"}, focal=util.vector3(0, 0, 40)},		-- headpos 52
...
local function onDialogOpened(data)
	...
	if height then
		...
		if height.focal then dialogCam.head = height.focal			end
	end

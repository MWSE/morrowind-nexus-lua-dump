local config = mwse.loadConfig("Teleport Tome", {
    combatEnabled = true,
    jailEnabled = true,
    bountyEnabled = true,
    setBounty = 250,
...
local function registerConfig()
    ...
    local template = mwse.mcm.createTemplate("Teleport Tome")
    template:saveOnClose("Teleport Tome", config)
    template:register()
    ...
    local settings = page:createCategory("Teleport Tome Settings\n\n\n\nCombat")

...
interop.lockedMessage = {
    steamDetailsRevealed = i18n("lockedMessage.steamDetails"),
    steamKeepPlaying = i18n("lockedMessage.steamKeep"),
    xboxSecret = i18n("lockedMessage.xboxSecret"),
    xboxMoreYouPlay = i18n("lockedMessage.xboxMore"),
    psHidden = i18n("lockedMessage.Hidden")
}
...
---@field progress function | nil
---@field progressMax function | nil
---@field icon string | nil
---@field fullIcon string | nil
...
function interop.registerAchievement(achievement)
    ...
    cheeve.conditionType = cheeve.conditionType or interop.conditionType.instant

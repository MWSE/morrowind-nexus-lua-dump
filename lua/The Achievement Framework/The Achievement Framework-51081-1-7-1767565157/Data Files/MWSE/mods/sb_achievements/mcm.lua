...
local function registerMCM()
    ...
    categoryAchievementsList:createDropdown{
        ...
        defaultSetting = defaultConfig.showHiddenAchievements,
    ...
    categoryAchievementsList:createSlider{
        ...
        defaultSetting = defaultConfig.iconSize,
        showDefaultSetting = true,
        decimalPlaces = 1,
        min = 0.3,
        max = 1.0,
    ...
    categoryAchievementsList:createDropdown{
        ...
        defaultSetting = defaultConfig.achieveList,
        showDefaultSetting = true,
        options = {
    ...
    categoryAchievementsList:createKeyBinder{
        ...
        defaultSetting = defaultConfig.achieveKey,
        showDefaultSetting = true,
...
categoryNotification:createDropdown{
    ...
    defaultSetting = defaultConfig.popupPositionHorizontal,
    showDefaultSetting = true,
    options = {
...
categoryNotification:createDropdown{
    ...
    defaultSetting = defaultConfig.popupPositionVertical,
    showDefaultSetting = true,
    options = {

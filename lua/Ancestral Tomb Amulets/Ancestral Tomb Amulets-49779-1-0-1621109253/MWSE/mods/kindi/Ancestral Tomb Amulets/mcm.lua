...
keybind:createKeyBinder {
    ...
    description = "Enable more information in the table (spoiler!)",
...
smartPlace:createYesNoButton {
    ...
    description = "If yes, then dangerous cells, ie. cells that contain powerful enemies or many aggressive actors will have a higher chance to have an amulet inside\nFor example, there is a better chance to find an amulet inside a daedric or dwemer ruin compared to common houses or town buildings.",
    callback = function()
...
page3:createButton {
    inGameOnly = true,
    label = "Removes all instances of amulets and data from the game",
    buttonText = "Reset",
    description = "This is for uninstalling or debugging, use only for testing.\nUse this before uninstalling the mod completely or if you wish to recollect all amulets",
    callback = function()
        core.hardReset()
    end
}

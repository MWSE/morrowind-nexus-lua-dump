...
this.none = {
    id = "none",
    name = "-None-",
    description = "No Belief Selected"
}
...
this.akatosh = {
    ...
    doOnce = function()
        mwscript.addSpell{
            ...
            spell = "MTR_ByTheDivines_Akatosh"
        }
    end,
}
...
this.allmaker = {
    ...
    doOnce = function()
		...
		mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Allmaker"
        }
		tes3.setStatistic({
			reference = tes3.player,
...
this.adversary = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_AdversaryH"
        }
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_AdversaryG"
        }
        tes3.modStatistic({
            reference = tes3.player,
...
this.tuwhacca = {
    ...
    doOnce = function()
        ...
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Tuwhacca"
        }
    end
}
...
this.baandar = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Baandar"
        }
    end,
}
...
this.clavicusvile = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Clavicus"
        }
		tes3.modStatistic({
            reference = tes3.player,
            attribute = tes3.attribute.luck, 
...
this.dibella = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Dibella"
        }
    end,
}
...
this.kynareth = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Kynareth"
        }
    end,
}
...
this.khenarthi = {
    ...
    doOnce = function()
		mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Khenarthi"
        }
    end,
}
...
this.jodejone = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_JodeJone"
        }
    end,
}
...
this.malacath = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Malacath"
        }
    end,
}
...
this.trinimac = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Trinimac"
        }
    end,
}
...
this.mauloch = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Mauloch"
        }
    end,
}
...
this.mehrunesdagon = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Mehrunes"
        }
    end,
}
...
this.mephala = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Mephala"
        }
    end,
}
...
this.molagbal = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_MolagBal"
        }
    end,
}
...
this.nocturnal = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Nocturnal"
        }
    end,
}
...
this.riddlethar = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Riddlethar"
        }
    end,
}
...
this.sanguine = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Sanguine"
        }
		tes3.modStatistic({
            reference = tes3.player,
...
this.sothasil = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_SothaSil"
        }
    end
}
...
this.stendarr = {
    ...
    name = "Stendarr",
    description = (
        "God of Mercy - God of the Nine Divines, Stendarr has evolved from his Nordic origins into a deity of compassion or, sometimes, righteous rule. He is said to have accompanied Tiber Septim in his later years. Patron of the Imperial Legion. In early Altmeri legends, Stendarr is the apologist of Men. \n\nStendarr is usually venerated by Cyrodiils, Bretons, Altmers and Bosmers. \n\nBonus to Endurance (+5), Block (+5) and Blunt Weapon (+5) is bestowed upon followers of Stendarr."
    ),
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Stendarr"
        }
    end,
}
...
this.srendarr = {
    ...
    doOnce = function()
		mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Srendarr"
        }
    end,
}
...
this.syrabane = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Syrabane"
        }
    end,
}
...
this.vaermina = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Vaermina"
        }
    end,
}
...
this.zenithar = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Zenithar"
        }
    end,
}
...
this.godofworms = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Mannimarco"
        }
        tes3.modStatistic({
            reference = tes3.player,
            attribute = tes3.attribute.personality, 
...
this.ebonarm = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_Ebonarm"
        }
    end,
}
...
this.theoldways = {
    ...
    doOnce = function()
        mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_OldWays"
        }
        tes3.modStatistic({
            reference = tes3.player,
            attribute = tes3.attribute.personality, 
...
this.idealmasters = {
    ...
    doOnce = function()
		mwscript.addSpell{
            reference = tes3.player, 
            spell = "MTR_ByTheDivines_IdealMasters"
        }
    end,
}

-- Here could be "gods" from earlier games like Arius, Ius, Notorgo, Druagaa, Ephen, Jhim Sei, Shagrath, Sai, I'ric, Djen, Kieran, Jhim Sei, Raen, The Sage, Phen, Bandi, Dugrod, Ephen, Mai, Q'Olwen, Vigryl, Strenner, Riana, Agamanus, Zeqqi, etc.,

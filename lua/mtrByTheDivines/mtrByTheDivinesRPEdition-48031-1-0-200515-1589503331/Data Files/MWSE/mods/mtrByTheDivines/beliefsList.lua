...
this.boethiah = {
    ...
    name = "Boethiah",
    description = (
        "Prince of Plots - is a Daedric Prince who rules over deceit, conspiracy, secret plots of murder, assassination, treason, and unlawful overthrow of authority. This sphere is destructive in nature, and his destructiveness comes from inspiring the arms of mortal warriors. Worshippers are known to hold bloody competitions in Bher honor, battling—even killing—each other. Sometimes described as a male and commonly as a female, often within the same text."
    ),
}
...
this.srendarr = {
    ...
    name = "S'rendarr",
    description = (
        "The Runt - S'rendarr is Khajiiti god of mercy, a form of Stendarr.  \n\nS'rendarr is usually venerated by Khajiits."
    ),
}

...
local gnisisPavilion = {
    {   -- южнее моста
        minX = -85276, maxX = -80977,
        minY = 95090, maxY = 96936,
        points = {
            {x = -86283, y = 96030, z = 1821},
            {x = -83971, y = 96520, z = 1977},
        },
        notInRange = true,
    },
}

local gnisisSiltstrider = {
    {   -- севернее подъема от силтстрайдера
        minX = -89566, maxX = -79840,
        minY = 90200, maxY = 96000,
        points = {
            {x = -85624, y = 91426, z = 1304},
            {x = -85705, y = 89981, z = 1225},
            {x = -85871, y = 88733, z = 877},
        },
    },
}
...
local shelterZones = {
    ...
    ["pavilion_4"] = gnisisPavilion,
    ["pavilion_5"] = gnisisPavilion,
    ["siltstrider_awning_1"] = gnisisSiltstrider,
    ["siltstrider_awning_2"] = gnisisSiltstrider,
    ["siltstrider_awning_3"] = gnisisSiltstrider,
}

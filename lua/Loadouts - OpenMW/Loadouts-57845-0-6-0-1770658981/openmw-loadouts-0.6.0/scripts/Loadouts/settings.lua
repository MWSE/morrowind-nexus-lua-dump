...
input.registerTrigger {
        key = o.showLoadoutsWindowRes.argument.key,
        l10n = MOD_ID,
}
...
I.Settings.registerGroup {
        ...
        settings = {
                ...
                makeSeparator(l10n('General')),
                getSettingsFor(o.bgAlpha),
                getSettingsFor(o.bgAlpha_eqSelect),
                getSettingsFor(o.highlightColor),
                getSettingsFor(o.showCondition),


                makeSeparator(l10n('Tool_Tip')),
                getSettingsFor(o.bgAlpha_tooltip),
                getSettingsFor(o.toolTipDelay),
                getSettingsFor(o.toolTipPosX),
                getSettingsFor(o.toolTipPosY),
                getSettingsFor(o.toolTipAnchorX),
                getSettingsFor(o.toolTipAnchorY),

                makeSeparator(l10n('Keyboard_Keybinds')),
                makeReset({
                        o.showLoadoutsWindow.key,
                        o.showLoadoutsWindowRes.key,
                        o.switchToNextLoadout.key,
                        o.switchToPrevLoadout.key
                }),
                getSettingsFor(o.showLoadoutsWindow),
                getSettingsFor(o.showLoadoutsWindowRes),
                getSettingsFor(o.switchToNextLoadout),
                getSettingsFor(o.switchToPrevLoadout),

                makeSeparator(l10n('Controller_Keybinds')),

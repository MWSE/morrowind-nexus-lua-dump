local myUtil = require('scripts.Loadouts.myLib.myUtils')
...
local keyMaps = {
        ...
        -- [input.KEY.UpArrow]   = 'upArrow',
        -- [input.KEY.DownArrow] = 'downArrow',
        -- [input.CONTROLLER_BUTTON.LeftShoulder]  = 'leftArrow',
        -- [input.KEY.LeftArrow]                   = 'leftArrow',
        -- [input.CONTROLLER_BUTTON.RightShoulder] = 'rightArrow',
        -- [input.KEY.RightArrow]                  = 'rightArrow',
...
local function handlePress(code, pressed)
        if not myVars.mainWindow.element.layout then return end

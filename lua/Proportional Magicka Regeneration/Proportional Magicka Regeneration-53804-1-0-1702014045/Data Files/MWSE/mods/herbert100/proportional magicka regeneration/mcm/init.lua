...
function mcm.register()
    ...
    do -- make atronach settings 
        ...
        settings:createOnOffButton({
            label = "Enable Atronach sleep/rest regeneration",
            description = string.format("\z
                If enabled, Atronachs will be able to regeneration magicka when sleeping or resting, taking the above multiplier into account.\n\n\z
                    \z
                    Disabling this will mean Atronachs cannot rest to regain all their magicka; they will instead have to wait \z
                    many grueling real-world minutes for it to slowly replenish.\n\n\z
                    \z
                    Default: disabled.",
                    (default_config.atronachs_can_sleep and "enabled") or "disabled"
            ),
            variable = mwse.mcm.createTableVariable{id = "atronachs_can_sleep", table = mcm.config},
        })
        settings:createOnOffButton({
            label = "Enable Atronach rest/travel regeneration",
            description = string.format("\z
            If enabled, Atronachs will be able to regeneration magicka when traveling/teleporting, taking the Atronach regeneration multiplier into account.\n\n\z
                \z
                Disabling this will mean that Atronachs will have to walk if they want to regenerate magicka while traveling.\n\n\z
                \z
                Default: %s.",
            (default_config.atronachs_can_travel and "enabled") or "disabled"
            ),
            variable = mwse.mcm.createTableVariable{id = "atronachs_can_sleep", table = mcm.config},
        })
    end
    ...
    do -- make player regen settings
        ...
        category:createOnOffButton({ label = "Enable magicka regeneration",

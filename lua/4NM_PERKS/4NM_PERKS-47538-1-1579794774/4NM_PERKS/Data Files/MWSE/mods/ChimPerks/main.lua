...
--local mes = {"кузнецом", "средних доспехов", "тяжелых доспехов", "дробящего оружия", "длинных клинков", "топоров", "древкового оружия", "атлетики", "зачарования", "разрушения", "изменения", "иллюзий", "колдовства",
--"мистицизма", "восстановления", "алхимии", "бездоспешного боя", "взлома", "скрытности", "акробатики", "легких доспехов", "коротких клинков", "меткости", "торговли", "красноречия", "рукопашного боя", [0] = "защиты"}
...
-- Только для тестеров. Получить все перки. Для тестеров. Удалить все перки. Вы не получили какой-то перк? Нажмите да - и при загрузке сейва произойдет проверка. Перевыбрать свой класс при загрузке сейва.

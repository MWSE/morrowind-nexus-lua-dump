...
--local mes = {"кузнецом", "средних доспехов", "т€желых доспехов", "дроб€щего оружи€", "длинных клинков", "топоров", "древкового оружи€", "атлетики", "зачаровани€", "разрушени€", "изменени€", "иллюзий", "колдовства",
--"мистицизма", "восстановлени€", "алхимии", "бездоспешного бо€", "взлома", "скрытности", "акробатики", "легких доспехов", "коротких клинков", "меткости", "торговли", "красноречи€", "рукопашного бо€", [0] = "защиты"}
...
-- “олько дл€ тестеров. ѕолучить все перки. ƒл€ тестеров. ”далить все перки. ¬ы не получили какой-то перк? Ќажмите да - и при загрузке сейва произойдет проверка. ѕеревыбрать свой класс при загрузке сейва.

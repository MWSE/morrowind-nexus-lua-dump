return {
 ...
 {Description="Sets the selected object to the desired scale",Command_Name="setscale",},
 {Description="Will return the player's crime level if no number is provided, if one is provided, the player crime level will be set to that level",Command_Name="setpccrimelevel;crimelevel",},

 {Description="Saves the current camera position. Requires a string be provided after the command. This saved position is not save game specific. Can type scp for short",Command_Name="setcampos",},
 {Description="Resets the player and camera position to the last palce they were before entering freecam mode.",Command_Name="resetcampos",},
 {Description="Teleports the player(if needed) and camera to the position saved by setcampos commands. gcp can be used for short.",Command_Name="gotocampos",},

 {Description="Checks the scale of the selected object",Command_Name="getscale",},
 {Description="Toggles freecam. Experimental. May also use freecam command",Command_Name="tfc;freecam",},
 ...
 {Description="Create a merchant with all items of the specified type. Accepts Apparatus; Armor; Book; Clothing; Ingredient; Light; Lockpick; Misc; Potion; Probe; Repair; weapon. If type is “item”; you will get a merchant with every item in the game. This will cause significant lag. Items with scripts attached are ommited.",Command_Name="seeall",},
 ...
 {Description="Toggles music. If on or off is specified, it is set to that state.",Command_Name="music"},

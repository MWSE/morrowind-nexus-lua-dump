...
local zu = require('openmw.interfaces').ZackUtilsG
local player = nil
...
local function runConsoleCommand(command)
    player:sendEvent("runConsoleCommandEvent",command)
    
    

end
local function setSelected(obj)
    zu = require('openmw.interfaces').ZackUtilsG
    zu.getPlayer():sendEvent("OMWConsoleSetSelected",obj)

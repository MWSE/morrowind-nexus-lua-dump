local cf = mwse.loadConfig("Spawner", {KEY = {keyCode = 184}, n = 1, msg = true, agr = true, ray = false, hp = 0, mana = 0, stam = 0, str = 0, endu = 0, spd = 0, agi = 0, int = 0, wil = 0, atb = 0, arm = 0,
...
p0:createSlider{label = "Spawn number", min = 1, max = 20, step = 1, jump = 1, variable = var{id = "n", table = cf}}
...
p0:createSlider{label = "Strength bonus", min = 0, max = 500, step = 10, jump = 50, variable = var{id = "str", table = cf}}
p0:createSlider{label = "Endurance bonus", min = 0, max = 500, step = 10, jump = 50, variable = var{id = "endu", table = cf}}
p0:createSlider{label = "Speed bonus", min = 0, max = 500, step = 10, jump = 50, variable = var{id = "spd", table = cf}}
p0:createSlider{label = "Agility bonus", min = 0, max = 500, step = 10, jump = 50, variable = var{id = "agi", table = cf}}
p0:createSlider{label = "Intelligence bonus", min = 0, max = 500, step = 10, jump = 50, variable = var{id = "int", table = cf}}
p0:createSlider{label = "Willpower bonus", min = 0, max = 500, step = 10, jump = 50, variable = var{id = "wil", table = cf}}
p0:createSlider{label = "Attack bonus", min = 0, max = 500, step = 10, jump = 50, variable = var{id = "atb", table = cf}}

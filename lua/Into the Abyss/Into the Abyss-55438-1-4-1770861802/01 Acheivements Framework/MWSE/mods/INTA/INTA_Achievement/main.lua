...
local function init()
    ...
    sb_achievements.registerAchievement {
        ...
        title     = "Rock Bottom", desc = "Reach the bottom of the Abyss.",
    }
    sb_achievements.registerAchievement {
        ...
        title     = "Curses Aren't Real", desc = "Reach the bottom of the Abyss...without getting cursed!",
    ...
    sb_achievements.registerAchievement {
        ...
        colour    = pData.colours.gold,
        title     = "Public Transport", desc = "Activate every Wayshrine in the Abyss.",
        configDesc = sb_achievements.configDesc.groupHidden
    }
end

  ...
  engineHandlers = { 
    ...
    onUpdate = function(dt)
      if enabled then
        ...
        if (I.RUN and not I.RUN.Active()) or (I.RUN == nil) then
            -- Avoid forcing base FOV every frame when the bow zoom system is idle.
            -- This prevents hard conflicts with other camera/FOV mods.
            if active or counter > (counterMin + 0.001) then

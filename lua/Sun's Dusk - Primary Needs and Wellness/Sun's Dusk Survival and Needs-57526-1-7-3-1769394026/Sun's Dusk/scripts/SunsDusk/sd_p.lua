...
function mainLogic()
	...
	if G_isTravelling and tempCurrentHour - lastHourProcessed >= 12 then
		G_isLongTravel = true
	else
...
local function UiModeChanged(data)
	...
	log(3, "ui mode "..tostring(data.oldMode).." -> " .. tostring(data.newMode), data.arg)
...
local function cellChanged(lastCell)
    ...
    if saveData.got_sd_book_1_needs and saveData.got_sd_book_2_temp then
...
--        -- Scale up
--        core.sendGlobalEvent("scaleUp", obj)
--    elseif key.symbol == "2" then
--        -- Scale down
--        core.sendGlobalEvent("scaleDown", obj)
--    elseif key.symbol == "3" then
--        -- Move up
--        core.sendGlobalEvent("moveUp", obj)
--    elseif key.symbol == "4" then
--        -- Move down
--        core.sendGlobalEvent("moveDown", obj)
--    elseif key.code == input.KEY.LeftArrow then
--        -- Move left
--        core.sendGlobalEvent("moveLeft", obj)
--    elseif key.code == input.KEY.RightArrow then
--        -- Move right
--        core.sendGlobalEvent("moveRight", obj)
--    elseif key.code == input.KEY.UpArrow then
--        -- Move forward
--        core.sendGlobalEvent("moveForward", obj)
--    elseif key.code == input.KEY.DownArrow then
--        -- Move back
--        core.sendGlobalEvent("moveBack", obj)

...
local function updateWidget()
	...
	if sleepData.currentSleepingProfile ~= "insomniac" then
		...
		tooltipStr = tooltipStr..(not sleepData.currentTirednessBuff and "Loading..." or tooltips[sleepData.currentTirednessBuff] or "Error: "..tostring(sleepData.currentTirednessBuff))
...
local function module_sleep_minute(clockHour, minute, minutesPassed)
	...
	elseif G_isSleeping then
		...
		log(5, tostring(minutesPassed).."m passed  ;  currently not sleeping at ...  "..clockHour..":00  ;  current tiredness is: "..f2(sleepData.tiredness).." ; gained  "..f2((sleepData.tiredness -tirednessPrior )*100).."%")

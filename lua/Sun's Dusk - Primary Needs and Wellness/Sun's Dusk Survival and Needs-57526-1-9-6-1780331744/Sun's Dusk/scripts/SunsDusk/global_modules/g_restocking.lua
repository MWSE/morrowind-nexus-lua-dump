...
table.insert(G_restocking, {
	...
	classPatterns   = { "publican", "t_sky_publican", "t_cyr_publican", "t_glb_publican", "innkeeper", "trader", "merchant", "trader service", "t_glb_trader", "t_glb_traderservice" },
	startStock      = 6,
	maxStock        = 6,
	restockPerDay   = 3,
})
--merchants usually sell ingredients too
--table.insert(G_restocking, {
--	itemPool        = { "sd_wood_merchant" },
--	itemType        = "Miscellaneous",
--	serviceRequired = "Misc",
--	classPatterns   = { "publican", "t_sky_publican", "t_cyr_publican", "t_glb_publican", "innkeeper", "trader", "merchant" },
--	startStock      = 6,
--	maxStock        = 6,
--	restockPerDay   = 3,
--})
table.insert(G_restocking, {
	itemPool        = { "sd_campingitem_tent_ing" },
	itemType        = "Ingredient",
	serviceRequired = "Ingredients",
	classPatterns   = { "publican", "t_sky_publican", "t_cyr_publican", "t_glb_publican", "innkeeper", "trader", "merchant", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 8,
...
table.insert(G_restocking, {
	itemPool        = { "sd_campingitem_bedroll_ing" },
	itemType        = "Ingredient",
	serviceRequired = "Ingredients",
	classPatterns   = { "publican", "t_sky_publican", "t_cyr_publican", "t_glb_publican", "innkeeper", "trader", "merchant", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 8,
...
table.insert(G_restocking, {
	...
	itemType        = "Miscellaneous",
	serviceRequired = "Misc",
	classPatterns   = { "trader", "merchant", "pawnbroker", "soap seller", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 0.5,
	maxStock        = 4,
	restockPerDay   = 0.5,
})
...
table.insert(G_restocking, {
	itemPool        = { "ingred_sload_soap_01", }, -- sload soap
	itemType        = "Ingredient",
	serviceRequired = "Ingredients",
	classPatterns   = { "publican", "t_sky_publican", "t_cyr_publican", "t_glb_publican", "innkeeper", "trader", "merchant", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 2,
...
table.insert(G_restocking, {
	...
	itemType        = "Miscellaneous",
	serviceRequired = "Misc",
	classPatterns   = { "trader", "merchant", "alchemist", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 0.5,
	maxStock        = 4,
	restockPerDay   = 0.5,
})
table.insert(G_restocking, {
	...
	itemType        = "Miscellaneous",
	serviceRequired = "Misc",
	classPatterns   = { "trader", "merchant", "alchemist", "pawnbroker", "soap seller", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 1,
	maxStock        = 2,
	restockPerDay   = 1,
})
...
-- 	classPatterns   = { "trader", "merchant", "pawnbroker", "bookseller", "t_glb_bookseller" },
-- 	startStock      = 1,
-- 	maxStock        = 1,
-- 	restockPerDay   = 1,
-- })
...
table.insert(G_restocking, {
	...
	itemType        = "Book",
	serviceRequired = "Books",
	classPatterns   = { "trader", "merchant", "pawnbroker", "bookseller", "t_glb_bookseller", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 0.5,
	maxStock        = 1,
	restockPerDay   = 0.5,
})
table.insert(G_restocking, {
	itemPool        = { 
		...
		"sd_campingitem_workbench",	
	},
	itemType        = "Miscellaneous",
	serviceRequired = "Misc",
	classPatterns   = { "trader", "merchant", "pawnbroker", "trader service", "t_glb_trader", "t_glb_traderservice"  },
	startStock      = 0.25,
	maxStock        = 1,
	restockPerDay   = 0.25,
})
...
local toConvert = {
	sd_wood_publican = "sd_wood_1",
	sd_wood_merchant = "sd_wood_1",
	sd_campingitem_bedroll_ing = "sd_campingitem_bedroll",
	sd_campingitem_tent_ing = "sd_campingitem_tent"
}

local function convertMerchantItems(player)
	for _, item in pairs(types.NPC.inventory(player):getAll()) do
		if item.count > 0 and toConvert[item.recordId] then
			local tempItem = world.createObject(toConvert[item.recordId], item.count)
...
G_eventHandlers.SunsDusk_convertMerchantItems = convertMerchantItems
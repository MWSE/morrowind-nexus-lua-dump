...
G_tentUpgrades = {
	["sd_campingitem_sticks"] = { { component = nil, result = "sd_tent_1",  label = "Build Tent" }, },
	["sd_campingitem_rope"] = { { component = "sd_campingitem_sticks", result = "sd_tent_2", label = "Build Tent (Add sticks)" }, },
	["sd_campingitem_tarp"] = { { component = "sd_campingitem_sticks", result = "sd_tent_2b", label = "Build Tent (Add sticks)" }, },
	["sd_tent_1"] = { { component = "sd_campingitem_rope", result = "sd_tent_2", label = "Add Rope" }, },
	["sd_tent_2"] = { { component = "sd_campingitem_tarp", result = "sd_tent_3", label = "Add Tarp" }, },
	["sd_tent_2b"] = { { component = "sd_campingitem_rope", result = "sd_tent_3", label = "Add Rope" }, },
	["sd_tent_3"] = { { component = "sd_campingitem_bedroll", result = "sd_tent_4", label = "Add Bedroll" }, },
}
...
-- ------------------------------ brewing ------------------------------
-- consumed by p_tea w mesh check for world interaction ; tea_recipes (teakettle station check), and g_liquids (vfx blacklist)

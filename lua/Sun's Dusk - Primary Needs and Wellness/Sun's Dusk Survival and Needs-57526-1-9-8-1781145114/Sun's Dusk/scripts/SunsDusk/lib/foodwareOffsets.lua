...
local foodwareOffsets = {
	...
	["t_com_coconutplate_02"] = {
		offset = util.vector3(0.00, 0.00, -0.90),
		scale = 1.04
	},
	["teamod_sugarbowl_cali_silv"] = {
		offset = util.vector3(0.00, 0.00, 0.00),
		scale = 1.00
	},
	["nom_mix_bowl"] = {
	...
	["misc_uvi_silverware_plate_02"] = {
		offset = util.vector3(0.00, 0.00, -0.60),
		scale = 1.22
	},
	["misc_uvi_silverware_bowl_a"] = {
		offset = util.vector3(0.00, 0.00, -1.50),
		scale = 0.96
	},
	["misc_uvi_silverware_bowl_b"] = {
		offset = util.vector3(0.00, 0.00, -1.50),
		scale = 1.00
	},
	["uvi_bowl_sara"] = {
	...
	["uvi_berom_redware_bowl"] = {
		offset = util.vector3(0.00, 0.00, -2.10),
		scale = 1.00
	},
	["st_bowl_mushwood"] = {
		offset = util.vector3(0.00, 0.00, 0.00),
...
--for a,b in pairs(foodwareOffsets) do
--	if not soupFoodwareOffsets[a] then
--		print("missing in soup:", a)
--	end
--end
--
--for a,b in pairs(soupFoodwareOffsets) do
--	if not foodwareOffsets[a] then
--		print("missing in food:", a)
--	end
--end

return {foodOffsets, foodwareOffsets, soupFoodwareOffsets}
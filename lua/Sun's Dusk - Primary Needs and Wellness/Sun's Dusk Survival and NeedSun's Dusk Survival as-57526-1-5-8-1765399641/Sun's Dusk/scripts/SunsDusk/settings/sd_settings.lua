...
settingsTemplate.THIRST = {
	...
	settings = {
		...
		-- },
		{
			key = "NEEDS_THIRST_REFILL_SOURCES",
			name = "Enable Saltwater and Suspicious water (COMING SOON)",
			description = "Refilling water in places other than wells gives you different kinds of water",
			renderer = "checkbox",
			default = true,
		},
		{
		...
		{
			key = "NEEDS_THIRST_SPILL_ON_JUMP",

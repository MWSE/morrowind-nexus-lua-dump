...
-- ========================================================== VVARDENFELL ==========================================================
	...
	},
	{
		...
		position = util.vector3(22573.322266, 71358.187500, 21258.263672),
		intensity = 20,
		radius = 25000,
		climate = "volcanic",
	},
	...
	},
	{
		...
		intensity = 14,
		radius = 6500 / (TEMP_TOTSP and 1 or 10000),
		climate = "urban",
		exponent = 0.35,
	},	
	{
	...
	{
		name = "Bitter Coast Swamps", -- gnaar mok
		position = util.vector3(-30000, 1187.576538, 228.582367), 
		intensity = 15, -- 35c is max
		radius = 36000,
		climate = "tropical",
	},	
	{
		name = "Odai River",
		position = util.vector3(-34349.285156, -41576.277344, 228.582367), 
		intensity = -3,
		radius = 23000,
		climate = "coastal",
	},

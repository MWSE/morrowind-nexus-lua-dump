...
if ashfall then
	...
	ashfall.registerTeas{
		['ab_ingflor_pomegranate01'] = {
			teaName = "Гранатовый чай",
			teaDescription = "Чай с освежающими фруктовыми нотками, заваренный из зерен граната. Его сладкий вкус с терпкими нотками заставляет вас забыть о своих болезнях.",
			effectDescription = "Восстановить все атрибуты 1 п.",
			spell = {

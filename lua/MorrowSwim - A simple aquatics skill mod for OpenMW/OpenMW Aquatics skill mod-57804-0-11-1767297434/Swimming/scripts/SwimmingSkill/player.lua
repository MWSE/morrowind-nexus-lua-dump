...
-- New function: Calculate dash parameters based on skill level
-- Each level contributes a small, consistent improvement
local function getDashParameters()
    ...
    -- Linear scaling: each skill level adds the same fixed amount
    ...
    -- Ensure fatigue cost doesn't go below a minimum threshold
...
print("  Nord: -5 | Orc: -5")
print("Dash scaling per level:")
print("  Speed: +" .. dashSpeedPerLevel)
print("  Fatigue: " .. dashFatigueCostPerLevel)
print("  Duration: +" .. dashDurationPerLevel .. "s")
print("==========================================")

...
function self.createMenu(e)
	...
	self.animate = { time=core.getRealTime(), open=true, stop=0.4 }
...
--        template = I.MWUI.templates.boxSolidThick,
        ...
        content = ui.content {
            ...
            { template = Container({ alpha = 0.0, padding = {left=32, right=32, top=12, bottom=12},

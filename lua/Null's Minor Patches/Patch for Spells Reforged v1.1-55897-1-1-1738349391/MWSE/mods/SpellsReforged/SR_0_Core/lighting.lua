...
event.register(tes3.event.vfxCreated, function(e)
    -- NC: Added missing nil check to ensure effectNode exists.
    if e.vfx.effectNode and e.vfx.effectNode:hasStringDataWith("SR_ManagedLights") then ---@diagnostic disable-line

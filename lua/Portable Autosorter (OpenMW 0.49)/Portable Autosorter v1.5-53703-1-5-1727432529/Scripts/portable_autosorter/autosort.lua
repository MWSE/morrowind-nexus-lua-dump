            ...
            do
                ...
                do
                    ...
                    elseif item.recordId == "autosort_target_clothing" then
                        core.sendGlobalEvent("moveClothing", {actorObject=actor, container=container, list=types.Actor.inventory(actor):getAll(types.Clothing)})
                    elseif item.recordId == "autosort_target_jewelry" then
                        core.sendGlobalEvent("moveJewelry", {actorObject=actor, container=container, list=types.Actor.inventory(actor):getAll(types.Clothing)})

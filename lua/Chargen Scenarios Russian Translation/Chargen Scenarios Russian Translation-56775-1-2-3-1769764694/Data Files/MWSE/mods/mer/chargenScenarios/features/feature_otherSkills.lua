...
function OtherSkillsFeature.callback(e)
    ...
    local header = menu:createLabel{ text = "Выберите бонусы для других навыков" }
    ...
    for skillId, skill in pairs(availableSkills) do
        ...
        local function createResetButton()
            local button = skillBlock:createButton{ text = "Сброс" }
    ...
    --Reset button
    local resetButton = buttonsBlock:createButton{ text = "Сбросить все" }

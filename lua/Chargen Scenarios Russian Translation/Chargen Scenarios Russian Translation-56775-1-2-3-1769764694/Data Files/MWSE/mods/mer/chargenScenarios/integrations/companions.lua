...
local companions = {
    ...
    },
    {
        ...
        callback = function(ref)
            ...
            tes3.addTopic{ topic = "-пропавший ослик"}
        end
    },
    {
        id = "0_ulf",
        description = "Оранжевый волк",
        callback = function(ref)
    ...
    {
        id = "cm_clannfear",
        description = "Ужас клана",
        callback = addCMCompanion,
    },
    {
        id = "cm_cliff_racer",
        description = "Скальный наездник",
        callback = addCMCompanion,
    },
    {
        id = "cm_daedroth",
    ...
    },
    {
        ...
        description = "Карликовый гуар",
        callback = addFFCompanion,
    },
    {
        id = "aa_cm_centurion_spider",
        description = "Паук-центурион",
        callback = addFFCompanion,
    },
    {
        id = "aa_cm_winged twilight",
        description = "Крылатый сумрак",
        callback = addFFCompanion,
    },
    {
    ...
    {
        id = "AA1_Paxon",
        description = "Вьючная крыса",
    },
    {
        id = "AA1_Tetra",
        description = "Вьючный гуар",
    },
    {
        id = "AA1_Henwen",
        description = "Вьючный кабан",
    },
}
...
event.register("equip", function(e)
    if e.item.id:lower() == "mer_cs_flute_01" then
        ...
        if guarRef then
            ...
            tes3.messageBox("Вы призываете своего гуара.")
        else
            logger:debug("Guar ref not found")
            tes3.messageBox("Ничего не происходит.")
        end
    end
end)
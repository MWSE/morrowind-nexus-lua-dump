...
local scenarios = {
    ...
    {
        id = "janattaSyndicate",
        name = "Фракция: Синдикат Джа-Натта",
        description = "Вы - недавно посвященный \"Слизняк\" преступной фракции, известной как Синдикат Джа-Натта, в Нарсисе.",
        journalEntry = "Меня посвятили в члены синдиката Джа-Натта. Мне следует поговорить с Салдени Андралор о моей первой работе.",
        topics = { "случайные подработки", "Повышение", "работа" },
        factions = {

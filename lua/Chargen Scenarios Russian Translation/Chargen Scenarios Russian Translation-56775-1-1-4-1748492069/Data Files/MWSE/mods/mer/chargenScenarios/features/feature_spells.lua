...
function SpellsFeature.callback(e)
    ...
    local header = block:createLabel{ text = "Выберите дополнительные заклинания:" }
    ...
    local randomButton = buttonsBlock:createButton{ text = "Случайные" }
...
function SpellsFeature.getTooltip(e)
    ...
    local tooltipMessage = "Начальные заклинания:\n"

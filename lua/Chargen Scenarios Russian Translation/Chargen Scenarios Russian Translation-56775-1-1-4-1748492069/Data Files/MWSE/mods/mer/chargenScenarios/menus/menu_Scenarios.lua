...
local function onClickScenario(scenario)
    ...
    if scenarioValid and #validLocations > 1 then
        ...
        local button = locationDropdownBlock:createButton{ text = "Расположение: " .. scenario:getStartingLocation():getName()}
        button:register("mouseClick", function()
            ...
            local heading = outerBlock:createLabel{ text = "Выберите расположение:"}
            ...
            for _, location in ipairs(validLocations) do
                ...
                locationButton:register("mouseClick", function()
                    ...
                    button.text = "Расположение: " .. location:getName()
                end)
            end
            ...
            --okay button
            local okayButton = buttonsBlock:createButton{ text = "ОК"}

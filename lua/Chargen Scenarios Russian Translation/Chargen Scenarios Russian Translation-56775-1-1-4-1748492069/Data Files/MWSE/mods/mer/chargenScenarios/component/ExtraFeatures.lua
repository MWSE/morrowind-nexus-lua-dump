...
function ExtraFeatures.openMenu(e)
    ...
    if #availableFeatures == 0 then
        featureButtons = {
            {
                text = "Дополнительные опции отсутствуют",
        ...
        tes3ui.showMessageMenu{
            ...
            customBlock = function(parent)
                ...
                local message = parent:createLabel{
                    text = "Предупреждение: Дополнительные опции не сбалансированы и могут конфликтовать или переопределять настройки сценария. Используйте с осторожностью.",
                }
...
function ExtraFeatures.getTooltip()
    ...
    if tooltip == "" then
        tooltip = "Не выбрано ни одной дополнительной опции."
    else
        --remove last newline

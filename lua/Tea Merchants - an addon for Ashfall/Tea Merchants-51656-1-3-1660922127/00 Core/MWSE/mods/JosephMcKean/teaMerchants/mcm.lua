...
this.version = "1.3"
local summary =
    "This mod is an addon for Ashfall. It adds Tea Merchants in the game."
...
local function modConfigReady()
    ...
    if tes3.isModActive("Tea Merchants.esp") then
        ...
        local template = mwse.mcm.createTemplate {
            name = this.mod,
            headerImagePath = "textures/jsmk/MCMHeader.tga"
        }
        ...
        infoPage:createDropdown{
            ...
            callback = function(self)
                for _, log in ipairs(
                                  require("JosephMcKean.teaMerchants.logging").loggers) do

                    ...
                    timer.start{
                        ...
                        callback = function()
                            ...
                            timer.delayOneFrame(function()
                                tes3.messageBox{
                                    message = newAnimal:format("{Name} doesn't trust you enough to accompany you. Try petting {him} and giving {him} some treats. \n" ..
                                        "As {his} trust builds up over time, {he} will learn new skills like fetching items and wearing a pack. \n" ..
                                        "You can command your guar from a distance by pressing the {Command Key} key while looking at {him}."
                                    ),
                                    buttons = { "Okay" }
                                }
                            end)
    ...
    if guar then
        ...
        if guar.pack:hasPack() then
            ...
            local label = block:createLabel{ id = tes3ui.registerID("GuarWhisperer:PackLabel"),
                text = "Press SHIFT+P to open pack"
            }
            label.text = string.format("Press SHIFT+%s to open inventory", activateKey)

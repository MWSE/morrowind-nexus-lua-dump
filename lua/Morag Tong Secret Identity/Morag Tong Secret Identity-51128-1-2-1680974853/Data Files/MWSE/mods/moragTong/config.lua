local defaultConfig = {
    modEnabled = true,
		...
		writTargets = {
			...
			["TR_m4_Serali_Beralam"] = "TR_m4_MT_Serali",
			["TR_m4_Llirala_Arys"] = "TR_m4_MT_Llirala",
			["TR_m4_Nalvos Omayn"] = "TR_m4_MT_Omayn",
			["TR_m4_Nadras_Arvel"] = "TR_m4_MT_NadrasArvel",
			["TR_m4_O_Ilmeni"] = "TR_m4_MT_Ilmeni",
			["TR_m4_O_Dransa"] = "TR_m4_MT_Dransa",
			["TR_m4_O_Jelyn Indo"] = "TR_m4_MT_Jebyn",
			["TR_m4_Almse_Ramaran"] = "TR_m4_MT_Almse",
			["TR_m4_Tolmse_Indarys"] = "TR_m4_MT_Tolmse",
			--[""] = "",
		},
        closedHelmets = {
			smt_hl_op = true

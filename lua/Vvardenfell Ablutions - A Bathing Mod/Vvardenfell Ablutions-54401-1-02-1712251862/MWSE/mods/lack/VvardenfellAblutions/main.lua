...
"ko_basin", "ko_rose_basin", "ko_white_basin", "clawtub", "water_bucket-bathsale", "nom_well_", "hlaalu_well", "ex_redoran_well", "ex_t_wellpod", "rp_red_well", "rp_mh_well", "rm_well", "ruined_well_", "ex_nord_well", "furn_well00", "act_bm_well" }
...
local fragrants = { "bath_oil", "bug_musk", "ko_bath_salts", "bath_powder", "moonlust", "darkpassion", "eveninghaze", "parfuem", "blood musk", "cologne", "aftershave" }
...
local function bathe(e)
	...
	local armor = tes3.mobilePlayer.object.equipment
	
	if ( config.requireNudity and #armor > 0 ) then

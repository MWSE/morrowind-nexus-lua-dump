...
local function modConfigReady()
    ...
    category_main_settings:createSlider{
		...
		description = [[
        Влияет на скорость прокачки при ходьбе. Работает, как простой множитель получаемого опыта.
    ...
    movement_types:createSlider{
		label = "Коэфициент опыта для ходьбы",
		description = [[
        Влияет на количество опыта при ходьбе в доспехах.
    ...
    movement_types:createSlider{
		label = "Коэфицент опыта для плавания",
		description = [[
        Влияет на количество опыта при плавании в доспехах

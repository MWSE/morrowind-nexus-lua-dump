...
local IN_COMBAT_MESSAGE = "Вы не можете использовать инвентарь во время боя."
...
local sidebarDefault = (
    "\"Выключение меню во время боя\" не позволяет вам получить доступ к меню инвентаря, " ..
    "а также блокирует обыск контейнеров/тел, во время боя. \n" ..
    "Да, это значительно усложняет ведение боя. Вам придется планировать" ..
    "заранее стратегию и использовать быстрые клавиши, так как они - ваш единственный " ..
    "способ выбрать оружие/магию/зелье. И нет, вы не сможете менять быстрые клавиши " ..
    "во время боя."
)
...
local function registerModConfig()
    local template = mwse.mcm.createTemplate("Выключение меню во время боя")
    ...
    page:createOnOffButton{
        label = "Выключить меню во время боя",
        description = "Включить или выключить этот мод.",
        variable = makeVar("enable")
    }

    page:createSlider{
        label = "Безопасное расстояние",
        description = "Расстояние до ближайшего врага, на котором вы можете получить доступ к своему инвентарю.",

local constant = require("zackhasacat.ConsoleCheck.consolecheck_c")
...
local function uiActivated(e)
    if isConsoleBlocked() then
        timer.frame.delayOneFrame(function()
            ...
            tes3.messageBox { message = constant.message, duration = 5 }
        end)
    end
end


event.register(tes3.event.uiActivated, uiActivated, { filter = "MenuConsole" })

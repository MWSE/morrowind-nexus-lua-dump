...
I.Settings.registerGroup({
   ...
   settings = {
	...
	},
	{
        ...
        {
            key = 'soundfile',
            name = 'Notification Sound Start',
            description = 'Select the sound to be played when the Start Quest notification appears. Selecting None silences the notification\n\nDefault: Skyrim Quest',
            default = 'Skyrim Quest', 
            renderer = 'select',
            argument = {
                disabled = false,
	...
	},
      {
        ...
        {
            key = 'soundfilefin',
            name = 'Notification Sound Finish',
            description = 'Select the sound to be played when the Finish Quest notification appears.\n\nDefault: Skyrim Quest',
	...
	},
      {
        ...
        {
            key = 'soundfileupdate',
            name = 'Quest Update Sound',
            description = 'Select the sound to be played when a Quest stage advances.\n\nDefault: Book Page 2',
            default = 'Book Page 2',
            renderer = 'select',
            argument = {
                disabled = false,
                l10n = 'LocalizationContext', 
                items = { "Book Page 1", "Book Page 2", "None", "Custom" },
            },
	},
      {
...
element = ui.create {
	...
	if notificationText == "Quest Started:" then

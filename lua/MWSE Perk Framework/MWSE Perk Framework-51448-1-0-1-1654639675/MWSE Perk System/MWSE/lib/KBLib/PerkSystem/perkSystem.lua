...
public.showPerkMenu = function(params)
	...
	if params.perkList then
		...
		headerBlock.paddingAllSides = 5
			...
			headerLabel = headerBlock:createLabel{text = (params.header or "Perk Selection")}
		...
		perksPage.childAlignY = 0
			...
			perksPage_borderR.widthProportional = 1.4
				...
				perksPage_perksRem = perksPage_borderL:createLabel({text = "Perk Points:  " .. (params.perkPoints) - perksSelected})
	...
	local function updatePerkState()
		...
		perksPage_perksRem.text = "Perk Points:  " .. params.perkPoints - perksSelected
	end

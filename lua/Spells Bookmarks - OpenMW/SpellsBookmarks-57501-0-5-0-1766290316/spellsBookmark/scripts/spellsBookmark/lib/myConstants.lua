...
local textures = {
        ...
        inactiveTab = ui.texture { path = 'textures/SB_inactiveTab.dds' },
        bookmarksTab = ui.texture { path = 'textures/bookmarksTab.dds' },
        addOrRemoveTab = ui.texture { path = 'textures/addOrRemoveTab.dds' },
        scroll = ui.texture { path = 'Icons/m/Tx_scroll_open_01.dds' },
        enchItem = ui.texture { path = 'Icons/c/tx_amulet_exquisite1.dds' },

        ...
        function self.createLayout()
                ...
                self.bottomPanel = {
                        ...
                        content = ui.content({
                                ...
                                -- (self.filterFunction and {
                                --         type = ui.TYPE.Flex,
                                --         props = { arrange = ui.ALIGNMENT.Center, align = ui.ALIGNMENT.Start, horizontal = true },
                                --         content = ui.content({
                                --                 {
                                --                         template = I.MWUI.templates.box,
                                --                         content = ui.content {
                                ...
                                --                                 props = {
                                --                                         text = self.filterText,
                                --                                         textColor = util.color.hex('ffffff'), size = util.vector2(50, 1)
                                --                                 },
                                --                                 events = { textChanged = async:callback(function(newText)
                                --                                         self

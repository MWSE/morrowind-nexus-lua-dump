...
M.tomeId = 'rt_soul_wisp_artaeum_tome'
M.tomeSourceBookId = 'bk_fragmentonartaeum'
M.tomeDialogueTopic = 'soul wisp'
M.tomeCellAliases = {
...
M.scanInterval = 0.15
M.fadeOutTime = 1.0
-- Hostility polling/target-cache timings for the Soul Wisp actor monitor.
M.hostilityPollInterval = 0.25
M.hostilityRequestInterval = 0.20
M.hostilityCacheDuration = 0.75
-- Fallback targeting heuristics used when OpenMW does not expose an active
-- Combat target for a given actor.  The high friendly-disposition cutoff is
-- meant to keep companions/followers from being targeted just because their
-- Fight value is high.
M.friendlyNpcDispositionCutoff = 75
M.hostileNpcDispositionCutoff = 70
M.npcFightFallbackCutoff = 70
M.creatureFightFallbackCutoff = 30

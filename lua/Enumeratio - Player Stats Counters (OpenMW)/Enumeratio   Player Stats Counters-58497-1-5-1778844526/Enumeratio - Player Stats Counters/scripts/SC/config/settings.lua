...
local settingGroups = {
    ...
    [healthKey] = {
        ...
        settings = {
            ...
            { key = "resetDeathLuckPenalty", default = false, renderer = mDef.renderers.resetButton, argument = { label = "Reset Luck Penalty" } },
        },
    },
    -- ── Display options ────────────────────────────────────────
    [displayKey] = {
    ...
    [summaryKey] = {
        ...
        settings = {
            ...
            { key = "showOppAfflictionLedger", default = true, renderer = "checkbox" },
            {
    ...
    [magicKey] = {
        ...
        settings = {
            ...
            { key = "showCmcDiseasedCreaturesCured", default = true, renderer = "checkbox" },
            { key = "showCmcBlightedCreaturesCured", default = true, renderer = "checkbox" },
            { key = "showCmcDiseasesSpread", default = true, renderer = "checkbox" },
            { key = "showCmcBlightsSpread", default = true, renderer = "checkbox" },
...
local categoryMap = {
    ...
    showCmcDiseasedCreaturesCured = { s = catStorages.magic, g = "showAllMagic" },
    showCmcBlightedCreaturesCured = { s = catStorages.magic, g = "showAllMagic" },
    showCmcDiseasesSpread = { s = catStorages.magic, g = "showAllMagic" },
    showCmcBlightsSpread = { s = catStorages.magic, g = "showAllMagic" },
...
module.resetToggles = {
    { toggle = "resetStats", storage = catStorages.stats, keys = {
        "questCount", "deathCount", "luckPenaltyForgivenDeaths", "mostGold", "totalGoldFound",
    ...
    { toggle = "resetInteractions", storage = catStorages.interact, keys = {
        ...
        "peopleMet", "peopleMetStr", "slavesFreed", "slavesFreedStr",
    }},
    ...
    { toggle = "resetMagic", storage = catStorages.magic, keys = {
        ...
        "blackSoulsTrapped", "spellEffectsLearned", "spellEffectsSeenStr",
        "cmcDiseasedCreaturesCured", "cmcBlightedCreaturesCured",
        "cmcDiseasesSpread", "cmcBlightsSpread", "spellTallyStr",
    }},

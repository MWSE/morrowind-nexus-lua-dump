...
config.skills = {
    painting = {
        ...
        name = "Рисование",
        value = 10,
        description = "Навык Рисование позволяет рисовать на пергаменте и писать картины на холсте. По мере развития навыка ваши картины становятся более детализированными и имеют более высокую цену.",

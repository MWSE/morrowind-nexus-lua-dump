...
local function scanInv(reset)
   ...
   local vfxActive = showGlasses and activeSkins and cam ~= MD.first and headIsOurs()
...
return {
   engineHandlers = { onUpdate = onUpdate, onFrame = onFrame, onInit = onInit, onActive = onActive },
   eventHandlers  = {

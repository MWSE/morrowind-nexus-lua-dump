...
local function setShowearrings(val)
  ...
  if val and #availearrings > 0 and earringsSettings:get('EARBUFFS') then
...
local function onFrame(dt)
  ...
  local showKeyCode   = settingsEAR:get('EARShow')
  local changeKeyCode = settingsEAR:get('EARChange')

  local earVarKeyDown = showKeyCode   and input.isKeyPressed(showKeyCode)   or false

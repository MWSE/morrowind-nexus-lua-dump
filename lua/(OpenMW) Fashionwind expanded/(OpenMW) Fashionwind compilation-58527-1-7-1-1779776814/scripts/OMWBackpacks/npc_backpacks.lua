-- npc_backpacks.lua
-- NPC local script: shows cosmetic backpacks as visible 3D items on NPCs.
--
-- Scans the NPC's inventory for any known backpack item and attaches
-- the corresponding _skins.nif to the 'Backpack1' bone via addVfx.
-- Only the first matching item found is shown.
--
-- OMWSCRIPTS ENTRY:
--   NPC: scripts/yourmod/npc_backpacks.lua
...
local function scanInv(force)
    ...
    vfxBackpacks.boneName = VFX_BONE
    anim.addVfx(self, skins, vfxBackpacks)
end

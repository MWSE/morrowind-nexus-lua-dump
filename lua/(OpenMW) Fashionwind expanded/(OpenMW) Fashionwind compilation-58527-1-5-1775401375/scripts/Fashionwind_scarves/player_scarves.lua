...
local function setShowScarvesWithSpell(val, availScarves)
    ...
    if val and #scarves > 0 then
        applyScarfBuffs(self)   -- this already checks SKARFBUFFS internally
    else
        removeScarfBuffs(self)  -- always remove when hiding scarves
    end
end

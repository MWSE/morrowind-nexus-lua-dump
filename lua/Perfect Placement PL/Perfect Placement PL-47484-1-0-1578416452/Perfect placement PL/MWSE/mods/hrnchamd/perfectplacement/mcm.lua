...
function this.onCreate(parent)
    ...
    local summary = pane:createLabel{ text = "W widoku pierwszoosobowym u¿yj przycisku [Chwyæ / Upuœæ przedmiot] na przedmiocie, aby nim manipulowaæ." }
    ...
    local optionGuideLabel = optionGuide:createLabel{ text = "Wyœwietl pomoc na temat skrótów klawiszowych" }
    ...
    createKeybind(pane, "Podnoszenie / Upuszczanie przedmiotów", "keybind")
    createKeybind(pane, "Obracanie przedmiotów", "keybindRotate")

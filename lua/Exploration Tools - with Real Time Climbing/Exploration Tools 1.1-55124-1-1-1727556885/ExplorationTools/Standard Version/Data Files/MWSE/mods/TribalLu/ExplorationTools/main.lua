...
local function myPathmCallback(e)
	...
	local count3 = tes3.getItemCount({ reference = tes3.mobilePlayer, item = "trib_flint_01" })
	local count4 = tes3.getItemCount({ reference = tes3.mobilePlayer, item = "trib_flint_01" })
	if ( count > 0 ) then

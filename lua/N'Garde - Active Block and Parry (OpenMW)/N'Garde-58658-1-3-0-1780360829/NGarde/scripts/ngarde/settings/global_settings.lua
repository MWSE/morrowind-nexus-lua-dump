        ...
        settings = {
            ...
            },
            {
                ...
                argument = {
                    disabled = false,
                    l10n = modInfo.l10n,
                    items = SettingsConstants.fatigueEffectsFormulaValues
                }
            },
            {
                ...
                argument = {
                    disabled = false,
                    l10n = modInfo.l10n,
                    items = SettingsConstants.allowParryCreaturesValues
                }
            },
            {
            ...
            {
                key = SettingsConstants.allowArrowDeflectKey,
                renderer = 'checkbox',
                name = l10n('allow_arrow_deflect_setting_name'),
                description = l10n('allow_arrow_deflect_setting_desc'),
                default = SettingsConstants.allowArrowDeflectDefault,
                trueLabel = l10n('true_string'),
                falseLabel = l10n('false_string')
            },
            {
                key = SettingsConstants.playMissAnimationsKey,
                renderer = 'checkbox',
                name = l10n('play_miss_animtions_setting_name'),
                description = l10n('play_miss_animtions_setting_desc'),
                default = SettingsConstants.playMissAnimationsDefault,
                trueLabel = l10n('true_string'),
                falseLabel = l10n('false_string')
            },
            {

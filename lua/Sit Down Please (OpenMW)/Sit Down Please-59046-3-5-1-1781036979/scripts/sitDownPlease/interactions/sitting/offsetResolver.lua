-- interactions/sitting/offsetResolver.lua
---@omw-context all
...
local NORMALIZATION_FILE = "furnitureProfiles/sdp/global/animationNormalizationOffsets.txt"
...
local FALLBACK_ANIMATION_NORMALIZATION_OFFSETS = {
    sitting = {
        ...
        -- SDP arms-on-knees seating anchor.
        sdpvasitting6 = {

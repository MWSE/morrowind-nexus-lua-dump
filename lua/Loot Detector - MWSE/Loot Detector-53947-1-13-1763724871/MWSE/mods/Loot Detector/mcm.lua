...
FindingValueContainer = category0:createOnOffButton({
	label = 'Finding "Value" in a container',
	description = 'This is an old version of the condition for displaying icons on a container.\n\nOnly search items in a container if they match the "Value".\n\nThis only includes the "From Containers", "From Organic Containers", "From NPCs", and "From Creatures" settings.\n\nDefault: Off.',
	variable = mwse.mcm:createTableVariable{id = 'FindingValueContainer', table = config}
})
--////////////////////////////////////////////////////////////////////////////////////////
...
GoldValue = category4:createSlider({
	label = 'Gold min',
	description = 'Works only with the "Finding "Value" in a container" setting disabled.',
	min = 0,
	max = 100000,
	step = 1,
	jump = 5,
	variable = mwse.mcm.createTableVariable{id = 'GoldValue', table = config },
})
...
GoldValueOwner = category41:createSlider({
	label = 'Gold min',
	description = 'Works only with the "Finding "Value" in a container" setting disabled.',
	min = 0,
	max = 100000,
	step = 1,
	jump = 5,
	variable = mwse.mcm.createTableVariable{id = 'GoldValueOwner', table = config },
})

...
local objType = {tes3.objectType.door,tes3.objectType.container,tes3.objectType.light,tes3.objectType.book,tes3.objectType.alchemy,tes3.objectType.ammunition,
				tes3.objectType.apparatus,tes3.objectType.armor,tes3.objectType.clothing,tes3.objectType.enchantment,tes3.objectType.ingredient,
				tes3.objectType.lockpick,tes3.objectType.miscItem,tes3.objectType.probe,tes3.objectType.repairItem,tes3.objectType.spell,tes3.objectType.weapon}
...
local function BlacklistCells()
    ...
    if not config.CellsBL[cell.id:lower()] then
        ...
        config.CellsBL[cell.id:lower()] = false

...
local function getCurrentSettings()
    ...
    local pause = settings:get('stop_the_mod') or false
...
local function pause()
    return currentSettings.PAUSE and (I.UI.getMode() or core.isWorldPaused()) or false
end
...
local function onFrame(dt)
    ...
    local gameTime = core.getRealTime()
    ...
    if isTransitioning then
        ...
        local t = math.min(1, elapsedTime / (currentSettings.TRANSITION_DURATION ))

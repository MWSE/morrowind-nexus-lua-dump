local cf = mwse.loadConfig("PvP", {animsw = true, npcsw = true, agil = 1, pvp1 = true, par = true, duel = true, aspd = true, tim = true, dodkey = {keyCode = 54},
hitr = 0, vol = 0.8, cofat = 0.5, comult = 1, dodcost = 30, parind = true, m3 = false})
...
local p, mp, ad, wc, ic, MB, PST		local DOM = {}		local L = {}	local T = {Dom = timer, Tim = timer, EDMG = timer}		local N = {}	local AF = {}	local M = {}	local G = {}	local W = {}

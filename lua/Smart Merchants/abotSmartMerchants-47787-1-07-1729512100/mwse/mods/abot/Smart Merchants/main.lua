...
buyMulPerc = 100, -- buy from vendor price percent multiplier (default/disabled = 100)
...
Default/disabled = 100, suggested]] .. suggestedIf .. ': 250 = 2.5 X.',
		variable = createConfigVariable("buyMulPerc")
		,min = 100, max = 500
	}
...
Default/disabled = 100, suggested]] .. suggestedIf .. ': 20 = 0.2 X.',
		variable = createConfigVariable("sellMulPerc")
		,min = 20, max = 100
	}

...
persistentSkillsUpgrades = false, -- merchants/trainers skills upgrade type false = on the fly, true = persistent
...
harderBuyingPrices = 0, -- Harder Barter like merchants buying prices reduction 0 Disabled .. 4 Very High
...
tk[1] = 'upgradeTrainerNPCsSkills'
tk[2] = 'upgradeMerchantNPCsSkills'
tk[3] = 'persistentSkillsUpgrades'
tk[4] = 'atLeastPlayerLevel'
tk[5] = 'skillLevelBase'
tk[6] = 'skillLevelMultiplier'
tk[7] = 'fBargainOfferBase'
tk[8] = 'creatureBargainLevel'
tk[9] = 'harderMerchantsBuyingPrices'
tk[10] = 'fBargainOfferMulti'
tk[11] = 'fBribe10Mod'
tk[12] = 'fBribe100Mod'
tk[13] = 'fBribe1000Mod'
tk[14] = 'iBarterSuccessDisposition'
tk[15] = 'fDispBargainSuccessMod_X100'
...
local dbug = 1 -- 0 = no debug, 1 = log, 2 = message, 3 = log + message, 4 = messagebox, 5 = log + messagebox
...
local function modConfigReady()
	...
	toggles:createOnOffButton{
		...
		description = "Toggle merchants/trainers skill upgrades to be persistent (base value changes) or on-the-fly (current dialog only)",
	...
	controls:createSlider{
		...
		description = "If greater than 0, fBargainOfferBase and max(creature bargain level, creature level) affect prices when selling to creatures (game default: 0, suggested: 10)",
	...
	controls:createDropdown{
		...
		description = "Default: 0. Disabled. Greatly reduces merchants buying prices for expensive items."
		.."\n if unitPrice = totalPrice / units > 10 then"
		.."\n1. Low - Squared root base 10 logarithmic --> totalPrice / sqrt(base 10 logarithm(unitPrice))"
		.."\n2. Medium - Base 10 logarithmic --> totalPrice / base 10 logarithm(unitPrice)"
		.."\n3. High - Squared root natural logarithmic --> totalPrice / sqrt(natural logarithm(unitPrice))"
		...
		options = {
			...
			{ label = "2. Medium - Base 10 logarithmic", value = 2 },
			{ label = "3. High - Squared root natural logarithmic", value = 3 },
...
local function adjustTrainerSkills(mobile)
	...
	--- dm(string.format("skill1 = %s, skill2 = %s, skill3 = %s\n", skill1, skill2, skill3))
	local skillLevel = (level * config.skillLevelMultiplier) + config.skillLevelBase
	skillNew = skill3 - 1

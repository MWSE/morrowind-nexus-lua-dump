...
local function registerModConfig()
    ...
    settings:createKeyBinder{
        label = "Hot Key",
        description = "Hold down this key while looking at a creature or NPC to activate the Hostility Indicator.",
        variable = mwse.mcm.createTableVariable{ id = "hotkey", table = mcmConfig},
        allowCombinations = false,
    }
    settings:createSlider{
        label = "Max Distance for Indicator",
        description = "The maximum distance between the player and an NPC/Creature that the Hostility Indicator can be activated.",
        min = 1000,
        max = 10000,
        step = 100,
        jump = 1000,

...
local category = page:createCategory("Settings")
	...
	category:createSlider({
	label = "Delay",
	description = "Delay to disable after attack event starts, tenths of a second",
	min = 1,
	max = 10,
	step = 1,
	jump = 2,
	variable = mwse.mcm.createTableVariable{id = "delay", table = config },
})
category:createSlider({
	label = "Distance",
	description = "Maximum distance from web for attack",
	min = 1,
	max = 200,
	step = 1,
	jump = 10,

...
local version = "1.5.2-LevelIndicator"
...
local function updateBars()
	if isValidTarget(currentTarget) then
		if cachedBarMenu then
			-- Name
			cachedHealthBarLabel.text = "(" .. tostring(currentTarget.object.level) .. ")" .. " " .. currentTarget.object.name  -- this be the FaNcY level indicator of this mod! -- format this to use the format of string.format's format so that ican more easily format it later 

...
local pageMagic = createPage("Звуки магии")
...
categoryCombat:createOnOffButton{
	label = "Включить предсмертные звуки",
	description = "Включить предсмертные звуки\n\nОпределяет, будет ли диалог NPC прерван и заменен стоном при смерти.\n\nПо умолчанию: Включено",
...
local categoryMagic = pageMagic:createCategory{
	label = "Настройки звуков магии",
	description = ""
}
categoryMagic:createOnOffButton{
	label = "Включить звуки магии",
	description = "Включить звуки магии\n\nОпределяет, будут ли воспроизводиться звуковые эффекты для заклинаний, создания заклинаний и зачарования.\n\nПо умолчанию: Включено",
	variable = mwse.mcm:createTableVariable{id = "magicSounds", table = config}
}
categoryMagic:createOnOffButton{
	label = "Включить расширенные звуки магии",
	description = "Включить расширенные звуки магии\n\nТРЕБУЕТСЯ ПЕРЕЗАГРУЗКА СОХРАНЕНИЯ\n\nОпределяет, будут ли воспроизводиться новые звуки для эффектов заклинаний. По умолчанию включает только звуки для заклинаний элементального урона и заклинаний элементальных щитов.\n\nПо умолчанию: Включено",
	variable = mwse.mcm:createTableVariable{id = "expandedMagicSounds", table = config}
}
categoryMagic:createOnOffButton{
	label = "Включить шум эффектов заклинаний",
	description = "Включить шум эффектов заклинаний\n\nОпределяет, могут ли эффекты заклинаний создавать слышимый шум. По умолчанию работает только для заклинаний типа 'Звук'.\n\nПо умолчанию: Включено",
	variable = mwse.mcm:createTableVariable{id = "spellNoise", table = config}
}
categoryMagic:createSlider{
	label = "Громкость магии игрока: %s%%",
	description = "Громкость магии игрока\n\nОпределяет громкость звуков при чтении игроком заклинаний, создании заклинаний, зачаровании.\n\nПо умолчанию: 60%",
	min = 0,
	max = 100,
	step = 1,
	jump = 10,
...
categoryMagic:createSlider{
	label = "Громкость магии NPC: %s%%",
	description = "Громкость магии NPC\n\nОпределяет громкость звуков заклинаний NPC и существ.\n\nПо умолчанию: 70%",
	min = 0,
	max = 100,
	step = 1,
	jump = 10,
...
categoryMagic:createSlider{
	label = "Громкость магических снарядов: %s%%",
	description = "Громкость магических снарядов\n\nОпределяет громкость магических снарядов, особенно заметно при зацикливании.\n\nDefault: 80%",
	min = 0,
	max = 100,
	step = 1,
	jump = 10,

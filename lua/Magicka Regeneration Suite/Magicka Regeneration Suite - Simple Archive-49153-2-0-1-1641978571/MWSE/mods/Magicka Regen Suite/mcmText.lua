 ...
 Hover over individual settings to see more information.]],
    ...
    regenerationFormula = {
        ...
        { label = "Logarithimic WILL", value = 3 },
    ...
    regenerationFormulasDescription = (
		...
		"Advanced - Provides logarithmic willpower or maximum magicka scaling for magicka regeneration speed. "..
		"See Advanced settings page for more info.\n\n"..
	...
	-- Logarithimic WILL settings page
	WILLFormula = (
		"Magicka % regenerated per second\n\n"..

		" = log(Willpower, base / 10) x (a / 10)\n\n"
	),
	...
	WILLa = (
		"\nRepresents a scaling factor in the formula.\n\n"..
	...
	INTFormula = (
		...
		" = (a / 100) x log(Intelligence, base / 100) - (b / 10)\n\n"
	),
	...
	INTb = (
		"\nRepresents a constant offset in the formula.\n\n"..

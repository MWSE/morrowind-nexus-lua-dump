...
do	-- Settings
	...
	do	-- Morrowind style regeneration settings page
		...
		morrowindSettingsPage:createSlider{
			...
			step = 1,
			jump = 10,
			variable = mwse.mcm.createTableVariable({ id = "magickaReturnBaseMorrowind", table = mcmConfig }),
		}
		...
		morrowindSettingsPage:createSlider{
			...
			step = 1,
			jump = 10,
			variable = mwse.mcm.createTableVariable({ id = "magickaReturnMultMorrowind", table = mcmConfig }),
		}
	...
	do -- Logarithimic WILL settings page
		...
		logarithmicWILLPage:createSlider{
			...
			step = 1,
			jump = 1,
			variable = mwse.mcm.createTableVariable({ id = "WILLBase", table = mcmConfig })
		}
		...
		logarithmicWILLPage:createSlider{
			...
			step = 1,
			jump = 1,
			variable = mwse.mcm.createTableVariable({ id = "WILLa", table = mcmConfig })
		}
		...
		logarithmicWILLPage:createYesNoButton{
			...
			variable = mwse.mcm.createTableVariable({ id = "WILLApplyCombatPenalty", table = mcmConfig })
		}
		logarithmicWILLPage:createSlider{
			label = "Combat Penalty: %s %%",
			description = text.combatPenalty,
			...
			step = 1,
			jump = 10,
			variable = mwse.mcm.createTableVariable({ id = "WILLCombatPenalty", table = mcmConfig })
		}
		...
		logarithmicWILLPage:createYesNoButton{
			...
			variable = mwse.mcm.createTableVariable({ id = "WILLUseFatigueTerm", table = mcmConfig })
		}
	end
	do -- Logarithimic INT settings page
		...
		logarithmicINTPage:createSlider{
			...
			step = 1,
			jump = 5,
			variable = mwse.mcm.createTableVariable({ id = "INTa", table = mcmConfig })
		}
		...
		logarithmicINTPage:createSlider{
			...
			step = 1,
			jump = 5,
			variable = mwse.mcm.createTableVariable({ id = "INTb", table = mcmConfig })
		}

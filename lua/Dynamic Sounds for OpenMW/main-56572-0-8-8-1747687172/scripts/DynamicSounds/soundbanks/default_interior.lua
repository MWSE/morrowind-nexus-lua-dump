...
local soundbank = {
    ...
    ambientLoopSounds = {
        ...
        
        {
			...
			volume = 1.5, 
			weather = {4,5}, 
			ifCellContainsObjects = "in_nord_house,in_c_plain_room,in_hlaalu_roomt,common_tower_thatch,MGRD_AR_I,in_redoran_,in_v_s_wall,in_hlaalu_room"
        },
        {
        ...
        },        
        {
            ...
            weather = {4,5}, 
            volume = 0.7,
            ifCellContainsObjects = "in_de_shack,_tent_interior"
        },
        {
            ...
            ifCellContainsObjects = "in_nord_house,in_c_plain_room,in_hlaalu_roomt,in_de_shack,common_tower_thatch,MGRD_AR_I,in_redoran_,in_v_s_wall,in_hlaalu_room,_tent_interior"
        },
        {

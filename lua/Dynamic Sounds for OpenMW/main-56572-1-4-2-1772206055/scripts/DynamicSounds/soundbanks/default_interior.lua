...
local soundbank = {
    ...
    ambientLoopSounds = {
        ...
        
        {
			...
			weather = {4,5}, 
			volume = 1.5, 
			ifCellContainsObjects = "in_nord_house,in_c_plain_room,in_hlaalu_hall,common_tower_thatch,MGRD_AR_I,in_redoran_,in_v_s_wall,in_hlaalu_room,in_c_rich_room",            
        },
        {
        ...
        {
            soundPath = "sounds\\DynamicSounds\\weather\\int_wind_lt_lp.wav",
            loop = true,
            volume=0.3,
            weather = {6,7,9}, 
            ifCellContainsObjects = "_tent_interior,ashl_tent",
        ...
        },	        
        {
            ...
            ifCellContainsObjects = "in_nord_house,in_c_plain_room,in_hlaalu_hall,in_de_shack,common_tower_thatch,MGRD_AR_I,in_redoran_,in_v_s_wall,in_hlaalu_room,_tent_interior,ashl_tent,in_c_rich_room"
        },
        {
    ...
    objects = {
        ...
        },         
        {
            ...
            {
                {
                    soundPath = "sounds\\DynamicSounds\\human\\flesh_lp.wav", 
					loop = true,
                },
            }
        },          

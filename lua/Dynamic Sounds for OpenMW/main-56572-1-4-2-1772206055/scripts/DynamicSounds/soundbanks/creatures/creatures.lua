...
local creaturesSoundBank = {
    ...
    
    {
        creatureId = "bonelord",  
        aware = {
            sound = "sounds\\DynamicSounds\\creatures\\bonelord_aware.wav",
            volume = 1,
            timeOffset = 0,           
        }, 
    },  
    ...
    {
        creatureId = "centurion_sphere",  
        aware = {
            sound = "sounds\\DynamicSounds\\creatures\\centurion_sphere_aware.wav",
            volume = 1,
            timeOffset = 0,           
        }, 
    },  
    
    {
        ...
        aware = {
            sound = "sounds\\DynamicSounds\\creatures\\centurion_steam_aware.wav",
            volume = 1,
            timeOffset = 0,           
        }, 
    },      
    
    {
        ...
        aware = {
            sound = "sounds\\DynamicSounds\\creatures\\ascended_sleeper_aware.wav",
            volume = 1,
            timeOffset = 0,           
        }, 
        sounds = {
            {
                animGroupName = "*",
                animSound = "sounds\\DynamicSounds\\creatures\\ascended_sleeper_death.wav",
                loopSound = false,
                volume = 1,
                timeOffset = 0,
                replaceOriginalSound = "body fall large",
            ...
            {
                animGroupName = "*",
                animSound = "sounds\\DynamicSounds\\creatures\\ascended_sleeper_pain.wav",
                loopSound = false,
                volume = 1,
                timeOffset = 0,
    ...
    
    {
        ...
        sounds = {
            ...
            },
            {
                ...
                volume = 1,
                timeOffset = 0,
                exceptAnimGroups="death1,death2,death3,death4,death5,deathknockdown,deathknockout",
            },                                
        },
    },     
...

    {
     ...
     {
        creatureId = "vivec_god",
        sounds = {
            {
                animGroupName = "idle2",
                animSound = "sounds\\DynamicSounds\\creatures\\vivec_idle.wav",
                loopSound = true,
                volume = 1,
                timeOffset = 0,
            },   

local soundbank = {
    ...
    ambientLoopSounds = {
        {
            soundPath = "sounds\\DynamicSounds\\cities\\amb_town_large_day_lp.wav",
            loop = true,
            volume = 0.7,
        },        
        {
        ...
        {
            soundPath = "sounds\\DynamicSounds\\cities\\amb_churchbls_os_002.wav", 
			loop = false, 
    		PlayChancePercent = 25
        },        
        {
            soundPath = "sounds\\DynamicSounds\\cities\\amb_os_rooster_002.wav",
            loop = false,
            PlayChancePercent = 40
        },        
    ...
    objects = {
        {
            ...
            {
                {
                    soundPath = "sounds\\DynamicSounds\\taverns\\amb_inn_outside_lp.wav", 
					volume = 1.5, 
					loop = true, 

...
local config = mwse.loadConfig('MWCA_config') or {stayOpen = true, playSound = true, items = 0, animTimeToWait = 100, barrelRivet = true, version = 2.07};
...
local function OnInitialized(eventData)
	...
	mwse.log("[MW Containers Animated v2.07] lua loaded");
end

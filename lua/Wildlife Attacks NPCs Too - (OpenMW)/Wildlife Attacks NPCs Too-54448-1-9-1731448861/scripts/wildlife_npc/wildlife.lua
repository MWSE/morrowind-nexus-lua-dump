...
-- To (des)activate the blacklist, see my explanation below in the code.
local NPCsBlacklist = {

	-- Silt Strider Caravaneers:
	["seldus nerendus"] = true,
	["daras aryon"] = true,
	--["folsi thendas"] = true, ﻿-- optional...
	--
	-- NPCs in the Wilderness:
	["falanu indaren"] = true,
	["drerel indaren"] = true,
	["thoronor"] = true,
	["edras oril"] = true,
	["athanden girith"] = true,
	["lette"] = true,
	--﻿["﻿tinos drothan"] = true, -- optional...
	--
	-- NPCs in Dungeons:
...
local function wildlifeAtk()
  ...
  if old_API then
	...
	-- To desactivate the blacklist, add "--" at the begining of the next line.

...
function this.onItemTileUpdated(e)
    ...
    e.element:registerBefore(tes3.uiEvent.mouseClick, function()
...
function this.onSetActive()
  ...
  event.register(tes3.event.itemTileUpdated, this.onItemTileUpdated, { filter = "MenuContents" })
...
function this.onSetInactive()
  ...
  event.unregister(tes3.event.itemTileUpdated, this.onItemTileUpdated, { filter = "MenuContents" })
	event.unregister(tes3.event.save, this.onSave)

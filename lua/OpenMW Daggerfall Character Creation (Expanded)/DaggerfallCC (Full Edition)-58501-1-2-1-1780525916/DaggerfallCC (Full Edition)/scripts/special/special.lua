...
-- OpenMW applies Fortify Attribute/Skill abilities directly to base stats.
-- These maps are intentionally empty now; saved values are still used by the
-- migration path to undo the old scripted layer exactly once.
local attributeBaseModifiersByAbilityId = {}

local attributeDisplayModifiersByAbilityId = {
   special_robust = { id = 'endurance', delta = 10 },
   special_strong = { id = 'strength', delta = 10 },
   special_agile = { id = 'agility', delta = 10 },
   special_fast = { id = 'speed', delta = 10 },
   special_charismatic = { id = 'personality', delta = 10 },
   special_intelligent = { id = 'intelligence', delta = 10 },
   special_resolute = { id = 'willpower', delta = 10 },
   special_lucky = { id = 'luck', delta = 10 },
   special_fragile = { id = 'endurance', delta = -10 },
   special_weak = { id = 'strength', delta = -10 },
   special_clumsy = { id = 'agility', delta = -10 },
   special_slow = { id = 'speed', delta = -10 },
   special_uncharismatic = { id = 'personality', delta = -10 },
   special_stupid = { id = 'intelligence', delta = -10 },
   special_irresolute = { id = 'willpower', delta = -10 },
   special_unlucky = { id = 'luck', delta = -10 },
   special_small_frame = {
      { id = 'agility', delta = 10 },
      { id = 'endurance', delta = -10 },
   },
}

local conditionalAttributeBaseModifiersByAbilityId = {}

local skillBaseModifiersByAbilityId = {}

local nonCombatSkillIds = {
   heavyarmor = true,
   mediumarmor = true,
   acrobatics = true,
   armorer = true,
...
local skillDisplayModifiersByAbilityId = {
   special_proficient_in_heavy_armor = { id = 'heavyarmor', delta = 20 },
   special_proficient_in_medium_armor = { id = 'mediumarmor', delta = 20 },
   special_proficient_in_spear = { id = 'spear', delta = 20 },
   special_proficient_in_acrobatics = { id = 'acrobatics', delta = 20 },
   special_proficient_in_armorer = { id = 'armorer', delta = 20 },
   special_proficient_in_axe = { id = 'axe', delta = 20 },
   special_proficient_in_blunt_weapon = { id = 'bluntweapon', delta = 20 },
   special_proficient_in_long_blade = { id = 'longblade', delta = 20 },
   special_proficient_in_block = { id = 'block', delta = 20 },
   special_proficient_in_light_armor = { id = 'lightarmor', delta = 20 },
   special_proficient_in_marksman = { id = 'marksman', delta = 20 },
   special_proficient_in_sneak = { id = 'sneak', delta = 20 },
   special_proficient_in_athletic = { id = 'athletics', delta = 20 },
   special_proficient_in_handtohand = { id = 'handtohand', delta = 20 },
   special_proficient_in_short_blade = { id = 'shortblade', delta = 20 },
   special_proficient_in_unarmored = { id = 'unarmored', delta = 20 },
   special_proficient_in_illusion = { id = 'illusion', delta = 20 },
   special_proficient_in_mercantile = { id = 'mercantile', delta = 20 },
   special_proficient_in_speechcraft = { id = 'speechcraft', delta = 20 },
   special_proficient_in_alchemy = { id = 'alchemy', delta = 20 },
   special_proficient_in_conjuration = { id = 'conjuration', delta = 20 },
   special_proficient_in_enchant = { id = 'enchant', delta = 20 },
   special_proficient_in_security = { id = 'security', delta = 20 },
   special_proficient_in_alteration = { id = 'alteration', delta = 20 },
   special_proficient_in_destruction = { id = 'destruction', delta = 20 },
   special_proficient_in_mysticism = { id = 'mysticism', delta = 20 },
   special_proficient_in_restoration = { id = 'restoration', delta = 20 },
   special_inept_at_heavy_armor = { id = 'heavyarmor', delta = -100 },
   special_inept_at_medium_armor = { id = 'mediumarmor', delta = -100 },
   special_inept_at_spear = { id = 'spear', delta = -100 },
   special_inept_at_acrobatics = { id = 'acrobatics', delta = -100 },
   special_inept_at_armorer = { id = 'armorer', delta = -100 },
   special_inept_at_axe = { id = 'axe', delta = -100 },
   special_inept_at_blunt_weapon = { id = 'bluntweapon', delta = -100 },
   special_inept_at_long_blade = { id = 'longblade', delta = -100 },
   special_inept_at_block = { id = 'block', delta = -100 },
   special_inept_at_light_armor = { id = 'lightarmor', delta = -100 },
   special_inept_at_marksman = { id = 'marksman', delta = -100 },
   special_inept_at_sneak = { id = 'sneak', delta = -100 },
   special_inept_at_athletic = { id = 'athletics', delta = -100 },
   special_inept_at_handtohand = { id = 'handtohand', delta = -100 },
   special_inept_at_short_blade = { id = 'shortblade', delta = -100 },
   special_inept_at_unarmored = { id = 'unarmored', delta = -100 },
   special_inept_at_illusion = { id = 'illusion', delta = -100 },
   special_inept_at_mercantile = { id = 'mercantile', delta = -100 },
   special_inept_at_speechcraft = { id = 'speechcraft', delta = -100 },
   special_inept_at_alchemy = { id = 'alchemy', delta = -100 },
   special_inept_at_conjuration = { id = 'conjuration', delta = -100 },
   special_inept_at_enchant = { id = 'enchant', delta = -100 },
   special_inept_at_security = { id = 'security', delta = -100 },
   special_inept_at_alteration = { id = 'alteration', delta = -100 },
   special_inept_at_destruction = { id = 'destruction', delta = -100 },
   special_inept_at_mysticism = { id = 'mysticism', delta = -100 },
   special_inept_at_restoration = { id = 'restoration', delta = -100 },
}

local goodNaturedDisplayModifiers = {
   { id = 'spear', delta = -10 },
   { id = 'axe', delta = -10 },
   { id = 'bluntweapon', delta = -10 },
   { id = 'longblade', delta = -10 },
   { id = 'marksman', delta = -10 },
   { id = 'handtohand', delta = -10 },
   { id = 'shortblade', delta = -10 },
   { id = 'mysticism', delta = -10 },
   { id = 'destruction', delta = -10 },
}

for skillId, _ in pairs(nonCombatSkillIds) do
   table.insert(goodNaturedDisplayModifiers, { id = skillId, delta = 5 })
end

skillDisplayModifiersByAbilityId.special_good_natured = goodNaturedDisplayModifiers
...
local daggerCCStorage = storage.playerSection('Specials_DaggerCC')
local appliedMaxHp = 8
local appliedBaseModifiers = { attributes = {}, skills = {} }
local appliedConditionalBaseModifiers = { attributes = {}, skills = {} }
local pendingBaseModifierMigration = false
local pendingSpecialsApplication = false
...
local function addBaseModifier(modifiers, id, delta)
   modifiers[id] = (modifiers[id] or 0) + delta
end

local function addMappedBaseModifiers(modifiers, mappedModifiers)
   if not mappedModifiers then return end
   if mappedModifiers.id then
      addBaseModifier(modifiers, mappedModifiers.id, mappedModifiers.delta)
      return
   end

   for _, modifier in ipairs(mappedModifiers) do
      addBaseModifier(modifiers, modifier.id, modifier.delta)
   end
end

local function collectSpecialBaseModifiers(special, modifiers)
   addMappedBaseModifiers(modifiers.attributes, attributeBaseModifiersByAbilityId[special.abilityId])
   addMappedBaseModifiers(modifiers.skills, skillBaseModifiersByAbilityId[special.abilityId])
end

local function collectScriptedBaseModifiers()
   local modifiers = { attributes = {}, skills = {} }
   for _, advantage in ipairs(specials.advantages) do
      collectSpecialBaseModifiers(advantage, modifiers)
   end
   for _, disadvantage in ipairs(specials.disadvantages) do
      collectSpecialBaseModifiers(disadvantage, modifiers)
   end
   return modifiers
end

local function collectSpecialDisplayModifiers(special, modifiers)
   addMappedBaseModifiers(modifiers.attributes, attributeDisplayModifiersByAbilityId[special.abilityId])
   addMappedBaseModifiers(modifiers.skills, skillDisplayModifiersByAbilityId[special.abilityId])
end

local function collectDaggerCCSpecialModifiers()
   local modifiers = { attributes = {}, skills = {} }
   for _, advantage in ipairs(specials.advantages) do
      collectSpecialDisplayModifiers(advantage, modifiers)
   end
   for _, disadvantage in ipairs(specials.disadvantages) do
      collectSpecialDisplayModifiers(disadvantage, modifiers)
   end
   return modifiers
end

local function adjustStatBase(accessors, id, delta)
   if delta == 0 then return end
   local accessor = accessors[id]
   if not accessor then
      print('Cannot apply scripted special modifier: missing stat accessor ' .. tostring(id))
      return 0
   end

   local stat = accessor(self)
   if not stat or stat.base == nil then
      print('Cannot apply scripted special modifier: missing stat ' .. tostring(id))
      return 0
   end

   local newBase = math.max(0, stat.base + delta)
   local appliedDelta = newBase - stat.base
   stat.base = newBase

   if stat.current ~= nil then
      local newCurrent = math.max(0, stat.current + appliedDelta)
      pcall(function() stat.current = newCurrent end)
   end

   return appliedDelta
end

local function applyBaseModifierSet(modifiers, sign)
   local applied = { attributes = {}, skills = {} }
   for id, delta in pairs(modifiers.attributes or {}) do
      local appliedDelta = adjustStatBase(types.Actor.stats.attributes, id, delta * sign)
      if appliedDelta ~= 0 then
         applied.attributes[id] = appliedDelta
      end
   end
   for id, delta in pairs(modifiers.skills or {}) do
      local appliedDelta = adjustStatBase(types.NPC.stats.skills, id, delta * sign)
      if appliedDelta ~= 0 then
         applied.skills[id] = appliedDelta
      end
   end
   return applied
end

local function clearScriptedBaseModifiers()
   applyBaseModifierSet(appliedBaseModifiers, -1)
   appliedBaseModifiers = { attributes = {}, skills = {} }
end

local function applyScriptedBaseModifiers()
   clearScriptedBaseModifiers()
   appliedBaseModifiers = applyBaseModifierSet(collectScriptedBaseModifiers(), 1)
end

local function clearConditionalBaseModifiers()
   applyBaseModifierSet(appliedConditionalBaseModifiers, -1)
   appliedConditionalBaseModifiers = { attributes = {}, skills = {} }
end

local function collectConditionalBaseModifiers()
   local modifiers = { attributes = {}, skills = {} }
   if not self.cell or self.cell.isExterior then
      return modifiers
   end

   for _, special in ipairs(insidesOutsides) do
      addMappedBaseModifiers(
         modifiers.attributes,
         conditionalAttributeBaseModifiersByAbilityId[special.abilityIdWhenInside]
      )
   end
   return modifiers
end

local function applyConditionalBaseModifiers()
   clearConditionalBaseModifiers()
   appliedConditionalBaseModifiers = applyBaseModifierSet(collectConditionalBaseModifiers(), 1)
end

local function hasAppliedBaseModifiers(modifiers)
   for _, delta in pairs(modifiers.attributes or {}) do
      if delta ~= 0 then return true end
   end
   for _, delta in pairs(modifiers.skills or {}) do
      if delta ~= 0 then return true end
   end
   return false
end

local function migrateOldScriptedBaseModifiers()
   if not pendingBaseModifierMigration then return end

   if hasAppliedBaseModifiers(appliedBaseModifiers) then
      print('Removing old scripted permanent Specials base modifiers; OpenMW abilities now own these stats')
      applyBaseModifierSet(appliedBaseModifiers, -1)
      appliedBaseModifiers = { attributes = {}, skills = {} }
   end

   if hasAppliedBaseModifiers(appliedConditionalBaseModifiers) then
      print('Removing old scripted conditional Specials base modifiers; OpenMW abilities now own these stats')
      applyBaseModifierSet(appliedConditionalBaseModifiers, -1)
      appliedConditionalBaseModifiers = { attributes = {}, skills = {} }
   end

   pendingBaseModifierMigration = false
end
...
local function applySpecials()
   ...
   applyScriptedBaseModifiers()
   applyConditionalBaseModifiers()
...
local function shouldDelaySpecialsForDaggerCC()
   local ok, daggerCC = pcall(function() return I.DaggerCC end)
   if not ok or not daggerCC or not daggerCC.shouldWaitForDone then
      return false
   end

   local waitOk, shouldWait = pcall(daggerCC.shouldWaitForDone)
   return waitOk and shouldWait == true
end

local function requestSpecialsApplication()
   local completePayload = {
      specialModifiers = collectDaggerCCSpecialModifiers(),
   }
   daggerCCStorage:set('specialModifiers', completePayload.specialModifiers)

   if shouldDelaySpecialsForDaggerCC() then
      pendingSpecialsApplication = true
      destroyApplyElement()
      core.sendGlobalEvent('SpecialsComplete', completePayload)
      return
   end
...
local function applyPendingSpecialsForDaggerCC()
   if not pendingSpecialsApplication then
      return false
   end

   pendingSpecialsApplication = false
   applySpecials()
   return true
end

local function onDaggerCCChargenComplete()
   applyPendingSpecialsForDaggerCC()
end
   ...
   if enableApplyButton then
      content:add(TextButton:new({
         ...
         events = {
            ...
            mouseClick = requestSpecialsApplication,
         },
         props = {
...
local function onUpdate(dt)
   ...
   migrateOldScriptedBaseModifiers()
...
local function onSave()
   return {
      ...
      appliedBaseModifiers = appliedBaseModifiers,
      appliedConditionalBaseModifiers = appliedConditionalBaseModifiers,
   }
end
...
local function onLoad(data)
   ...
   if data.appliedBaseModifiers then
      appliedBaseModifiers = data.appliedBaseModifiers
      if hasAppliedBaseModifiers(appliedBaseModifiers) then
         pendingBaseModifierMigration = true
      end
   end
   if data.appliedConditionalBaseModifiers then
      appliedConditionalBaseModifiers = data.appliedConditionalBaseModifiers
      if hasAppliedBaseModifiers(appliedConditionalBaseModifiers) then
         pendingBaseModifierMigration = true
      end
   end
...
return {
   interfaceName = 'Specials',
   interface = {
      apiVersion = 1,
      applyPendingForDaggerCC = applyPendingSpecialsForDaggerCC,
   },
   engineHandlers = {
   ...
   eventHandlers = {
      ...
      DaggerCC_ChargenComplete = onDaggerCCChargenComplete,
   },
}

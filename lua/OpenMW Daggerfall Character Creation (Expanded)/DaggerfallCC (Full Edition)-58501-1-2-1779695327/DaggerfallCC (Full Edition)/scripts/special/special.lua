...
local attributeBaseModifiersByAbilityId = {
   ...
   special_small_frame = { id = 'endurance', delta = -10 },
}
...
local conditionalAttributeBaseModifiersByAbilityId = {
   special_claustrophobia_inside = {
      { id = 'strength', delta = -10 },
      { id = 'intelligence', delta = -10 },
      { id = 'willpower', delta = -10 },
      { id = 'agility', delta = -10 },
      { id = 'speed', delta = -10 },
      { id = 'endurance', delta = -10 },
      { id = 'personality', delta = -10 },
      { id = 'luck', delta = -10 },
   },
}

...
local minHpPerLevel = 4
local maxHpPerLevel = 30
local defaultHpPerLevel = 8
...
function AdvantagesDisadvantages:isNotEmpty()
   return self.maxHp ~= defaultHpPerLevel or #self.advantages ~= 0 or #self.disadvantages ~= 0
end

function AdvantagesDisadvantages:cost()
   local cost = self.maxHp - defaultHpPerLevel
...
return {
   ...
   minHpPerLevel = minHpPerLevel,
   maxHpPerLevel = maxHpPerLevel,
   defaultHpPerLevel = defaultHpPerLevel,

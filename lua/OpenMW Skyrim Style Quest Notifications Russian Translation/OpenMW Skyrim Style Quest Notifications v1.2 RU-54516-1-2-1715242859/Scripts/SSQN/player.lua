...
local soundfiles = {
	...
	["Нет"] = nil, ["Пользовательский"] = "custom", ["Такой же"] = "same"
	}
	...
	},
	{
	...
	},
      {
      ...
      },
        {
            ...
            description = 'Выберите звук уведомления о завершении задания.\n\nПо умолчанию: такой же, как при старте',
            default = 'Такой же', 
            renderer = 'select',
            argument = {
                disabled = false,
                l10n = 'LocalizationContext', 
                items = { "Квест Skyrim", "Колокол Шестого Дома", "Поднятие уровня", "Магический эффект", "Квест Oblivion", "Скальный наездник", "Нет", "Пользовательский", "Такой же" },
            },
	},
      {
         key = 'soundcustomfin',

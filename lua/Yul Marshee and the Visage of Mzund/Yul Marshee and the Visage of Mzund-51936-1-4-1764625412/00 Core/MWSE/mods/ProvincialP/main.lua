...
--condition to only process this function when the airship door PP_Airship_Door_MWSE is activated
if tes3.getGlobal("PP_SimulEnable") >= 1 then
--
...
function Button1PressedCallback(e)
    if e.button == 0 then
	--global is set here to enable processing of the simul function
	tes3.setGlobal("PP_SimulEnable", 1)
	--

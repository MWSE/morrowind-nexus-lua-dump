...
I.Settings.registerGroup {
    key              = 'SettingsWReqD',
    page             = 'WeaponRequirementsDebuff',
    l10n             = 'WeaponRequirementsDebuff',

local cf = mwse.loadConfig("DragonDoor!", {m = false, nost = true, nor = 200, acs = 800, help = true, vamp = true, nosav = true, hdist = 3000, skey = {keyCode = 56}})
...
if not H[r] and (m.actorType == 1 and m.flee < 70 and (cf.vamp or not r.baseObject.head.vampiric) or ((m.object.biped or m.object.usesEquipment or HandyCr[bid]) and not Summon[bid]))

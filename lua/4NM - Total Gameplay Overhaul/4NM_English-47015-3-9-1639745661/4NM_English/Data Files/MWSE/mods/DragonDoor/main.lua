...
if e.activator == p then	list = "You are haunted by: "	count = 0
	...
	Dtim = true		--if Dtim then Dtim:cancel() end		Dtim = timer.start{duration = 0.3, callback = function() Dtim = nil end}
...
end		Dtim = nil	end		event.register("cellChanged", cellChanged)

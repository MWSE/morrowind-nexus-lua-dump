	...
	for r, t in pairs(H) do
		if t.safe:valid() then
			...
			elseif t.status == 3 then
				...
				elseif not AC[t.scell] then tes3.positionCell{cell = t.scell, position = t.spos, reference = r}		H[r] = nil	mp:exerciseSkill(19, 1 + r.object.level/10)			--[C]: in function 'positionCell'

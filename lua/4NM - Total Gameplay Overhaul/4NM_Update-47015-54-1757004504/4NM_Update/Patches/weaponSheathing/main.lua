...
local function GoD(m, wid) if m == tes3.mobilePlayer and wid:sub(1,1) == "*" then local Old = tes3.getObject(wid:sub(2))	if Old then return Old.type end end	return false end
-------------
-- STARTUP --
-------------
local attachNodes = {}

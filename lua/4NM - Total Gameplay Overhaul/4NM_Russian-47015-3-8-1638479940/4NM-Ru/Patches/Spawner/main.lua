...
local S = {[1] = {"atronach_flame", "atronach_frost", "atronach_storm", "atronach_flame_lord", "atronach_frost_lord", "atronach_storm_lord", 
...
[4] = {"Rat", "mudcrab", "mudcrab_king", "mudcrab_rock", "mudcrab_titan", "scrib", "shalk", "kwama forager", "kwama worker", "kwama warrior", "nix-hound", "nix_mount", 
...
[5] = {"db_assassin3", "Imperial Guard", "imperial archer", "hlaalu guard", "redoran guard male", "telvanni guard", "ordinator wander", "ordinator_mournhold", "Guard_Helseth",
"BM_berserker_m3", "bm_frysehag_2", "bm_reaver_50", "bm_reaver_archer_50", "bm_smugglers_darkelf", 
...
local S1 = {[1] = {"atronach_flame", "atronach_frost", "atronach_storm", "dremora", "dremora_lord", "golden saint",

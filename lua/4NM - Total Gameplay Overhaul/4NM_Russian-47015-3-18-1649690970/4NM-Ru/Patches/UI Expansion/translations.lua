return {
	...
	["fra"] = {
		...
		condition = "Etat ",
		configAlwaysClearFiltersOnOpen = "Toujours rГ©initialiser les filtres lorsque le menu d'ouverture?",
		configAutoFilterToTradable = "Afficher seulement les objets vendables lors du marchandage ?",
		configAutoSelectSearch = "Barre de recherche automatiquement sпїЅlectionnпїЅe :",
		...
		configCredits = "CrпїЅdits :",
		configFilterButtons = "Remplacer les icпїЅnes par des boutons textuels pour la recherche dans l'inventaire ?",
		configMaxWaitDays = "DurпїЅe maximum de l'attente :",
		...
		configTransferStackByDefault = "TransfпїЅrer des piles entiпїЅres d'objets entre les inventaires sans garder la touche Alt enfoncпїЅe ?",
		...
		filterAlterationHelpDescription = "AltпїЅration",
		filterAlterationHelpText = { "Cliquez pour trouver vos sorts, pouvoirs et objets d'AltпїЅration." },
		filterApparelButtonName = "Tenues",
		filterApparelHelpDescription = "Tenues",
		filterApparelHelpText = { "Rassemble :", "- Armures", "- VпїЅtements" },
		...
		filterConsumablesHelpText = {
			...
			"- Potions",
			"- Parchemins",
			"- Enchantements de type dпїЅclenchement sur dпїЅcision",
		},
		...
		filterIngredientsButtonName = "IngrпїЅdients",
		filterIngredientsHelpDescription = "IngrпїЅdients",
		filterIngredientsHelpText = { "Rassemble :", "- IngrпїЅdients" },
		...
		filterOtherHelpText = { "Rassemble :", "- Livres", "- ClпїЅs", "- Gemmes vides", "- Autres objets" },
		filterRestorationHelpDescription = "GuпїЅrison",
		filterRestorationHelpText = { "Cliquez pour trouver vos sorts, pouvoirs et objets de GuпїЅrison." },
		filterToolsButtonName = "Outils",
		filterToolsHelpDescription = "Outils",
		filterToolsHelpText = {
			"Rassemble :",
			"- MatпїЅriel d'alchimie",
			"- Crochets et sondes",
			"- Outils de forgeron",
			"- Gemmes pleines",
		},
		...
		helpTextDisableTip = "Les infobulles d'aide peuvent пїЅtre dпїЅsactivпїЅes dans le menu de configuration du mod.",
		lightDuration = "Temps ",
		load = "Chargement",
		...
		statFactionReputation = "RпїЅputation dans la faction : %d",
		statFactionReputationRequirement = "RпїЅputation de faction requise pour le rang suivant : %d",
		statHelpBaseValue = "La valeur de base tient compte de vos capacitпїЅs et est prise en compte lors d'une promotion dans les rangs d'une faction.",
		statHelpRawValue = "La valeur brute n'implique aucun effet.",
		statModifiers = "Modificateurs : ",
		statRawValue = "Valeur brute : %d",
		stolenFromMerchant = "VolпїЅ пїЅ ce vendeur.",
		takeAll = "Tout prendre",
		takeFiltered = "Prendre ceci",
		unknown = "inconnu",
		updateRequired = "\"Extension de l'interface utilisateur\" requiert la derniпїЅre version de MWSE 2.1 pour fonctionner. Lancez MWSE-Updater.exe. pour la mettre пїЅ jour.",
		weaponReach = "PortпїЅe ",
		weaponSpeed = "Vitesse ",
		weekDays = { "Sundas", "Morndas", "Tirdas", "Middas", "Turdas", "Fredas", "Loredas" },
		weightClasses = { "Armure lпїЅgпїЅre", "Armure interm.", "Armure lourde" },
		yes = "Oui",
	},
	...
	["deu"] = {
		...
		condition = "Zustand",
		configAlwaysClearFiltersOnOpen = "Immer Filter zurГјckgesetzt, wenn das MenГј zu Г¶ffnen?",
		...
		configRatioDisplay = "Anzeigewert/GewichtsverhГ¤ltnis?",

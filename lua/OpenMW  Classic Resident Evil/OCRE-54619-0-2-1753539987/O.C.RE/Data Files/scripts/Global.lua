...
local function RemoveItem(data)
	...
	if data.Item  and data.Item.count>0 and data.number>0 then
...
--	print(world.mwscript.getLocalScript(data.Object,data.Player).variables[1])
	...
	elseif data.Variable=="blowtorch" and world.mwscript.getLocalScript(data.Object,data.Player) and world.mwscript.getLocalScript(data.Object,data.Player).variables and world.mwscript.getLocalScript(data.Object,data.Player).variables[data.Variable] and world.mwscript.getLocalScript(data.Object,data.Player).variables[data.Variable]>0 and world.mwscript.getLocalScript(data.Object,data.Player).variables[data.Variable]<6 then
		data.Player:sendEvent("BlowtorchPuzzle", {Value=world.mwscript.getLocalScript(data.Object,data.Player).variables[data.Variable],Object=data.Object})
	elseif data.Variable=="hacpuzzle" and world.mwscript.getLocalScript(data.Object,data.Player) and world.mwscript.getLocalScript(data.Object,data.Player).variables and world.mwscript.getLocalScript(data.Object,data.Player).variables[data.Variable] and world.mwscript.getLocalScript(data.Object,data.Player).variables[data.Variable]>0 then
		data.Player:sendEvent("HotAndColdPuzzle", {Value=world.mwscript.getLocalScript(data.Object,data.Player).variables[data.Variable],Object=data.Object})
	end
end
...
--[[
				...
				if world.mwscript.getGlobalVariables(player)["camera"] >-1 then
					...
					print("Global cam =",world.mwscript.getGlobalVariables(player)["camera"])
					world.mwscript.getGlobalVariables(player)["camera"]=-1
				end

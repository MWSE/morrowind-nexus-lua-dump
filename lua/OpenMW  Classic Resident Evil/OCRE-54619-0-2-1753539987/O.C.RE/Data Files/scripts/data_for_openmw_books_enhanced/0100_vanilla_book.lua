...
local DocumentData = {
    ...
    texture = {
        ...
        width = ui.screenSize().x,
        --height = ui.screenSize().y/(3-1/5),
        height = ui.screenSize().y,
        colorable = true,
    },
    pagesTextArrangement = {
        page1 = {
            textArea = {
                width =ui.screenSize().x/3,-- 400,--220,
                height =ui.screenSize().y/3,-- 333,
                posTopLeftCornerX =ui.screenSize().x/3,--200,-- 110,
                posTopLeftCornerY =ui.screenSize().y/4,-- 16,
                isScrollableVertically = false,
            },
            pageNumber = {
                posCenterX =ui.screenSize().x/2,-- 110 + (400 / 2),
                posCenterY =ui.screenSize().y/2,-- 16 + 333 + 15,
            }
        },
        page2 = nil--[[{
            textArea = {

                        ...
                        tes3.messageBox({
                            ...
                            callback = function (e2)
                                if e2.button == 0 and checkPurchase(tes3.player.data.helvilMine.mineData.upgrades.pickaxes.levelCosts[nextPickLevel]) then
                                   ...
                                   craftingFramework.Recipe.getRecipe("helvilMine:ashStatueRecipe"):unlearn() tes3.player.data.helvilMine.mineData.upgrades.pickaxes.level = tes3.player.data.helvilMine.mineData.upgrades.pickaxes.level + 1

...
local function onMobileActivated(e)
    if (e.reference == tes3.player or e.reference.object.objectType ~= tes3.objectType.npc or e.reference.sceneNode == nil) then
        return
    end
    for _, stack in pairs(e.reference.object.equipment) do
...
local function menuExitCallback(e)
    for _, cell in ipairs(tes3.getActiveCells()) do
        for ref in tes3.iterate(cell.actors) do
            if (ref ~= tes3.player and ref.object.objectType == tes3.objectType.npc and ref.sceneNode) then

...
FactionTableNames = {"Vampire Clan Aundae.", "Vampire Clan Berne.", "Vampire Clan Quarra.", "Fighters Guild.", "Imperial Cult.", "Imperial Legion.", "Mages Guild.", "Morag Tong.", "Greate House Hlaalu.",
"Greate House Redoran.", "Great House Telvanni.", "Tribunal Temple.", "Thieves Guild.", "Twin Lamps.", "East Empire Company."}

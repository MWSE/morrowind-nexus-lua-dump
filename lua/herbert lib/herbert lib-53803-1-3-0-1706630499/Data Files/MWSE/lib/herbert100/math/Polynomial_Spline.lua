...
---@class herbert.Spline.new_params
...
---@class herbert.Spline : herbert.Class
...
---@field new fun(params: herbert.Spline.new_params): herbert.Spline
    ...
    obj_metatable = {
        __tostring = function(self) 
            ...
            for i=1, self.n do
                ...
                local coeffs_copy = table.copy(coeffs)
...
---@class herbert.Evenly_Spaced_Spline.new_params
...
---@class herbert.Evenly_Spaced_Spline : herbert.Spline
...
---@field new fun(params:herbert.Evenly_Spaced_Spline.new_params): herbert.Evenly_Spaced_Spline
...
return {Spline = Polynomial_Spline, Evenly_Spaced_Spline = Evenly_Spaced_Spline}
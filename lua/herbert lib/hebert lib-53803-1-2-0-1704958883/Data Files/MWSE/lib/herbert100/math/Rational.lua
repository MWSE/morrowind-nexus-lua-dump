...
---@field num number|function|herbert.Polynomial # numerator
---@field denom number|function|herbert.Polynomial # denom
---@field new fun(num: number|herbert.Polynomial, denom:number|herbert.Polynomial?): herbert.Rational

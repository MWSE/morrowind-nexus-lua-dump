...
--- append tables to the current ones. earlier values will take precedence. nothing will be overriden.
---@param tbl table
---@param ... table
...
--- concatenate multiple tables together. later tables will take precedence over later tables.
---@param ... table
---@return table

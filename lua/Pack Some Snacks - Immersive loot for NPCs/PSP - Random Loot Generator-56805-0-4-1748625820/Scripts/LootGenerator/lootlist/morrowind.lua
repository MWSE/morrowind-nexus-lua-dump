return {
    ...
    misc = {
		...
		-- Alchemist
		{ id = "misc_skooma_vial", tags = { "alchemist" } },
		...
		{ id = "p_feather_c", tags = { "alchemist" } },
		{ id = "p_levitation_c", tags = { "alchemist" } },
		{ id = "p_night-eye_c", tags = { "alchemist" } },
		{ id = "p_cure_poison_s", tags = { "alchemist" } },
		{ id = "p_fortify_health_c", tags = { "alchemist" } },
		{ id = "p_invisibility_c", tags = { "alchemist" } },		

...
I.Settings.registerGroup {
    ...
    settings = {
        ...
        },
        {
            key = 'staticTimescale',
            renderer = 'number',
            name = 'Static Timescale',
            description = 'Timescale for when the player is standing still',
            default = 5
        }
    }
}
...
return{
	eventHandlers = {
        ...
        ['hazelnotsettimescaleSTATIC'] = function()
            world.setGameTimeScale(globalSettings:get('staticTimescale'))
        end
	}
}

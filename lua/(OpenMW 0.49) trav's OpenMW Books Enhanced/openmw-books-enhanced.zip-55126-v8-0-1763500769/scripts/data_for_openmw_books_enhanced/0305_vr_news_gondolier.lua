...
local DocumentData = {
    ...
    shouldApplyTo = function(gameObject)
        return string.match(types.Book.records[gameObject.recordId].model, "vr_text_note_viv_news.nif")
    end,
    texture = {
    ...
    modifyTextBeforeApplying = function(text)
        return string.gsub(
            text,
            "<IMG SRC=\"VR\\vr_gondol_512_256%.dds\" WIDTH=\"348\" HEIGHT=\"168\"><BR>",
            ""
        )
    end,
    additionalWidgetsInDocumentUi = {
        {
            ...
            props = {
                ...
                resource = ui.texture { path = "bookart\\vr\\vr_gondol_512_256.dds" },
                visible = true,
            },
        }
    },

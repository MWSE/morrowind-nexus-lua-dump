...
function this.onCreate(container)
	...
	mainPane:createLabel({ text = "  Kolorowe ikony szkуі magii: R-Zero" })
	mainPane:createLabel({ text = "  Ikony filtrowania ekwipunku: Remiros" })
	mainPane:createLabel({ text = "  Ikony umiejкtnoњci: RedFurryDemon" })
	mainPane:createLabel({ text = "  Koncepcje i testowanie: Spoіecznoњж Morrowind z Discorda" })
	mainPane:createLabel({ text = "  Tіumaczenie: Negato aka GokuZboku, TeWu" })
end
